...
class ActionManager(API):
    ...
    def shortcuts(self, Path: str, Group: ShortcutGroup = ...): ...
    def __bool__(self) -> bool: ...
...
class AdjustmentLayer(Layer):
    ...
    def primaryAdjustmentParameters(self): ...
    def primaryAdjustmentType(self) -> str: ...
    def removeSecondaryAdjustment(self): ...
    def secondaryAdjustmentParameters(self): ...
...
class Application(API):
    ...
    def executeDialog(self, Dialog: PySide2.QtWidgets.QDialog) -> typing.SupportsInt: ...
    ...
    def maximize(self): ...
    def minimize(self): ...
    def numProcessingSteps(self) -> typing.SupportsInt: ...
    def popupsAllowed(self) -> bool: ...
    def processEvents(self): ...
    def progress(self) -> typing.SupportsInt: ...
    ...
    def registerGeoPluginWidget(self, FileExtensions, Widget: PySide2.QtWidgets.QWidget): ...
...
class BakePointNode(PaintNode):
    ...
    def exportBakedResult(self, BakeOutOfDate: bool, Options: typing.SupportsInt = ..., UVIndexList=..., FileOptions: variant = ...): ...
...
class Channel(LayerStack):
    ...
    def height(self, UVIndex: typing.SupportsInt = ...) -> typing.SupportsInt: ...
    def isLocked(self) -> bool: ...
    def isPtex(self): ...
    def isShaderStack(self): ...
    def lock(self): ...
    def makeCurrent(self): ...
    def metricResize(self, Metric: ResizeMetric, Value: float, UVIndexList=...): ...
    def name(self) -> str: ...
    def resize(self, NewSize: ImageSet.Size, UVIndexList=...): ...
    ...
    def width(self, UVIndex: typing.SupportsInt = ...) -> typing.SupportsInt: ...
    def __bool__(self) -> bool: ...
...
class ChannelInfo(API):
    ...
    def setWidth(self): ...
    def shader(self): ...
    def size(self) -> typing.SupportsInt: ...
    def width(self): ...
    def __bool__(self) -> bool: ...
...
class Clock(API):
    ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def frame(self) -> typing.SupportsInt: ...
    def frameCount(self) -> typing.SupportsInt: ...
    def frameRate(self) -> typing.SupportsInt: ...
    def loopCount(self) -> typing.SupportsInt: ...
    ...
    def sourceFrameRate(self) -> typing.SupportsInt: ...
    def startFrame(self) -> typing.SupportsInt: ...
    def stepBack(self): ...
    def stepForward(self): ...
    def stop(self): ...
    def stopFrame(self) -> typing.SupportsInt: ...
    def time(self) -> str: ...
    def __bool__(self) -> bool: ...
...
class ColorspaceConfig(API):
    ...
    def availableColorspaces(self, Stage: ColorspaceStage = ..., PrettyNames: bool = ...): ...
...
class ColorspaceDefaults(API):
    ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def availableColorspaces(self, Target: ColorspaceTarget = ..., PrettyNames: bool = ...): ...
...
class CustomProceduralLayer(AdjustableLayer):
    ...
    def geoChannels(self): ...
    def missingGeoChannels(self): ...
...
class CustomProceduralNode(GroupNode):
    ...
    def addCustomProceduralTags(self, Tags): ...
    def customProceduralTags(self): ...
    ...
    @classmethod
    def readTagsFromCustomProceduralFile(cls, CustomProceduralFilePath: str): ...
    @classmethod
    ...
    def removeCustomProceduralTags(self, Tags): ...
    def setCustomProceduralTags(self, CustomProceduralTags): ...
    ...
    @classmethod
    def writeTagsToCustomProceduralFile(cls, Tags, CustomProceduralFilePath: str) -> bool: ...
    @classmethod
...
class DDI(API):
    ...
    def dataBlocks(self) -> typing.SupportsInt: ...
    def garbageCollect(self, UnusedPatches: bool = ...): ...
    def isLive(self, Hash: str) -> bool: ...
    def liveBlocks(self) -> typing.SupportsInt: ...
    def liveBytes(self): ...
    def memoryCacheSize(self) -> typing.SupportsInt: ...
    def profile(self, NumberOfBlocks: typing.SupportsInt = ..., BlockSize: unsignedint = ..., RandomSize: bool = ...) -> typing.SupportsInt: ...
    def setMemoryCacheSize(self, Size: typing.SupportsInt): ...
    def setTraceEnabled(self, Hash: str, Enabled: bool = ...): ...
    def traces(self, Hash: str): ...
    def __bool__(self) -> bool: ...
...
class EnvironmentLight(Light):
    ...
    def cubeImageResolution(self) -> typing.SupportsInt: ...
...
class ExportItem(Metadata):
    ...
    def resolveExportFilePaths(self, RootPath: str = ...): ...
    ...
    def setErrorStringList(self, ErrorStringList): ...
    ...
    def setUvIndexList(self, UVIndexList): ...
    def setWarningStringList(self, WarningStringList): ...
    def sourceColorspace(self) -> str: ...
    def sourceDepth(self) -> Image.Depth: ...
    def sourceDepthAsInternalFormat(self) -> typing.SupportsInt: ...
    def sourceNode(self) -> Node: ...
    def sourceNodeName(self) -> str: ...
    def sourceResolution(self) -> str: ...
    def uvIndexList(self): ...
    def warningStringList(self): ...
    def __bool__(self) -> bool: ...
...
class ExportManager(API):
    ...
    def colorspaceList(self): ...
    def depthList(self): ...
    def exportItemList(self, Entity: GeoEntity): ...
    def exportTextures(self, ExportItems, ExportRootPath: str, Overrides: variant = ...) -> str: ...
    def imageFileExtensionList(self): ...
    def imageFileOptions(self, Extension: str) -> variant: ...
    def imageFileOptionsWidget(self, Extension: str) -> PySide2.QtWidgets.QWidget: ...
    def postProcessCommandList(self): ...
...
class FileList(API):
    ...
    def count(self) -> typing.SupportsInt: ...
...
class GLRender(API):
    ...
    def postFilterCollectionNames(self): ...
    def postFilterCollections(self): ...
    @classmethod
...
class GLSLFilter(PostFilter):
    ...
    def setTexture1D(self, SamplerName: str, Width: typing.SupportsInt, DataFormat: Format, Data, MinFilter: Filter = ..., MagFilter: Filter = ..., ClampS: Clamp = ..., ClampT: Clamp = ...): ...
    def setTexture2D(self, SamplerName: str, Width: typing.SupportsInt, Height: typing.SupportsInt, DataFormat: Format, Data, MinFilter: Filter = ..., MagFilter: Filter = ..., ClampS: Clamp = ..., ClampT: Clamp = ...): ...
    def setTexture3D(self, SamplerName: str, Width: typing.SupportsInt, Height: typing.SupportsInt, Depth: typing.SupportsInt, DataFormat: Format, Data, MinFilter: Filter = ..., MagFilter: Filter = ..., ClampS: Clamp = ..., ClampT: Clamp = ..., ClampR: Clamp = ...): ...
    def updateTexture1D(self, SamplerName: str, Data): ...
    def updateTexture2D(self, SamplerName: str, Data): ...
    def updateTexture3D(self, SamplerName: str, Data): ...
    def __bool__(self) -> bool: ...
...
class GeoChannel(Metadata):
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    def aliases(self): ...
    def geoChannelLayers(self): ...
    def geoChannelNodes(self): ...
...
class GeoEntity(Lockable):
    ...
    def imageSet(self): ...
    def imageSetList(self): ...
    def imageSetNames(self): ...
...
class GeoEntityVersion(Metadata):
    ...
    def geoEntity(self) -> GeoEntity: ...
    def geometryCount(self) -> typing.SupportsInt: ...
    def load(self) -> bool: ...
    ...
    def sourceMeshLocationList(self): ...
    def __bool__(self) -> bool: ...
...
class GeoManager(API):
    ...
    def geometryOperationList(self): ...
    def get(self, Name: str) -> GeoEntity: ...
    def getAnimationTakes(self, Path: str): ...
    def getDefaultAnimationTake(self, Path: str) -> str: ...
    def getFileContents(self, Path: str) -> variant: ...
    def getFileFrameRange(self, Path: str, Take: str = ...): ...
    def importFromArchive(self, DirPath: str): ...
    def list(self): ...
    def listLocators(self): ...
    def load(self, Path: str, Options: variant = ..., ObjectsToLoad: variant = ..., LoadAsChild: bool = ...): ...
    def names(self): ...
    def recalculatePatchBounds(self): ...
    def remove(self, Name: str): ...
    def setCurrent(self, Name: str): ...
    def supportedReadFormats(self): ...
    def __bool__(self) -> bool: ...
...
class GeoPatch(Lockable):
    ...
    def u(self) -> typing.SupportsInt: ...
    def udim(self) -> typing.SupportsInt: ...
    def uv(self) -> PySide2.QtWidgets.QPoint: ...
    def uvIndex(self) -> typing.SupportsInt: ...
    def v(self) -> typing.SupportsInt: ...
    def __bool__(self) -> bool: ...
...
class GroupNode(Node):
    ...
    def knobList(self): ...
    def linkKnobs(self, KnobName: str, TargetKnobNames, PrettyKnobName: str = ...): ...
...
class Image(Metadata):
    ...
    def depth(self): ...
    @classmethod
    def depthAsInternalFormat(cls, Depth: Image.Depth) -> typing.SupportsInt: ...
    def filePath(self) -> str: ...
    def fileSpace(self): ...
    def fill(self, FillColor: Color): ...
    def hash(self) -> str: ...
    def height(self, MipMapLevel: typing.SupportsInt = ...) -> typing.SupportsInt: ...
    ...
    def mipMapCount(self) -> typing.SupportsInt: ...
    ...
    def size(self, MipMapLevel: typing.SupportsInt = ...): ...
    def thumbnail(self): ...
    def transform(self, Collection: PostFilterCollection) -> bool: ...
    def uniformColor(self) -> Color: ...
    def width(self, MipMapLevel: typing.SupportsInt = ...) -> typing.SupportsInt: ...
    def __bool__(self) -> bool: ...
...
class ImageManager(Metadata):
    ...
    def compressionList(self, Extension: str): ...
    ...
    def imageOperationList(self): ...
    def list(self): ...
    def open(self, Path: str, Config: ColorspaceConfig = ..., AlphaProcessing: ImageAlphaProcessing = ..., Name: str = ...): ...
    ...
    def saveImages(self, Images, Path: str) -> bool: ...
    ...
    def supportedReadFormats(self): ...
    def supportedTextureSizeList(self): ...
    def supportedWriteFormats(self): ...
    def traces(self, PathOrHash: str): ...
...
class ImageMimeDataInfo(API):
    ...
    @classmethod
    def fromMimeDataString(cls, MimeDataString: str): ...
    def path(self) -> str: ...
    def __bool__(self) -> bool: ...
...
class ImageSet(Snapshotable):
    ...
    def createSnapshot(self, Name: str, ID: str = ...) -> Snapshot: ...
    def defaultKeyFrame(self) -> typing.SupportsInt: ...
    def deleteSnapshot(self, ShotToDelete: Snapshot): ...
    ...
    def imageCount(self) -> typing.SupportsInt: ...
    def imageList(self, Frame: typing.SupportsInt = ...): ...
    def importImages(self, ImagePaths: variant, ScaleOption: ScaleChoice, UVIndexList=..., RemoveAlpha: bool = ..., SourceColorConfig: ColorspaceConfig = ...): ...
    ...
    def uvIndex(self, UvImage: Image) -> typing.SupportsInt: ...
    def uvIndices(self): ...
    def __bool__(self) -> bool: ...
...
class IntSlider(SliderBase):
    ...
    def value(self) -> typing.SupportsInt: ...
    def __bool__(self) -> bool: ...
...
class Layer(Metadata):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def activeCacheUpToHereParents(self): ...
    @classmethod
    ...
    def setVisibility(self, Visible: bool): ...
    def siblingSharedLayerList(self): ...
    def swizzle(self): ...
...
class LayerStack(Metadata):
    ...
    def duplicateLayers(self, LayersToDuplicate=..., RefLayer: Layer = ..., Flags: typing.SupportsInt = ...): ...
    def exportImages(self, PathAndTemplate: str, Options: typing.SupportsInt = ..., UVIndexList=..., FileOptions: variant = ..., OutputColorConfig: ColorspaceConfig = ...): ...
    def exportImagesFlattened(self, PathAndTemplate: str, Options: typing.SupportsInt = ..., UVIndexList=..., FileOptions: variant = ..., OutputColorConfig: ColorspaceConfig = ...): ...
    ...
    def findLayer(self): ...
    def groupLayers(self, LayersToGroup=..., RefLayer: Layer = ..., LayerName: str = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def hash(self, UVIndex: typing.SupportsInt = ...) -> str: ...
    def imageHash(self, UVIndex: typing.SupportsInt = ...) -> str: ...
    def importImages(self, PathAndTemplate: str, ScaleOption: ImageSet.ScaleChoice = ..., MatchingLayersOption: LayerImportOption = ..., MismatchingLayersOption: LayerImportOption = ..., UVIndexList=..., RemoveAlpha: bool = ..., SourceColorConfig: ColorspaceConfig = ...): ...
    def layer(self, LayerName: str) -> Layer: ...
    def layerList(self): ...
    def mergeLayers(self, LayersToMerge=..., RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
...
class MaterialNode(GroupNode):
    ...
    @classmethod
    def readTagsFromMaterialFile(cls, MaterialFilePath: str): ...
    @classmethod
    def readThumbnailFromMaterialFile(cls, MaterialFilePath: str) -> PySide2.QtWidgets.QImage: ...
    def removeMaterialTag(self, Tag: str): ...
    def removeMaterialTags(self, Tags): ...
    def setMaterialTags(self, MaterialTags): ...
    ...
    @classmethod
    def writeTagsToMaterialFile(cls, Tags, MaterialFilePath: str) -> bool: ...
    @classmethod
...
class Matrix(API):
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    def asList(self): ...
    def length(self) -> typing.SupportsInt: ...
    def __bool__(self) -> bool: ...

class MenuManager(API):
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def actions(self, rSet: str, rRoot: str, rSubMenu: str = ...): ...
    def addAction(self, pAction: Action, rPath: str, rAddBefore: str = ...): ...
    def addSeparator(self, Path: str, rAddBefore: str = ...): ...
    def itemNames(self, rSet: str, rRoot: str, rSubMenu: str = ...): ...
    def removeAction(self, pAction: Action, rFullPath: str): ...
    def roots(self, rSet: str): ...
    def sets(self): ...
    def submenus(self, rSet: str, rRoot: str, rSubMenu: str = ...): ...
    def __bool__(self) -> bool: ...
...
class Metadata(API):
    ...
    def metadataItemList(self, Name: str): ...
    ...
    def setMetadataItemList(self, Name: str, ItemList): ...
...
class Node(Metadata):
    ...
    def bypassInput(self, OutputPoint: str = ...) -> typing.SupportsInt: ...
    def connectSignals(self, *args, **kwargs): ...
    ...
    def inputConnection(self, PortName: str): ...
    def inputNode(self, PortName: str) -> Node: ...
    def inputPortCount(self) -> typing.SupportsInt: ...
    ...
    def nodePath(self): ...
    def outputNodes(self, PortName: str = ...): ...
    def outputPortCount(self) -> typing.SupportsInt: ...
...
class NodeGraph(Metadata):
    ...
    def autoLayoutNodes(self, Roots): ...
    ...
    def exportNodesAsArchive(self, DirPath: str, Nodes, NoDataBlockCopy: bool = ..., UVIndexList=...) -> dict[str, str]: ...
    @classmethod
    def getAllUpstreamNodes(cls, DestNode: Node): ...
    @classmethod
    def getUpstreamNodes(cls, DestNode: Node): ...
    def groupNodes(self, Nodes) -> GroupNode: ...
    def importCustomProcedural(self, FileName: str) -> Node: ...
    def importMaterial(self, FileName: str) -> Node: ...
    def importNodesFromArchive(self, DirPath: str, UuidsToLoad, UvIndexMap): ...
    def load(self, FilePath: str): ...
    def nodeList(self, IncludeSystemNodes: bool = ...): ...
    def nodesFromString(self, String: str): ...
    def nodesToString(self, Nodes) -> str: ...
    def nodesWithTag(self, Tag: str): ...
    def parentGeoEntity(self) -> GeoEntity: ...
    def parentGroupNode(self) -> GroupNode: ...
    def removeNode(self, NodeToRemove: Node): ...
    def save(self, FilePath: str, Nodes): ...
    def selectedNodeList(self, IncludeSystemNodes: bool = ...): ...
    def setActiveViewerInput(self, InputNumber: typing.SupportsInt): ...
    def teleportBroadcastChannelNameList(self): ...
    def teleportNodeBroadcastingOnChannel(self): ...
    def teleportNodesListeningToChannel(self): ...
    @classmethod
    def topologicalSortTo(cls, DestNode: Node, ReverseOrder: bool = ...): ...
    def typeList(self): ...
...
class NodeGraphPalette(Palette):
    ...
    def currentTabIndex(self) -> typing.SupportsInt: ...
    def indexForNodeGraph(self, NodeGraphObject: NodeGraph) -> typing.SupportsInt: ...
    def nodeGraphView(self, TabIndex: typing.SupportsInt) -> NodeGraphView: ...
    def nodeGraphViewList(self): ...
...
class OpenColorIO(API):
    ...
    def colorspaceCount(self, Config: str) -> typing.SupportsInt: ...
    def colorspacePrettyNames(self, Config: str): ...
    ...
    def get3DLutValuesFromDisplayViewTransform(self, Config: str, Src: str, View: str, Display: str, LutSize: typing.SupportsInt): ...
    def get3DLutValuesFromFileTransform(self, Config: str, Input: str, Output: str, LutSize: typing.SupportsInt): ...
    ...
    def lutSize(self) -> typing.SupportsInt: ...
    def parseColorspaceFromString(self, Config: str, Str: str) -> str: ...
    def registerConfigUiAllowlist(self, ConfigFilePath: str, Allowlist): ...
    def role(self, Config: str, Index: typing.SupportsInt) -> str: ...
    def roleCount(self, Config: str) -> typing.SupportsInt: ...
...
class PaintableLayer(AdjustableLayer):
    ...
    def exportSelectedPatches(self, PathAndTemplate: str, Options: typing.SupportsInt = ..., FileOptions: variant = ..., OutputColorConfig: ColorspaceConfig = ...): ...
    def imageSet(self) -> ImageSet: ...
    def importImages(self, PathAndTemplate: str, ScaleOption: ImageSet.ScaleChoice = ..., UVIndexList=..., RemoveAlpha: bool = ..., SourceColorConfig: ColorspaceConfig = ...): ...
    def setBleed(self, bleed: bool): ...
    def __bool__(self) -> bool: ...
...
class PatchLinksManager(API):
    ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def canLinkImageInternals(self, Images) -> bool: ...
    def canLinkImages(self, Images, GroupName: str) -> bool: ...
    def canLinkPatchInternals(self, Patches, pImageSet: ImageSet) -> bool: ...
    def canLinkPatches(self, Patches, GroupName: str, pImageSet: ImageSet) -> bool: ...
    def generateUniqueGroupName(self) -> str: ...
    def groupNames(self): ...
    def groupNamesForImageSet(self, pImageSet: ImageSet): ...
    def imageGroup(self, Img: Image) -> str: ...
    def images(self, GroupName: str): ...
    def isImageLinked(self, Img: Image) -> bool: ...
    def isPatchLinked(self, Patch: GeoPatch, pImageSet: ImageSet) -> bool: ...
    def linkImages(self, Images, GroupName: str): ...
    def linkPatches(self, Patches, GroupName: str, pImageSet: ImageSet): ...
    def linkSelectedPatches(self, GroupName: str, pImageSet: ImageSet): ...
    def linkedImages(self, Img: Image): ...
    def linkedPatches(self, Patch: GeoPatch, pImageSet: ImageSet = ...): ...
    def patchGroup(self, Patch: GeoPatch, pImageSet: ImageSet) -> str: ...
    def patches(self, GroupName: str, pImageSet: ImageSet = ...): ...
...
class PostFilter(PropertySource):
    ...
    def flags(self) -> typing.SupportsInt: ...
    def name(self) -> str: ...
    def setEnabled(self, Enabled: bool): ...
...
class PostFilterCollection(Metadata):
    ...
    def flags(self) -> typing.SupportsInt: ...
    def indexOf(self, Filter: PostFilter, StartAt: typing.SupportsInt = ...) -> typing.SupportsInt: ...
    def isReadOnly(self): ...
...
class Preferences(API):
    ...
    def setItemList(self, Path: str, ItemList): ...
...
class Project(PropertySource):
    ...
    def name(self) -> str: ...
    def remapConfigColorspaces(self, ColorspaceRemappings: dict[str, variant], FileName: str = ..., Stages=...): ...
...
class ProjectInfo(Metadata):
    ...
    def recentIndex(self) -> typing.SupportsInt: ...
...
class ProjectManager(API):
    ...
    def create(self, Name: str, MeshPaths: variant, ChannelsToCreate, ChannelsToImport=..., ProjectMetaOptions: variant = ..., ObjectsToLoad: variant = ..., ColorspaceSettings: ColorspaceDefaults = ...): ...
...
class ProjectionManager(PropertySource):
    ...
    def paintingModePathList(self): ...
    def paintingModeStr(self) -> str: ...
    def paintingModeStrList(self): ...
...
class Projector(Metadata):
    ...
    def exportPath(self) -> str: ...
    def format(self): ...
    def frameOffset(self) -> typing.SupportsInt: ...
    def height(self) -> typing.SupportsInt: ...
    ...
    def projectionMaskNameList(self): ...
    ...
    def useShaderList(self): ...
    def width(self) -> typing.SupportsInt: ...
    def __bool__(self) -> bool: ...
...
class ProjectorManager(API):
    ...
    def list(self): ...
    def load(self, Path: str, Options=..., CameraNames: variant = ...): ...
    def names(self): ...
    def remove(self, Name: str): ...
    def selection(self): ...
...
class Ptex(Metadata):
    ...
    def geoFaceCount(self) -> typing.SupportsInt: ...
...
class ResourceInfo(API):
    ...
    def setPathList(self, Key: str, NewPathList): ...
...
class ShelfManager(API):
    ...
    def search(self, SearchKeyword: str, Shelves): ...
...
class SliderBase(WidgetBase):
    ...
    def precision(self) -> typing.SupportsInt: ...
...
class ToolBar(WidgetBase):
    ...
    def addAction(self, Path: str, Pos=..., Removable: bool = ...): ...
    def addActionBefore(self, Path: str, InsertBefore: PySide2.QtWidgets.QAction = ..., Removable: bool = ...): ...
    def addActionList(self, Actions, Removable: bool): ...
