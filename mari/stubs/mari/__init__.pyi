...
class ActionManager(API):
    ...
    def list(self, rPath: str = ...) -> list[str]: ...
    ...
    def shortcuts(self, Path: str, Group: ShortcutGroup = ...) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class AdjustmentLayer(Layer):
    ...
    def primaryAdjustmentParameters(self) -> list[str]: ...
    def primaryAdjustmentType(self) -> str: ...
    def removeSecondaryAdjustment(self): ...
    def secondaryAdjustmentParameters(self) -> list[str]: ...
...
class Application(API):
    ...
    def backgroundJobIDs(self) -> list[int]: ...
    ...
    def registerGeoPluginWidget(self, FileExtensions: list[str], Widget: PySide2.QtWidgets.QWidget): ...
...
class BakePointNode(PaintNode):
    ...
    def exportBakedResult(self, BakeOutOfDate: bool, Options: typing.SupportsInt = ..., UVIndexList: list[int] = ..., FileOptions: variant = ...): ...
...
class Canvas(API):
    ...
    def displayPropertyList(self) -> list[str]: ...
...
class Channel(LayerStack):
    ...
    def metricResize(self, Metric: ResizeMetric, Value: float, UVIndexList: list[int] = ...): ...
    def name(self) -> str: ...
    def resize(self, NewSize: ImageSet.Size, UVIndexList: list[int] = ...): ...
    ...
    def snapshotList(self) -> list[Snapshot]: ...
    def unlock(self): ...
...
class ColorspaceConfig(API):
    ...
    def availableColorspaces(self, Stage: ColorspaceStage = ..., PrettyNames: bool = ...) -> list[str]: ...
...
class ColorspaceDefaults(API):
    ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def availableColorspaces(self, Target: ColorspaceTarget = ..., PrettyNames: bool = ...) -> list[str]: ...
...
class ComboBox(WidgetBase):
    ...
    def setContents(self, Values: list[str]): ...
...
class CustomLUTFilter(PostFilter):
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def setData(self, Data: list[Color]): ...
    def __bool__(self) -> bool: ...
...
class CustomProceduralLayer(AdjustableLayer):
    ...
    def geoChannels(self) -> list[str]: ...
    def missingGeoChannels(self) -> list[str]: ...
...
class CustomProceduralNode(GroupNode):
    ...
    def addCustomProceduralTags(self, Tags: list[str]): ...
    def customProceduralTags(self) -> list[str]: ...
    ...
    @classmethod
    def readTagsFromCustomProceduralFile(cls, CustomProceduralFilePath: str) -> list[str]: ...
    @classmethod
    ...
    def removeCustomProceduralTags(self, Tags: list[str]): ...
    def setCustomProceduralTags(self, CustomProceduralTags: list[str]): ...
    ...
    @classmethod
    def writeTagsToCustomProceduralFile(cls, Tags: list[str], CustomProceduralFilePath: str) -> bool: ...
    @classmethod
...
class DDI(API):
    ...
    def traces(self, Hash: str) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class ExportItem(Metadata):
    ...
    def resolveExportFilePaths(self, RootPath: str = ...) -> list[str]: ...
    ...
    def setErrorStringList(self, ErrorStringList: list[str]): ...
    ...
    def setUvIndexList(self, UVIndexList: list[int]): ...
    def setWarningStringList(self, WarningStringList: list[str]): ...
    ...
    def uvIndexList(self) -> list[int]: ...
    def warningStringList(self) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class ExportManager(API):
    ...
    def colorspaceList(self) -> list[str]: ...
    def depthList(self) -> list[str]: ...
    def exportItemList(self, Entity: GeoEntity) -> list[ExportItem]: ...
    def exportTextures(self, ExportItems: list[ExportItem], ExportRootPath: str, Overrides: variant = ...) -> str: ...
    def imageFileExtensionList(self) -> list[str]: ...
    def imageFileOptions(self, Extension: str) -> variant: ...
    def imageFileOptionsWidget(self, Extension: str) -> PySide2.QtWidgets.QWidget: ...
    def postProcessCommandList(self) -> list[str]: ...
    def registerPostProcessCommand(self, Command: str): ...
    def removeExportItem(self, Item: ExportItem): ...
    def resolutionList(self) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class GLRender(API):
    ...
    def postFilterCollectionNames(self) -> list[str]: ...
    def postFilterCollections(self) -> list[PostFilterCollection]: ...
    @classmethod
...
class GLSLFilter(PostFilter):
    ...
    def setTexture1D(self, SamplerName: str, Width: typing.SupportsInt, DataFormat: Format, Data: list[float], MinFilter: Filter = ..., MagFilter: Filter = ..., ClampS: Clamp = ..., ClampT: Clamp = ...): ...
    def setTexture2D(self, SamplerName: str, Width: typing.SupportsInt, Height: typing.SupportsInt, DataFormat: Format, Data: list[float], MinFilter: Filter = ..., MagFilter: Filter = ..., ClampS: Clamp = ..., ClampT: Clamp = ...): ...
    def setTexture3D(self, SamplerName: str, Width: typing.SupportsInt, Height: typing.SupportsInt, Depth: typing.SupportsInt, DataFormat: Format, Data: list[float], MinFilter: Filter = ..., MagFilter: Filter = ..., ClampS: Clamp = ..., ClampT: Clamp = ..., ClampR: Clamp = ...): ...
    def updateTexture1D(self, SamplerName: str, Data: list[float]): ...
    def updateTexture2D(self, SamplerName: str, Data: list[float]): ...
    def updateTexture3D(self, SamplerName: str, Data: list[float]): ...
    def __bool__(self) -> bool: ...
...
class GeoChannel(Metadata):
    ...
    def geoChannelLayers(self) -> list[Layer]: ...
    def geoChannelNodes(self) -> list[GeoChannelNode]: ...
    def imageSet(self) -> ImageSet: ...
    def name(self) -> str: ...
    def setAliases(self, Aliases: list[str]): ...
...
class GeoEntity(Lockable):
    ...
    def channelList(self) -> list[Channel]: ...
    def completePatchList(self) -> list[GeoPatch]: ...
    ...
    def geoChannels(self) -> list[GeoChannel]: ...
    def hideLocator(self): ...
    def imageSet(self): ...
    def imageSetList(self) -> list[ImageSet]: ...
    def imageSetNames(self) -> list[str]: ...
    ...
    def patchList(self) -> list[GeoPatch]: ...
    ...
    def selectedPatches(self) -> list[GeoPatch]: ...
    ...
    def shaderList(self) -> list[Shader]: ...
    @classmethod
    ...
    def versionList(self) -> list[GeoEntityVersion]: ...
    def versionNames(self) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class GeoEntityVersion(Metadata):
    ...
    def setMeshPaths(self, Paths: list[str]): ...
    ...
    def sourceMeshLocationList(self) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class GeoManager(API):
    ...
    def geometryOperationList(self) -> list[GeometryOperation]: ...
    def get(self, Name: str) -> GeoEntity: ...
    def getAnimationTakes(self, Path: str) -> list[str]: ...
    def getDefaultAnimationTake(self, Path: str) -> str: ...
    def getFileContents(self, Path: str) -> variant: ...
    def getFileFrameRange(self, Path: str, Take: str = ...) -> list[int]: ...
    def importFromArchive(self, DirPath: str): ...
    def list(self) -> list[GeoEntity]: ...
    def listLocators(self) -> list[LocatorEntity]: ...
    def load(self, Path: str, Options: variant = ..., ObjectsToLoad: variant = ..., LoadAsChild: bool = ...) -> list[GeoEntity]: ...
    def names(self) -> list[str]: ...
    def recalculatePatchBounds(self): ...
    def remove(self, Name: str): ...
    def setCurrent(self, Name: str): ...
    def supportedReadFormats(self) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class GeometryOperation(Metadata):
    ...
    def supportedOperations(self) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class GroupNode(Node):
    ...
    def knobList(self) -> list[variant]: ...
    def linkKnobs(self, KnobName: str, TargetKnobNames: list[str], PrettyKnobName: str = ...): ...
...
class Image(Metadata):
    ...
    def size(self, MipMapLevel: typing.SupportsInt = ...) -> list[int]: ...
    def thumbnail(self): ...
...
class ImageManager(Metadata):
    ...
    def compressionList(self, Extension: str) -> list[str]: ...
    ...
    def imageOperationList(self) -> list[ImageOperation]: ...
    def list(self) -> list[Image]: ...
    def open(self, Path: str, Config: ColorspaceConfig = ..., AlphaProcessing: ImageAlphaProcessing = ..., Name: str = ...) -> list[Image]: ...
    ...
    def saveImages(self, Images: list[Image], Path: str) -> bool: ...
    def selectCategory(self, CategoryName: str) -> bool: ...
    def selected(self) -> list[Image]: ...
    ...
    def supportedReadFormats(self) -> list[str]: ...
    def supportedTextureSizeList(self) -> list[variant]: ...
    def supportedWriteFormats(self): ...
    def traces(self, PathOrHash: str) -> list[str]: ...
...
class ImageMimeDataInfo(API):
    ...
    @classmethod
    def fromMimeDataString(cls, MimeDataString: str) -> list[ImageMimeDataInfo]: ...
    def path(self) -> str: ...
    def __bool__(self) -> bool: ...
...
class ImageSet(Snapshotable):
    ...
    def imageList(self, Frame: typing.SupportsInt = ...) -> list[Image]: ...
    def importImages(self, ImagePaths: variant, ScaleOption: ScaleChoice, UVIndexList: list[int] = ..., RemoveAlpha: bool = ..., SourceColorConfig: ColorspaceConfig = ...): ...
...
class Layer(Metadata):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def activeCacheUpToHereParents(self) -> list[Layer]: ...
    @classmethod
    ...
    def cacheUpToHereParents(self) -> list[Layer]: ...
    def close(self): ...
    ...
    def setVisibility(self, Visible: bool): ...
    def siblingSharedLayerList(self) -> list[Layer]: ...
    def swizzle(self): ...
...
class LayerStack(Metadata):
    ...
    def createAdjustmentLayer(self, LayerName: str, PrimaryAdjustmentKey: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createBakePointLayer(self, LayerName: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createChannelLayer(self, LayerName: str, TargetChannel: Channel, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createCustomProceduralLayer(self, LayerName: str, FilePath: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createGraphLayer(self, LayerName: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createGroupLayer(self, LayerName: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createMaterialLayer(self, LayerName: str, FilePath: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createMultiChannelGroupLayer(self, LayerName: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createPaintableLayer(self, LayerName: str, RefLayer: Layer = ..., FillColor: Color = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createProceduralLayer(self, LayerName: str, ProceduralKey: str, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def createShaderLayer(self, LayerName: str, TargetShader: Shader, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def duplicateLayers(self, LayersToDuplicate: list[Layer] = ..., RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> list[Layer]: ...
    def exportImages(self, PathAndTemplate: str, Options: typing.SupportsInt = ..., UVIndexList: list[int] = ..., FileOptions: variant = ..., OutputColorConfig: ColorspaceConfig = ...): ...
    def exportImagesFlattened(self, PathAndTemplate: str, Options: typing.SupportsInt = ..., UVIndexList: list[int] = ..., FileOptions: variant = ..., OutputColorConfig: ColorspaceConfig = ...): ...
    ...
    def findLayer(self): ...
    def groupLayers(self, LayersToGroup: list[Layer] = ..., RefLayer: Layer = ..., LayerName: str = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def hash(self, UVIndex: typing.SupportsInt = ...) -> str: ...
    def imageHash(self, UVIndex: typing.SupportsInt = ...) -> str: ...
    def importImages(self, PathAndTemplate: str, ScaleOption: ImageSet.ScaleChoice = ..., MatchingLayersOption: LayerImportOption = ..., MismatchingLayersOption: LayerImportOption = ..., UVIndexList: list[int] = ..., RemoveAlpha: bool = ..., SourceColorConfig: ColorspaceConfig = ...): ...
    def layer(self, LayerName: str) -> Layer: ...
    def layerList(self) -> list[Layer]: ...
    def mergeLayers(self, LayersToMerge: list[Layer] = ..., RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    ...
    def removeLayers(self, LayersToRemove: list[Layer] = ...): ...
    def shareLayer(self, LayerToShare: Layer, RefLayer: Layer = ..., Flags: typing.SupportsInt = ...) -> Layer: ...
    def ungroupLayers(self, GroupLayersToUngroup: list[Layer] = ...): ...
    def __bool__(self) -> bool: ...
...
class MaterialNode(GroupNode):
    ...
    def addMaterialTags(self, Tags: list[str]): ...
    def exportMaterial(self, FileName: str, ThumbnailFileName: str = ...): ...
    def geoChannels(self) -> list[str]: ...
    def materialTags(self) -> list[str]: ...
    def missingGeoChannels(self) -> list[str]: ...
    @classmethod
    ...
    @classmethod
    def readTagsFromMaterialFile(cls, MaterialFilePath: str) -> list[str]: ...
    @classmethod
    def readThumbnailFromMaterialFile(cls, MaterialFilePath: str) -> PySide2.QtWidgets.QImage: ...
    def removeMaterialTag(self, Tag: str): ...
    def removeMaterialTags(self, Tags: list[str]): ...
    def setMaterialTags(self, MaterialTags: list[str]): ...
    ...
    @classmethod
    def writeTagsToMaterialFile(cls, Tags: list[str], MaterialFilePath: str) -> bool: ...
    @classmethod
...
class MenuManager(API):
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def actions(self, rSet: str, rRoot: str, rSubMenu: str = ...) -> list[Action]: ...
    def addAction(self, pAction: Action, rPath: str, rAddBefore: str = ...): ...
    def addSeparator(self, Path: str, rAddBefore: str = ...): ...
    def itemNames(self, rSet: str, rRoot: str, rSubMenu: str = ...) -> list[str]: ...
    def removeAction(self, pAction: Action, rFullPath: str): ...
    def roots(self, rSet: str) -> list[str]: ...
    def sets(self) -> list[str]: ...
    def submenus(self, rSet: str, rRoot: str, rSubMenu: str = ...) -> list[str]: ...
    def __bool__(self) -> bool: ...
...
class Metadata(API):
    ...
    def metadataItemList(self, Name: str) -> list[str]: ...
    ...
    def setMetadataItemList(self, Name: str, ItemList: list[str]): ...
...
class MultiChannelBakePointNode(GroupNode):
    ...
    def bakeStreams(self, Streams: list[ShaderModelInput]): ...
    def deleteBake(self): ...
    def setLimitBake(self, LimitBake: bool): ...
    def setLimitBakeRange(self, LimitBakeRange: UvIndexRangeList): ...
    def shaderModel(self) -> ShaderModel: ...
...
class MultiChannelContainer(Metadata):
    ...
    def setVisibility(self, Visible: bool): ...
    def shaderModel(self) -> ShaderModel: ...
    def streamList(self) -> list[MultiChannelLayer]: ...
    def __bool__(self) -> bool: ...
...
class MultiChannelGroup(MultiChannelContainer):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def flattenLayerGroup(self) -> list[Layer]: ...
    def __bool__(self) -> bool: ...
...
class Node(Metadata):
    ...
    def nodeContextNames(self) -> list[str]: ...
    ...
    def nodePath(self): ...
    def outputNodes(self, PortName: str = ...) -> list[variant]: ...
    def outputPortCount(self) -> int: ...
    def outputPortName(self): ...
    def outputPortNames(self) -> list[str]: ...
...
class NodeGraph(Metadata):
    ...
    def autoLayoutNodes(self, Roots: list[Node]): ...
    ...
    def exportNodesAsArchive(self, DirPath: str, Nodes: list[Node], NoDataBlockCopy: bool = ..., UVIndexList: list[int] = ...) -> dict[str, str]: ...
    @classmethod
    def getAllUpstreamNodes(cls, DestNode: Node) -> list[Node]: ...
    @classmethod
    def getUpstreamNodes(cls, DestNode: Node) -> list[Node]: ...
    def groupNodes(self, Nodes: list[Node]) -> GroupNode: ...
    def importCustomProcedural(self, FileName: str) -> Node: ...
    def importMaterial(self, FileName: str) -> Node: ...
    def importNodesFromArchive(self, DirPath: str, UuidsToLoad: list[str], UvIndexMap: dict[int, list[int]]) -> list[Node]: ...
    def load(self, FilePath: str) -> list[Node]: ...
    def nodeList(self, IncludeSystemNodes: bool = ...) -> list[Node]: ...
    def nodesFromString(self, String: str) -> list[Node]: ...
    def nodesToString(self, Nodes: list[Node]) -> str: ...
    def nodesWithTag(self, Tag: str) -> list[Node]: ...
    def parentGeoEntity(self) -> GeoEntity: ...
    def parentGroupNode(self) -> GroupNode: ...
    def removeNode(self, NodeToRemove: Node): ...
    def save(self, FilePath: str, Nodes: list[Node]): ...
    def selectedNodeList(self, IncludeSystemNodes: bool = ...) -> list[Node]: ...
    def setActiveViewerInput(self, InputNumber: typing.SupportsInt): ...
    def teleportBroadcastChannelNameList(self) -> list[str]: ...
    def teleportNodeBroadcastingOnChannel(self): ...
    def teleportNodesListeningToChannel(self): ...
    @classmethod
    def topologicalSortTo(cls, DestNode: Node, ReverseOrder: bool = ...) -> list[Node]: ...
...
class NodeGraphPalette(Palette):
    ...
    def nodeGraphViewList(self) -> list[NodeGraphView]: ...
...
class ObjectSelectionGroup(SelectionGroup):
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def geoEntityList(self) -> list[GeoEntity]: ...
    def __bool__(self) -> bool: ...
...
class OpenColorIO(API):
    ...
    def colorspacePrettyNames(self, Config: str) -> list[str]: ...
    ...
    def registerConfigUiAllowlist(self, ConfigFilePath: str, Allowlist: list[str]): ...
    ...
    def standardConfigs(self) -> list[str]: ...
...
class PaintBuffer(PropertySource):
    ...
    def supportedResolutions(self) -> list[PySide2.QtWidgets.QSize]: ...
...
class PaintableLayer(AdjustableLayer):
    ...
    def exportSelectedPatches(self, PathAndTemplate: str, Options: typing.SupportsInt = ..., FileOptions: variant = ..., OutputColorConfig: ColorspaceConfig = ...): ...
    def imageSet(self) -> ImageSet: ...
    def importImages(self, PathAndTemplate: str, ScaleOption: ImageSet.ScaleChoice = ..., UVIndexList: list[int] = ..., RemoveAlpha: bool = ..., SourceColorConfig: ColorspaceConfig = ...): ...
    def setBleed(self, bleed: bool): ...
    def __bool__(self) -> bool: ...
...
class PatchLinksManager(API):
    ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def canLinkImageInternals(self, Images: list[Image]) -> bool: ...
    def canLinkImages(self, Images: list[Image], GroupName: str) -> bool: ...
    def canLinkPatchInternals(self, Patches: list[GeoPatch], pImageSet: ImageSet) -> bool: ...
    def canLinkPatches(self, Patches: list[GeoPatch], GroupName: str, pImageSet: ImageSet) -> bool: ...
    def generateUniqueGroupName(self) -> str: ...
    def groupNames(self) -> list[str]: ...
    def groupNamesForImageSet(self, pImageSet: ImageSet) -> list[str]: ...
    def imageGroup(self, Img: Image) -> str: ...
    def images(self, GroupName: str) -> list[Image]: ...
    def isImageLinked(self, Img: Image) -> bool: ...
    def isPatchLinked(self, Patch: GeoPatch, pImageSet: ImageSet) -> bool: ...
    def linkImages(self, Images: list[Image], GroupName: str): ...
    def linkPatches(self, Patches: list[GeoPatch], GroupName: str, pImageSet: ImageSet): ...
    def linkSelectedPatches(self, GroupName: str, pImageSet: ImageSet): ...
    def linkedImages(self, Img: Image) -> list[Image]: ...
    def linkedPatches(self, Patch: GeoPatch, pImageSet: ImageSet = ...) -> list[GeoPatch]: ...
    def patchGroup(self, Patch: GeoPatch, pImageSet: ImageSet) -> str: ...
    def patches(self, GroupName: str, pImageSet: ImageSet = ...) -> list[GeoPatch]: ...
...
class PostFilterCollection(Metadata):
    ...
    def filters(self) -> list[PostFilter]: ...
...
class Preferences(API):
    ...
    def setItemList(self, Path: str, ItemList: list[str]): ...
...
class ProceduralLayer(AdjustableLayer):
    ...
    def proceduralParameters(self) -> list[str]: ...
...
class Project(PropertySource):
    ...
    def name(self) -> str: ...
    def remapConfigColorspaces(self, ColorspaceRemappings: dict[str, variant], FileName: str = ..., Stages: list[int] = ...): ...
...
class ProjectManager(API):
    ...
    def create(self, Name: str, MeshPaths: variant, ChannelsToCreate: list[ChannelInfo], ChannelsToImport: list[ChannelInfo] = ..., ProjectMetaOptions: variant = ..., ObjectsToLoad: variant = ..., ColorspaceSettings: ColorspaceDefaults = ...): ...
...
class ProjectionManager(PropertySource):
    ...
    def paintingModeList(self) -> list[Layer.BlendMode]: ...
    def paintingModePath(self) -> str: ...
    def paintingModePathList(self) -> list[str]: ...
    def paintingModeStr(self) -> str: ...
    def paintingModeStrList(self) -> list[str]: ...
...
class Projector(Metadata):
    ...
    def projectionMaskNameList(self) -> list[str]: ...
    ...
    def useShaderList(self) -> list[str]: ...
    def width(self) -> int: ...
    def __bool__(self) -> bool: ...
...
class ProjectorManager(API):
    ...
    def list(self) -> list[Projector]: ...
    def load(self, Path: str, Options: list[str] = ..., CameraNames: variant = ...) -> list[Projector]: ...
    def names(self) -> list[str]: ...
    def remove(self, Name: str): ...
    def selection(self) -> list[Projector]: ...
...
class Ptex(Metadata):
    ...
    def validFaceSizes(self) -> list[int]: ...
    def __bool__(self) -> bool: ...
...
class ResourceInfo(API):
    ...
    def pathList(self, Key: str) -> list[str]: ...
    ...
    def setPathList(self, Key: str, NewPathList: list[str]): ...
...
class SelectionGroupManager(API):
    ...
    def list(self) -> list[SelectionGroup]: ...
    ...
    def selection(self) -> list[SelectionGroup]: ...
...
class Shader(Metadata):
    ...
    def inputList(self) -> list[variant]: ...
    def inputNameList(self) -> list[str]: ...
    ...
    def makeCurrent(self): ...
    def name(self) -> str: ...
    def parameterNameList(self) -> list[str]: ...
...
class ShelfManager(API):
    ...
    def list(self) -> list[Shelf]: ...
    def names(self) -> list[str]: ...
    def removeShelf(self, ShelfToRemove: Shelf) -> bool: ...
    def search(self, SearchKeyword: str, Shelves: list[Shelf]) -> list[ShelfItem]: ...
...
class ToolBar(WidgetBase):
    ...
    def addAction(self, Path: str, Pos: list[int] = ..., Removable: bool = ...): ...
    def addActionBefore(self, Path: str, InsertBefore: PySide2.QtWidgets.QAction = ..., Removable: bool = ...): ...
    def addActionList(self, Actions: list[str], Removable: bool): ...
