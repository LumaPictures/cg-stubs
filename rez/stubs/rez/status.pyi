...
class Status:
    ...
    def print_info(self, obj: Incomplete | None = None, buf=...):
        ...
        """
    def print_tools(self, pattern: Incomplete | None = None, buf=...):
        """Print a list of visible tools.

        Args:
            pattern (str): Only list tools that match this glob pattern.
        """
    def _print_tool_info(self, value, buf=..., b: bool = False): ...
    def _print_package_info(self, value, buf=..., b: bool = False): ...
    def _print_suite_info(self, value, buf=..., b: bool = False): ...
    def _print_context_info(self, value, buf=..., b: bool = False): ...
