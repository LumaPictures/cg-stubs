...
class SourceCode:
    ...
    func: Incomplete
    filepath: Incomplete
    eval_as_function: Incomplete
    package: Incomplete
    funcname: Incomplete
    decorators: Incomplete
    def __init__(self, source: str | None = None, func: FunctionType | MethodType | None = None, filepath: Incomplete | None = None, eval_as_function: bool = True) -> None: ...
    def copy(self): ...
