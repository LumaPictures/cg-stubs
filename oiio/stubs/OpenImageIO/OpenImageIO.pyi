...
class ImageBufAlgo:
    ...
    @staticmethod
    def isConstantColor(src: ImageBuf, threshold: float = ..., roi: ROI = ..., nthreads: int = ...) -> tuple[float, ...]: ...
    @staticmethod
...
class ImageCache:
    ...
    def getattribute(self, name: str, type: TypeDesc | BASETYPE | str = ...) -> Any: ...
...
class ImageInput:
    ...
    def read_native_deep_image(self, subimage: int = ..., miplevel: int = ...) -> DeepData | None: ...
    @overload
    ...
    @overload
    def read_native_deep_scanlines(self, ybegin: int, yend: int, z: int, chbegin: int, chend: int) -> DeepData | None: ...
    @overload
    ...
    @overload
    def read_native_deep_tiles(self, xbegin: int, xend: int, ybegin: int, yend: int, zbegin: int, zend: int, chbegin: int, chend: int) -> DeepData | None: ...
...
def getattribute(arg0: str, arg1: TypeDesc | BASETYPE | str, /) -> Any: ...
