...
class RopNode(Node):
    ...
    def addRenderEventCallback(self: RopNode, callback: Callable[[RopNode, ropRenderEventType, float], None], run_before_script: bool=False) -> None: ...
    def removeRenderEventCallback(self: RopNode, callback: Callable[[RopNode, ropRenderEventType, float], None]) -> None: ...
