...
class QWebSocket(PySide6.QtCore.QObject):
    ...
    alertReceived: typing.ClassVar[PySide6.QtCore.Signal[typing.Any, typing.Any, str]] = ...
    alertSent: typing.ClassVar[PySide6.QtCore.Signal[typing.Any, typing.Any, str]] = ...
    authenticationRequired: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    binaryFrameReceived: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QByteArray, bool]] = ...
    binaryMessageReceived: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QByteArray]] = ...
    bytesWritten: typing.ClassVar[PySide6.QtCore.Signal[int]] = ...
    connected: typing.ClassVar[PySide6.QtCore.Signal[()]] = ...
    disconnected: typing.ClassVar[PySide6.QtCore.Signal[()]] = ...
    error: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    errorOccurred: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    handshakeInterruptedOnError: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    peerVerifyError: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    pong: typing.ClassVar[PySide6.QtCore.Signal[typing.Any, PySide6.QtCore.QByteArray]] = ...
    preSharedKeyAuthenticationRequired: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    proxyAuthenticationRequired: typing.ClassVar[PySide6.QtCore.Signal[typing.Any, typing.Any]] = ...
    readChannelFinished: typing.ClassVar[PySide6.QtCore.Signal[()]] = ...
    sslErrors: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    stateChanged: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    textFrameReceived: typing.ClassVar[PySide6.QtCore.Signal[str, bool]] = ...
    textMessageReceived: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
...
class QWebSocketServer(PySide6.QtCore.QObject):
    class SslMode(enum.Enum):
        NonSecureMode = 1
        SecureMode = 0
    acceptError: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    alertReceived: typing.ClassVar[PySide6.QtCore.Signal[typing.Any, typing.Any, str]] = ...
    alertSent: typing.ClassVar[PySide6.QtCore.Signal[typing.Any, typing.Any, str]] = ...
    closed: typing.ClassVar[PySide6.QtCore.Signal[()]] = ...
    handshakeInterruptedOnError: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    newConnection: typing.ClassVar[PySide6.QtCore.Signal[()]] = ...
    originAuthenticationRequired: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtWebSockets.QWebSocketCorsAuthenticator]] = ...
    peerVerifyError: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    preSharedKeyAuthenticationRequired: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    serverError: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtWebSockets.QWebSocketProtocol.CloseCode]] = ...
    sslErrors: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
