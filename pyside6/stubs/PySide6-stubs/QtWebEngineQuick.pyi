...
class QQuickWebEngineProfile(PySide6.QtCore.QObject):
    ...
    class PersistentPermissionsPolicy(enum.Enum):
        ...
        StoreInMemory = 1
        StoreOnDisk = 2
    cachePathChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    clearHttpCacheCompleted: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    downloadFinished: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtWebEngineQuick.QQuickWebEngineDownloadRequest]]] = ...
    downloadPathChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    downloadRequested: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtWebEngineQuick.QQuickWebEngineDownloadRequest]]] = ...
    httpAcceptLanguageChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    httpCacheMaximumSizeChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    httpCacheTypeChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    httpUserAgentChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    offTheRecordChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    persistentCookiesPolicyChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    persistentPermissionsPolicyChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    persistentStoragePathChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    presentNotification: typing.ClassVar[PySide6.QtCore.Signal[tuple[typing.Any]]] = ...
    pushServiceEnabledChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    spellCheckEnabledChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    spellCheckLanguagesChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    storageNameChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    @typing.overload
