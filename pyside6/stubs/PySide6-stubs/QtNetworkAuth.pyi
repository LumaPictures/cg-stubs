...
class QAbstractOAuth(PySide6.QtCore.QObject):
    ...
    authorizationUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    authorizeWithBrowser: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    clientIdentifierChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    contentTypeChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtNetworkAuth.QAbstractOAuth.ContentType]] = ...
    extraTokensChanged: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    finished: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    granted: typing.ClassVar[PySide6.QtCore.Signal[()]] = ...
    replyDataReceived: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QByteArray]] = ...
    requestFailed: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtNetworkAuth.QAbstractOAuth.Error]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    statusChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtNetworkAuth.QAbstractOAuth.Status]] = ...
    tokenChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
...
class QAbstractOAuth2(QAbstractOAuth):
    ...
    authorizationCallbackReceived: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    autoRefreshChanged: typing.ClassVar[PySide6.QtCore.Signal[bool]] = ...
    clientIdentifierSharedKeyChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    error: typing.ClassVar[PySide6.QtCore.Signal[str, str, PySide6.QtCore.QUrl]] = ...
    expirationAtChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QDateTime]] = ...
    grantedScopeTokensChanged: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    idTokenChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    nonceChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    nonceModeChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtNetworkAuth.QAbstractOAuth2.NonceMode]] = ...
    refreshLeadTimeChanged: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    refreshTokenChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    requestedScopeTokensChanged: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    responseTypeChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    scopeChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    serverReportedErrorOccurred: typing.ClassVar[PySide6.QtCore.Signal[str, str, PySide6.QtCore.QUrl]] = ...
    sslConfigurationChanged: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    stateChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    tokenUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    userAgentChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    @typing.overload
...
class QAbstractOAuthReplyHandler(PySide6.QtCore.QObject):
    callbackDataReceived: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QByteArray]] = ...
    callbackReceived: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
    replyDataReceived: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QByteArray]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    tokenRequestErrorOccurred: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtNetworkAuth.QAbstractOAuth.Error, str]] = ...
    tokensReceived: typing.ClassVar[PySide6.QtCore.Signal[typing.Any]] = ...
...
class QOAuth1(QAbstractOAuth):
    class SignatureMethod(enum.Enum):
        ...
        PlainText = 2
        Rsa_Sha1 = 1
    clientSharedSecretChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    signatureMethodChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtNetworkAuth.QOAuth1.SignatureMethod]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    temporaryCredentialsUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    tokenCredentialsUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    tokenSecretChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    @typing.overload
...
class QOAuth2AuthorizationCodeFlow(QAbstractOAuth2):
    class PkceMethod(enum.Enum):
        ...
        Plain = 1
        S256 = 0
    accessTokenUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    @typing.overload
...
class QOAuth2DeviceAuthorizationFlow(QAbstractOAuth2):
    authorizeWithUserCode: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl, str, PySide6.QtCore.QUrl]] = ...
    completeVerificationUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    pollingChanged: typing.ClassVar[PySide6.QtCore.Signal[bool]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    userCodeChanged: typing.ClassVar[PySide6.QtCore.Signal[str]] = ...
    userCodeExpirationAtChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QDateTime]] = ...
    verificationUrlChanged: typing.ClassVar[PySide6.QtCore.Signal[PySide6.QtCore.QUrl]] = ...
    @typing.overload
