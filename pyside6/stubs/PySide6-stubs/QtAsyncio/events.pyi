...
class QAsyncioEventLoop(asyncio.BaseEventLoop, QObject):
    ...
    async def sock_recvfrom(self, sock, bufsize) -> None: ...  # type: ignore[override]
    async def sock_recvfrom_into(self, sock, buf, nbytes: int = 0) -> None: ...  # type: ignore[override]
    async def sock_sendall(self, sock, data) -> None: ...
    async def sock_sendto(self, sock, data, address) -> None: ...  # type: ignore[override]
