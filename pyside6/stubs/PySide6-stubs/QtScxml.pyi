...
class QScxmlDataModel(PySide6.QtCore.QObject):
    class ForeachLoopBody(shiboken6.Object):
        def __init__(self, /) -> None: ...
        def run(self, /) -> bool: ...
    stateMachineChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtScxml.QScxmlStateMachine]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
...
class QScxmlEvent(shiboken6.Object):
    class EventType(enum.Enum):
        ...
        PlatformEvent = 0
    @typing.overload
    def __init__(self, other: QScxmlEvent, /, *, name: str | None = ..., eventType: QScxmlEvent.EventType | None = ..., scxmlType: str | None = ..., sendId: str | None = ..., origin: str | None = ..., originType: str | None = ..., invokeId: str | None = ..., delay: int | None = ..., data: typing.Any | None = ..., errorEvent: bool | None = ..., errorMessage: str | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, name: str | None = ..., eventType: QScxmlEvent.EventType | None = ..., scxmlType: str | None = ..., sendId: str | None = ..., origin: str | None = ..., originType: str | None = ..., invokeId: str | None = ..., delay: int | None = ..., data: typing.Any | None = ..., errorEvent: bool | None = ..., errorMessage: str | None = ...) -> None: ...
    def clear(self, /) -> None: ...
    def data(self, /) -> Any: ...
    def delay(self, /) -> int: ...
...
class QScxmlStateMachine(PySide6.QtCore.QObject):
    dataModelChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtScxml.QScxmlDataModel]]] = ...
    finished: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    initialValuesChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[typing.Any]]] = ...
    initializedChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[bool]]] = ...
    invokedServicesChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[typing.Any]]] = ...
    loaderChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtScxml.QScxmlCompiler.Loader]]] = ...
    log: typing.ClassVar[PySide6.QtCore.Signal[tuple[str, str]]] = ...
    reachedStableState: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    runningChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[bool]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    tableDataChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtScxml.QScxmlTableData]]] = ...
