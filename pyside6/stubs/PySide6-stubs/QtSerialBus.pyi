...
class QCanBusDevice(PySide6.QtCore.QObject):
    ...
    errorOccurred: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtSerialBus.QCanBusDevice.CanBusError]]] = ...
    framesReceived: typing.ClassVar[PySide6.QtCore.Signal[tuple[()]]] = ...
    framesWritten: typing.ClassVar[PySide6.QtCore.Signal[tuple[int]]] = ...
    stateChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtSerialBus.QCanBusDevice.CanBusDeviceState]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
...
class QModbusDevice(PySide6.QtCore.QObject):
    ...
    class State(enum.Enum):
        ...
        ConnectingState = 1
        UnconnectedState = 0
    errorOccurred: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtSerialBus.QModbusDevice.Error]]] = ...
    stateChanged: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtSerialBus.QModbusDevice.State]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ..., destroyed: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ...) -> None: ...
    def close(self, /) -> None: ...
    def connectDevice(self, /) -> bool: ...
...
class QModbusReply(PySide6.QtCore.QObject):
    ...
    intermediateErrorOccurred: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtSerialBus.QModbusDevice.IntermediateError]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
...
class QModbusServer(QModbusDevice):
    class Option(enum.Enum):
        ...
        ServerIdentifier = 5
        UserOption = 256
    dataWritten: typing.ClassVar[PySide6.QtCore.Signal[tuple[PySide6.QtSerialBus.QModbusDataUnit.RegisterType, int, int]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ..., destroyed: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ...) -> None: ...
    @typing.overload
...
class QModbusTcpServer(QModbusServer):
    modbusClientDisconnected: typing.ClassVar[PySide6.QtCore.Signal[tuple[typing.Any]]] = ...
    staticMetaObject: typing.ClassVar[PySide6.QtCore.QMetaObject] = ...
