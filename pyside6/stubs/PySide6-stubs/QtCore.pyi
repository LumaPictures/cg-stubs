...
class SignalInstance(typing.Generic[typing_extensions.Unpack[_SignalSignatures]]):
    ...
    def __init__(cls, *args, **kwargs) -> None: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, typing_extensions.Unpack[_SignalArgT]], typing_extensions.Unpack[_SignalSignatures]], slot: _SlotFunc[()] | _SlotFunc[_T1] | _SignalEmitter[()] | _SignalEmitter[_T1], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, _T2, typing_extensions.Unpack[_SignalArgT]], typing_extensions.Unpack[_SignalSignatures]], slot: _SlotFunc[_T1, _T2] | _SignalEmitter[_T1, _T2], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, _T2, _T3, typing_extensions.Unpack[_SignalArgT]], typing_extensions.Unpack[_SignalSignatures]], slot: _SlotFunc[_T1, _T2, _T3] | _SignalEmitter[_T1, _T2, _T3], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[typing_extensions.Unpack[_SignalArgT]], typing_extensions.Unpack[_SignalSignatures]], slot: _SlotFunc[typing_extensions.Unpack[_SignalArgT]] | _SignalEmitter[typing_extensions.Unpack[_SignalArgT]], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
