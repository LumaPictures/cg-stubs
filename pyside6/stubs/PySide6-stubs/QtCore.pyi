...
class Signal(typing.Generic[*_SignalSignatures]):
    @typing.overload
    ...
    def __call__(self, *args, **kwargs): ...
    @typing.overload
    def __get__(self, instance: None, owner: type[QObject]) -> Signal[*_SignalSignatures]: ...
    @typing.overload
    def __get__(self, instance: QObject, owner: type[QObject]) -> SignalInstance[*_SignalSignatures]: ...
    @typing.overload
    def __getitem__(self: Signal[tuple[_T1],*_SignalSignatures1], index: type[_T1]) -> SignalInstance[tuple[_T1]]: ...
    @typing.overload
    def __getitem__(self: Signal[tuple[_T1, _T2],*_SignalSignatures1], index: tuple[type[_T1], type[_T2]]) -> SignalInstance[tuple[_T1, _T2]]: ...
    @typing.overload
    def __getitem__(self: Signal[tuple[_T1, _T2, _T3],*_SignalSignatures1], index: tuple[type[_T1], type[_T2], type[_T3]]) -> SignalInstance[tuple[_T1, _T2, _T3]]: ...
    @typing.overload
    def __getitem__(self: Signal[tuple[_T1, _T2, _T3, _T4],*_SignalSignatures1], index: tuple[type[_T1], type[_T2], type[_T3], type[_T4]]) -> SignalInstance[tuple[_T1, _T2, _T3, _T4]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[_T1]], index: type[_T1]) -> SignalInstance[tuple[_T1]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[_T1, _T2]], index: tuple[type[_T1], type[_T2]]) -> SignalInstance[tuple[_T1, _T2]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[_T1, _T2, _T3]], index: tuple[type[_T1], type[_T2], type[_T3]]) -> SignalInstance[tuple[_T1, _T2, _T3]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[_T1, _T2, _T3, _T4]], index: tuple[type[_T1], type[_T2], type[_T3], type[_T4]]) -> SignalInstance[tuple[_T1, _T2, _T3, _T4]]: ...
    @typing.overload
    def __getitem__(self, index: tuple[type, ...]) -> SignalInstance: ...

class SignalInstance(typing.Generic[*_SignalSignatures]):
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1,*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[()] | _SlotFunc[_T1] | _SignalEmitter[()] | _SignalEmitter[_T1], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, _T2,*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[_T1, _T2] | _SignalEmitter[_T1, _T2], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, _T2, _T3,*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[_T1, _T2, _T3] | _SignalEmitter[_T1, _T2, _T3], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[*_SignalArgT]|_SignalEmitter[*_SignalArgT], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    def disconnect(self: SignalInstance[tuple[*_SignalArgT],*_SignalSignatures], /, slot: _SlotFunc[*_SignalArgT]|_SignalEmitter[*_SignalArgT]|None = ...) -> bool: ...
    def emit(self: SignalInstance[tuple[*_SignalArgT],*_SignalSignatures], /, *args: *_SignalArgT) -> None: ...
    def __call__(self: SignalInstance[tuple[*_SignalArgT],*_SignalSignatures], /, *args: *_SignalArgT) -> None: ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[_T1],*_SignalSignatures1], index: type[_T1]) -> SignalInstance[tuple[_T1]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[_T1, _T2],*_SignalSignatures1], index: tuple[type[_T1], type[_T2]]) -> SignalInstance[tuple[_T1, _T2]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[_T1, _T2, _T3],*_SignalSignatures1], index: tuple[type[_T1], type[_T2], type[_T3]]) -> SignalInstance[tuple[_T1, _T2, _T3]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[_T1, _T2, _T3, _T4],*_SignalSignatures1], index: tuple[type[_T1], type[_T2], type[_T3], type[_T4]]) -> SignalInstance[tuple[_T1, _T2, _T3, _T4]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[_T1]], index: type[_T1]) -> SignalInstance[tuple[_T1]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[_T1, _T2]], index: tuple[type[_T1], type[_T2]]) -> SignalInstance[tuple[_T1, _T2]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[_T1, _T2, _T3]], index: tuple[type[_T1], type[_T2], type[_T3]]) -> SignalInstance[tuple[_T1, _T2, _T3]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[_T1, _T2, _T3, _T4]], index: tuple[type[_T1], type[_T2], type[_T3], type[_T4]]) -> SignalInstance[tuple[_T1, _T2, _T3, _T4]]: ...
    @typing.overload
    def __getitem__(self, index: tuple[type, ...]) -> SignalInstance: ...
