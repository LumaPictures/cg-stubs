...
class SignalInstance(typing.Generic[*_SignalSignatures]):
    ...
    def __init__(cls, *args, **kwargs) -> None: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1,*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[()] | _SlotFunc[_T1], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, _T2,*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[_T1, _T2], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[_T1, _T2, _T3,*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[_T1, _T2, _T3], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[*_SignalArgT],*_SignalSignatures], slot: _SlotFunc[*_SignalArgT], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    def disconnect(self: SignalInstance[tuple[*_SignalArgT],*_SignalSignatures], /, slot: _SlotFunc[*_SignalArgT]|None = ...) -> bool: ...
