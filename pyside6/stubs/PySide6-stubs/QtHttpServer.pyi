...
class QAbstractHttpServer(PySide6.QtCore.QObject):
    ...
    def configuration(self, /) -> QHttpServerConfiguration: ...
    ...
    def setConfiguration(self, config: QHttpServerConfiguration, /) -> None: ...
...
class QHttpServerConfiguration(shiboken6.Object):
    @typing.overload
    def __init__(self, other: QHttpServerConfiguration, /) -> None: ...
    @typing.overload
    def __init__(self, /) -> None: ...
    ...
    def swap(self, other: QHttpServerConfiguration, /) -> None: ...
    def __copy__(self, /) -> typing_extensions.Self: ...
