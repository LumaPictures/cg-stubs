...
def import_project_resource(file_path: str, resource_usage: Usage, name: str = None, group: str = None) -> Resource: ...
def import_session_resource(file_path: str, resource_usage: Usage, name: str = None, group: str = None) -> Resource: ...
...
from _substance_painter.resource import UpdateProjectStatus as UpdateProjectStatus
...
class Shelf:
    ...
    def import_resource(self, file_path: str, resource_usage: Usage, name: str = None, group: str = None, uuid: str = None) -> Resource: ...
