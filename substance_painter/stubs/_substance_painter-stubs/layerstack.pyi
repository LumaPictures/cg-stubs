...
class FillProjectionParams:
    ...
    hardness: float | None
    projection_3d_offset: float | None
    projection_3d_rotation: float | None
    projection_3d_scale: float | None
    projection_depth: float | None
    shape_crop_mode: ShapeCropMode | None
    source_uv_set: int | None
    uv_transformation_offset: float | None
    uv_transformation_rotation: float | None
    uv_transformation_scale: float | None
...
def create_smart_mask(*args, **kwargs): ...
def create_smart_material(*args, **kwargs): ...
