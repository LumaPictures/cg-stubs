...
def file_path() -> str: ...
def file_url() -> str: ...
def get_scene_bounding_box() -> tuple[float, float, float]: ...
def get_uuid() -> str: ...
def is_busy() -> bool: ...
...
def state() -> State: ...
def switch_color_workflow_to_ocio(config_filepath: str, colorspace_bitmap_int: str, colorspace_bitmap_int: str, colorspace_bitmap_float: str, colorspace_materials: str, colorspace_export_int: str, colorspace_export_int: str, colorspace_export_float: str, colorspace_standard_srgb: str) -> None: ...
