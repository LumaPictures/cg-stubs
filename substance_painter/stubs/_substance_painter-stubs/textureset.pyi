...
def material_description(texture_set_id: int) -> str: ...
def material_from_stack(stack_id: int) -> int: ...
def material_name(texture_set_id: int) -> str: ...
def original_material_name(texture_set_id: int) -> str: ...
...
def set_material_description(texture_set_id: int, description: str) -> None: ...
def set_material_name(texture_set_id: int, name: str) -> None: ...
...
def set_uv_tile_description(texture_set_id: int, uv_tile: int, description: str) -> None: ...
def set_uv_tile_name(texture_set_id: int, uv_tile: int, name: str) -> None: ...
...
def uv_tile_description(texture_set_id: int, uv_tile: int) -> str: ...
def uv_tile_name(texture_set_id: int, uv_tile: int) -> str: ...
