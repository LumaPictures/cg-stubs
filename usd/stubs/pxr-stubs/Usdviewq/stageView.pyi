...
class HUD:
    ...
    def updateGroup(self, name, x, y, col, dic, keys): ...
...
class StageView(PySide6.QtOpenGLWidgets.QOpenGLWidget):
    ...
    def __init__(self, parent, dataModel, makeTimer: type[pxr.Usdviewq.common.Timer] = ...) -> None: ...
    def DrawAxis(self, viewProjectionMatrix): ...
    def DrawCameraGuides(self, mvpMatrix): ...
    def ExportFreeCameraToStage(self, stage, defcamName: str = ..., imgWidth, imgHeight):
        """
        ...
        """
    def ExportSession(self, stagePath, defcamName: str = ..., imgWidth, imgHeight):
        """
