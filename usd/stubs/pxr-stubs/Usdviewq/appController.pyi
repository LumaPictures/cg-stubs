...
class AppController(PySide6.QtCore.QObject):
    ...
    def _cacheViewerModeEscapeSizes(self, pos, index): ...
    ...
    def _onCompositionSelectionChanged(self, curr, prev): ...
    def _onDomeLightClicked(self, checked): ...
    def _onDomeLightTexturesVisibleClicked(self, checked): ...
    ...
    def _populateChildren(self, item, depth: int = ..., maxDepth: int = ..., childrenToAdd):  # type: ignore[syntax]
    ...
    def _resetView(self, selectPrim):
    ...
    def _updateCompositionView(self, obj):
    ...
    def _updateLayerStackView(self, obj):
        """ Sets the contents of the layer stack viewer"""
    def _updateMetadataView(self, obj):
    ...
    def _updatePropertiesFromPropertyView(self):
        """Update the data model's property selection to match property view's
                current selection.
        """
    def _updatePropertyInspector(self, index, obj): ...
