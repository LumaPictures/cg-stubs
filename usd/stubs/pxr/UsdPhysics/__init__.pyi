...
class CollisionAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def CreateCollisionEnabledAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
...
class CollisionGroup(pxr.Usd.Typed):
    ...
    def CreateInvertFilteredGroupsAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateMergeGroupNameAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class DistanceJoint(Joint):
    ...
    @overload
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def CreateMaxDistanceAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateMinDistanceAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class DriveAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def Apply(cls, prim: pxr.Usd.Prim, name: str) -> DriveAPI: ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim, name: str) -> _CanApplyResult: ...
    def CreateDampingAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateMaxForceAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateStiffnessAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateTargetPositionAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateTargetVelocityAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateTypeAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @overload
    @classmethod
    def Get(cls, prim: pxr.Usd.Prim, name: str) -> DriveAPI: ...
    @overload
    @classmethod
...
class Joint(pxr.UsdGeom.Imageable):
    ...
    def CreateBreakForceAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateBreakTorqueAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateCollisionEnabledAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateExcludeFromArticulationAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateJointEnabledAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateLocalPos0Attr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateLocalPos1Attr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateLocalRot0Attr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateLocalRot1Attr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class LimitAPI(pxr.Usd.APISchemaBase):
    ...
    def __init__(self, arg2: pxr.Usd.SchemaBase, arg3: object) -> None: ...
    @classmethod
    def Apply(cls, prim: pxr.Usd.Prim, name: str) -> LimitAPI: ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim, name: str) -> _CanApplyResult: ...
    def CreateHighAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateLowAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @overload
    @classmethod
    def Get(cls, prim: pxr.Usd.Prim, name: str) -> LimitAPI: ...
    @overload
    @classmethod
...
class MassAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def CreateCenterOfMassAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateDensityAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateDiagonalInertiaAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateMassAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreatePrincipalAxesAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class MaterialAPI(pxr.Usd.APISchemaBase):
    ...
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def CreateDensityAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateDynamicFrictionAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateRestitutionAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateStaticFrictionAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class MeshCollisionAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def CreateApproximationAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class PrismaticJoint(Joint):
    ...
    def CreateLowerLimitAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateUpperLimitAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class RigidBodyAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def ComputeMassProperties(self, arg2: pxr.Gf.Vec3f) -> tuple: ...
    def CreateAngularVelocityAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateKinematicEnabledAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateRigidBodyEnabledAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateSimulationOwnerRel(self) -> pxr.Usd.Relationship: ...
    def CreateStartsAsleepAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateVelocityAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class Scene(pxr.Usd.Typed):
    ...
    @overload
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def CreateGravityDirectionAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateGravityMagnitudeAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class SphericalJoint(Joint):
    ...
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def CreateAxisAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateConeAngle0LimitAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateConeAngle1LimitAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
