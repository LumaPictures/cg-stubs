...
class FileFormat(Boost.Python.instance):
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    def CanRead(self, arg2: str) -> bool: ...
    @classmethod
    ...
    @overload
    @classmethod
    def FindByExtension(cls, extension: str, args: FileFormatArguments) -> FileFormat: ...
    @overload
    @classmethod
    def FindByExtension(cls, extension: str, target: str = ...) -> FileFormat: ...
    @classmethod
    def FindById(cls, arg1: str) -> FileFormat: ...
    @classmethod
    def FormatSupportsEditing(cls, extension: str, target: str = ...) -> bool: ...
    @classmethod
    def FormatSupportsReading(cls, extension: str, target: str = ...) -> bool: ...
    @classmethod
    def FormatSupportsWriting(cls, extension: str, target: str = ...) -> bool: ...
    @classmethod
    def GetFileExtension(cls, arg1: str) -> str: ...
    def GetFileExtensions(self) -> list[str]: ...
    def IsPackage(self) -> bool: ...
    def IsSupportedExtension(self, arg2: str) -> bool: ...
...
class Layer(Boost.Python.instance):
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def AddToMutedLayers(cls, arg1: str) -> None: ...
    def Apply(self, arg2: BatchNamespaceEdit) -> bool: ...
    def ApplyRootPrimOrder(self, arg2: list[str]) -> list: ...
    ...
    def ComputeAbsolutePath(self, arg2: str) -> str: ...
    @overload
    @classmethod
    def CreateAnonymous(cls, tag: str = ..., args: dict = ...) -> Layer: ...
    @overload
    @classmethod
    def CreateAnonymous(cls, tag: str, format: FileFormat, args: dict = ...) -> Layer: ...
    @classmethod
    def CreateIdentifier(cls, arg1: str, arg2: FileFormatArguments) -> str: ...
    @classmethod
    ...
    def Export(self, filename: str, comment: str = ..., args: dict = ...) -> bool: ...
    def ExportToString(self, *args, **kwargs) -> Any: ...
    @classmethod
    def Find(cls, filename) -> LayerPtr: ...
    @classmethod
    def FindOrOpen(cls, identifier: str, args: dict = ...) -> Layer: ...
    @classmethod
    def FindOrOpenRelativeToLayer(cls, anchor: Layer, identifier: str, args: dict = ...) -> Layer: ...
    @classmethod
    ...
    @classmethod
    def GetDisplayNameFromIdentifier(cls, arg1: str) -> str: ...
    ...
    def Import(self, arg2: str) -> bool: ...
    def ImportFromString(self, arg2: str) -> bool: ...
    @classmethod
    def IsAnonymousLayerIdentifier(cls, arg1: str) -> bool: ...
    def IsDetached(self) -> bool: ...
    @classmethod
    def IsIncludedByDetachedLayerRules(cls, arg1: str) -> bool: ...
    @classmethod
    def IsMuted(cls) -> bool: ...
    def ListAllTimeSamples(self) -> list[float]: ...
    def ListTimeSamplesForPath(self, arg2: Path) -> list[float]: ...
    @classmethod
    def New(cls, fileFormat: FileFormat, identifier: str, args: dict = ...) -> Layer: ...
    @classmethod
    def OpenAsAnonymous(cls, filePath: str = ..., metadataOnly: bool = ..., tag: str = ...) -> Layer: ...
    ...
    @classmethod
    def RemoveFromMutedLayers(cls, arg1: str) -> None: ...
    ...
    @classmethod
    def SplitIdentifier(cls, arg1: str) -> tuple: ...
    def StreamsData(self) -> bool: ...
    def TransferContent(self, arg2: Layer) -> None: ...
    def Traverse(self, path: Path, func: TraversalFunction) -> None: ...
    def UpdateAssetInfo(self) -> None: ...
    def UpdateCompositionAssetDependency(self, arg2: str, arg3: str) -> bool: ...
    def UpdateExternalReference(self, arg2: str, arg3: str) -> bool: ...
...
class NamespaceEdit(Boost.Python.instance):
    ...
    @classmethod
    def Rename(cls, arg1: Path, arg2: str) -> NamespaceEdit: ...
    @classmethod
    def Reorder(cls, arg1: Path, arg2: int) -> NamespaceEdit: ...
    @classmethod
    def Reparent(cls, arg1: Path, arg2: Path, arg3: int) -> NamespaceEdit: ...
    @classmethod
    def ReparentAndRename(cls, arg1: Path, arg2: Path, arg3: str, arg4: int) -> NamespaceEdit: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __reduce__(self) -> Any: ...
    @property
...
class Path(Boost.Python.instance):
    ...
    @overload
    def __init__(self, arg2: Path) -> None: ...
    def AppendChild(self, arg2: str) -> Path: ...
    def AppendElementString(self, arg2: str) -> Path: ...
    def AppendExpression(self) -> Path: ...
    def AppendMapper(self, arg2: Path) -> Path: ...
    def AppendMapperArg(self, arg2: str) -> Path: ...
    def AppendPath(self, arg2: Path) -> Path: ...
    def AppendProperty(self, arg2: str) -> Path: ...
    def AppendRelationalAttribute(self, arg2: str) -> Path: ...
    def AppendTarget(self, arg2: Path) -> Path: ...
    def AppendVariantSelection(self, arg2: str, arg3: str) -> Path: ...
    ...
    @classmethod
    def GetConciseRelativePaths(cls, arg1: list[Path]) -> list[Path]: ...
    ...
    @classmethod
    def IsValidIdentifier(cls, arg1: str) -> bool: ...
    @classmethod
    def IsValidNamespacedIdentifier(cls, arg1: str) -> bool: ...
    @classmethod
    def IsValidPathString(cls, arg1: str) -> _IsValidPathStringResult: ...
    @overload
    @classmethod
    ...
    def ReplaceName(self, arg2: str) -> Path: ...
    ...
    @classmethod
    def StripPrefixNamespace(cls, arg1: str, arg2: str) -> tuple: ...
    @classmethod
    def TokenizeIdentifier(cls, arg1: str) -> list[str]: ...
    def __bool__(self) -> bool: ...
    def __eq__(self, other: object) -> bool: ...
    def __ge__(self, other: object) -> bool: ...
    def __gt__(self, other: object) -> bool: ...
...
class PrimSpec(Spec):
    ...
    @overload
    def __init__(self, tupleargs, dictkwds) -> None: ...
    def ApplyNameChildrenOrder(self, arg2: list[str]) -> list: ...
    def ApplyPropertyOrder(self, arg2: list[str]) -> list: ...
    def BlockVariantSelection(self, arg2: str) -> None: ...
    def CanSetName(self, arg2: str) -> bool: ...
    ...
    def GetPropertyAtPath(self, arg2: Path) -> PropertySpec: ...
    def GetRelationshipAtPath(self, arg2: Path) -> RelationshipSpec: ...
    def GetVariantNames(self, arg2: str) -> list[str]: ...
...
class Spec(Boost.Python.instance):
    ...
    def GetInfo(self, arg2: str) -> Any: ...
    def GetMetaDataDisplayGroup(self, arg2: str) -> str: ...
    ...
    def SetInfo(self, arg2: str, arg3: Any) -> None: ...
    def SetInfoDictionaryValue(self, arg2: str, arg3: str, arg4: Any) -> None: ...
    def __bool__(self) -> bool: ...
    def __eq__(self, other: object) -> bool: ...
    def __ge__(self, other: object) -> bool: ...
    def __gt__(self, other: object) -> bool: ...
...
def ComputeAssetPathRelativeToLayer(anchor: Layer, assetPath: str) -> str: ...
...
@overload
def CopySpec(srcLayer: Layer, srcPath: Path, dstLayer: Layer, dstPath: Path, shouldCopyValueFn: ShouldCopyValueFn, shouldCopyChildrenFn: ShouldCopyChildrenFn) -> bool: ...
def CreatePrimInLayer(arg1: Layer, arg2: Path) -> PrimSpec: ...
def CreateVariantInLayer(arg1: Layer, arg2: Path, arg3: str, arg4: str) -> VariantSpec: ...
def DefaultUnit(*args, **kwargs) -> Any: ...
@overload
def Equal(arg1: AssetPathArray, arg2: AssetPathArray) -> pxr.Vt.BoolArray: ...
@overload
def Equal(arg1: AssetPath, arg2: AssetPathArray) -> pxr.Vt.BoolArray: ...
@overload
def Equal(arg1: AssetPathArray, arg2: AssetPath) -> pxr.Vt.BoolArray: ...
@overload
...
@overload
def Equal(arg1: Path, arg2: PathArray) -> pxr.Vt.BoolArray: ...
@overload
def Equal(arg1: PathArray, arg2: Path) -> pxr.Vt.BoolArray: ...
@overload
...
@overload
def Equal(arg1: TimeCode, arg2: TimeCodeArray) -> pxr.Vt.BoolArray: ...
@overload
def Equal(arg1: TimeCodeArray, arg2: TimeCode) -> pxr.Vt.BoolArray: ...
@overload
...
def GetTypeForValueTypeName(arg1: str) -> pxr.Tf.Type: ...
def GetUnitFromName(arg1: str) -> pxr.Tf.Enum: ...
def GetValueTypeNameForValue(arg1: Any) -> ValueTypeName: ...
def JustCreatePrimAttributeInLayer(layer: Layer, attrPath: Path, typeName: ValueTypeName, variability: Variability = ..., isCustom: bool = ...) -> bool: ...
def JustCreatePrimInLayer(arg1: Layer, arg2: Path) -> bool: ...
@overload
def NotEqual(arg1: AssetPathArray, arg2: AssetPathArray) -> pxr.Vt.BoolArray: ...
@overload
def NotEqual(arg1: AssetPath, arg2: AssetPathArray) -> pxr.Vt.BoolArray: ...
@overload
def NotEqual(arg1: AssetPathArray, arg2: AssetPath) -> pxr.Vt.BoolArray: ...
@overload
...
@overload
def NotEqual(arg1: Path, arg2: PathArray) -> pxr.Vt.BoolArray: ...
@overload
def NotEqual(arg1: PathArray, arg2: Path) -> pxr.Vt.BoolArray: ...
@overload
...
@overload
def NotEqual(arg1: TimeCode, arg2: TimeCodeArray) -> pxr.Vt.BoolArray: ...
@overload
def NotEqual(arg1: TimeCodeArray, arg2: TimeCode) -> pxr.Vt.BoolArray: ...
@overload
