...
class BatchNamespaceEdit(Boost.Python.instance):
    ...
    def Process(self, hasObjectAtPath: list[NamespaceEdit], canEdit: HasObjectAtPath, fixBackpointers: bool = ...) -> tuple: ...
    def __reduce__(self) -> Any: ...
    @property
    def edits(self) -> type: ...
...
class FileFormat(Boost.Python.instance):
    ...
    @classmethod
    def FindAllDerivedFileFormatExtensions(cls, arg1: Type) -> list[str]: ...
    @classmethod
...
class Layer(Boost.Python.instance):
    ...
    def GetAssetInfo(self) -> pxr.Vt.Value: ...
...
class Spec(Boost.Python.instance):
    ...
    def GetInfo(self, arg2: str) -> pxr.Vt.Value: ...
    ...
    def SetInfo(self, arg2: str, arg3: pxr.Vt.Value) -> None: ...
    def SetInfoDictionaryValue(self, arg2: str, arg3: str, arg4: pxr.Vt.Value) -> None: ...
    def __bool__(self) -> bool: ...
    def __eq__(self, other: object) -> bool: ...
    def __ge__(self, other: object) -> bool: ...
    def __gt__(self, other: object) -> bool: ...
...
def GetTypeForValueTypeName(arg1: str) -> Type: ...
def GetUnitFromName(arg1: str) -> pxr.Tf.Enum: ...
def GetValueTypeNameForValue(arg1: pxr.Vt.Value) -> ValueTypeName: ...
...
def ValueHasValidType(arg1: pxr.Vt.Value) -> bool: ...
