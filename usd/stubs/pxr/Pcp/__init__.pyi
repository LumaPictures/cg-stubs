...
class Cache(Boost.Python.instance):
    ...
    def ComputeAttributeConnectionPaths(self, relPath: Path, localOnly: bool = ..., stopProperty: Spec = ..., includeStopProperty: bool = ...) -> tuple: ...
    def ComputeLayerStack(self, arg2: LayerStackIdentifier) -> tuple: ...
    def ComputePrimIndex(self, arg2: Path) -> tuple: ...
    def ComputePropertyIndex(self, arg2: Path) -> tuple: ...
    def ComputeRelationshipTargetPaths(self, relPath: Path, localOnly: bool = ..., stopProperty: Spec = ..., includeStopProperty: bool = ...) -> tuple: ...
    def FindAllLayerStacksUsingLayer(self, arg2: Layer) -> list: ...
    def FindPrimIndex(self, arg2: Path) -> object: ...
    def FindPropertyIndex(self, arg2: Path) -> object: ...
    def FindSiteDependencies(self, arg1: Cache, siteLayerStack: LayerStack, sitePath: Path, dependencyType: int = ..., recurseOnSite: bool = ..., recurseOnIndex: bool = ..., filterForExistingCachesOnly: bool = ...) -> list: ...
    def GetDynamicFileFormatArgumentDependencyData(self, arg2: Path) -> DynamicFileFormatDependencyData: ...
    def GetLayerStackIdentifier(self) -> LayerStackIdentifier: ...
    def GetMutedLayers(self) -> list: ...
    def GetUsedLayers(self) -> list: ...
    ...
    def HasRootLayerStack(self, arg1: Cache, arg2: LayerStack) -> bool: ...
    def IsInvalidAssetPath(self, arg2: object) -> bool: ...
    def IsInvalidSublayerIdentifier(self, arg2: object) -> bool: ...
    def IsLayerMuted(self, arg1: Cache, layerIdentifier: object) -> bool: ...
    def IsPayloadIncluded(self, arg2: Path) -> bool: ...
    def IsPossibleDynamicFileFormatArgumentField(self, arg2: object) -> bool: ...
    def PrintStatistics(self) -> None: ...
    def Reload(self) -> None: ...
    def RequestLayerMuting(self, layersToMute: object, layersToUnmute: object) -> None: ...
    def RequestPayloads(self, arg2: object, arg3: object) -> None: ...
...
class Dependency(Boost.Python.instance):
    ...
    mapFunc: Any
    sitePath: Any
    def __init__(self, arg2: Path, arg3: Path, arg4: MapFunction) -> object: ...
    def __eq__(self, arg2: Dependency) -> object: ...
    def __ne__(self, arg2: Dependency) -> object: ...
    def __reduce__(self) -> Any: ...
...
class DynamicFileFormatDependencyData(Boost.Python.instance):
    def __init__(self, *args, **kwargs) -> None: ...
    def CanFieldChangeAffectFileFormatArguments(self, arg2: object, arg3: object, arg4: object) -> bool: ...
...
class InstanceKey(Boost.Python.instance):
    ...
    def __eq__(self, arg2: InstanceKey) -> object: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg2: InstanceKey) -> object: ...
    def __reduce__(self) -> Any: ...
...
class LayerStackIdentifier(Boost.Python.instance):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, rootLayer: Layer, sessionLayer: Layer = ..., pathResolverContext: ResolverContext = ...) -> None: ...
    def __bool__(self) -> object: ...
    def __eq__(self, arg2: LayerStackIdentifier) -> object: ...
    def __ge__(self, arg2: LayerStackIdentifier) -> object: ...
    def __gt__(self, arg2: LayerStackIdentifier) -> object: ...
    def __hash__(self) -> int: ...
    def __le__(self, arg2: LayerStackIdentifier) -> object: ...
    def __lt__(self, arg2: LayerStackIdentifier) -> object: ...
    def __ne__(self, arg2: LayerStackIdentifier) -> object: ...
    def __reduce__(self) -> Any: ...
    @property
...
class MapExpression(Boost.Python.instance):
    ...
    def MapSourceToTarget(self, path: Path) -> Path: ...
    def MapTargetToSource(self, path: Path) -> Path: ...
    def __reduce__(self) -> Any: ...
    @property
...
class MapFunction(Boost.Python.instance):
    ...
    @overload
    def __init__(self, sourceToTargetMap: dict, timeOffset: LayerOffset = ...) -> object: ...
    def Compose(self, arg2: MapFunction) -> MapFunction: ...
    def ComposeOffset(self, offset: LayerOffset) -> MapFunction: ...
    ...
    def MapSourceToTarget(self, path: Path) -> Path: ...
    def MapTargetToSource(self, path: Path) -> Path: ...
    def __eq__(self, arg2: MapFunction) -> object: ...
    def __ne__(self, arg2: MapFunction) -> object: ...
    def __reduce__(self) -> Any: ...
    @property
    def isIdentity(self) -> type: ...
    @property
...
class NodeRef(Boost.Python.instance):
    ...
    def GetIntroPath(self) -> Path: ...
    def GetOriginRootNode(self) -> object: ...
    def GetPathAtIntroduction(self) -> Path: ...
    def GetRootNode(self) -> object: ...
    def IsDueToAncestor(self) -> bool: ...
    def IsRootNode(self) -> bool: ...
    def __eq__(self, arg2: NodeRef) -> object: ...
    def __ne__(self, arg2: NodeRef) -> object: ...
    def __reduce__(self) -> Any: ...
    @property
...
class PrimIndex(Boost.Python.instance):
    ...
    def DumpToDotGraph(self, filename: object, includeInheritOriginInfo: bool = ..., includeMaps: bool = ...) -> None: ...
    def DumpToString(self, includeInheritOriginInfo: bool = ..., includeMaps: bool = ...) -> str: ...
    @overload
    def GetNodeProvidingSpec(self, primSpec: PrimSpec) -> NodeRef: ...
    @overload
    def GetNodeProvidingSpec(self, layer: Layer, path: Path) -> NodeRef: ...
    def GetSelectionAppliedForVariantSet(self, arg2: object) -> str: ...
...
def TranslatePathFromNodeToRoot(arg1: NodeRef, sourceNode: Path) -> Path: ...
def TranslatePathFromRootToNode(arg1: NodeRef, destNode: Path) -> Path: ...