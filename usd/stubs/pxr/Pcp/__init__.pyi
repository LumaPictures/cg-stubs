...
class Cache(Boost.Python.instance):
    ...
    def FindAllLayerStacksUsingLayer(self, arg2: pxr.Sdf.Layer) -> list: ...
    def FindPrimIndex(self, arg2: pxr.Sdf.Path) -> Any: ...
    def FindPropertyIndex(self, arg2: pxr.Sdf.Path) -> Any: ...
...
class Dependency(Boost.Python.instance):
    ...
    mapFunc: Any
    sitePath: Any
    def __init__(self, arg2: pxr.Sdf.Path, arg3: pxr.Sdf.Path, arg4: MapFunction) -> Any: ...
    def __eq__(self, arg2: Dependency) -> Any: ...
    def __ne__(self, arg2: Dependency) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class InstanceKey(Boost.Python.instance):
    ...
    def __eq__(self, arg2: InstanceKey) -> Any: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg2: InstanceKey) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class LayerStackIdentifier(Boost.Python.instance):
    ...
    def __eq__(self, arg2: LayerStackIdentifier) -> Any: ...
    def __ge__(self, arg2: LayerStackIdentifier) -> Any: ...
    def __gt__(self, arg2: LayerStackIdentifier) -> Any: ...
    def __hash__(self) -> int: ...
    def __le__(self, arg2: LayerStackIdentifier) -> Any: ...
    def __lt__(self, arg2: LayerStackIdentifier) -> Any: ...
    def __ne__(self, arg2: LayerStackIdentifier) -> Any: ...
    def __reduce__(self) -> Any: ...
    @property
...
class MapFunction(Boost.Python.instance):
    ...
    @overload
    def __init__(self, sourceToTargetMap: dict, timeOffset: pxr.Sdf.LayerOffset = ...) -> Any: ...
    ...
    def MapSourceToTarget(self, path: pxr.Sdf.Path) -> pxr.Sdf.Path: ...
    def MapTargetToSource(self, path: pxr.Sdf.Path) -> pxr.Sdf.Path: ...
    def __eq__(self, arg2: MapFunction) -> Any: ...
    def __ne__(self, arg2: MapFunction) -> Any: ...
    def __reduce__(self) -> Any: ...
    @property
    def isIdentity(self) -> type: ...
    @property
