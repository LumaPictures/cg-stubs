...
class SchemaRegistry(Boost.Python.instance):
    ...
    @overload
    @classmethod
    def FindSchemaInfosInFamily(cls, schemaFamily: object, schemaVersion: int, versionPolicy: SchemaRegistry.VersionPolicy) -> list: ...
    @classmethod
    def GetAPISchemaCanOnlyApplyToTypeNames(cls, apiSchemaName: object, instanceName: object = ...) -> list: ...
    @classmethod
    def GetAPISchemaTypeName(cls, schemaType: Type) -> Any: ...
    @classmethod
    def GetAPITypeFromSchemaTypeName(cls, typeName: object) -> Type: ...
    @classmethod
    def GetAutoApplyAPISchemas(cls) -> dict: ...
    @classmethod
    def GetConcreteSchemaTypeName(cls, schemaType: Type) -> Any: ...
    @classmethod
...
class StageCache(Boost.Python.instance):
    ...
    def Find(self, id: StageCache.Id) -> Any: ...
    @overload
    ...
    def Insert(self, stage: object) -> StageCache.Id: ...
