...
class Attribute(Property):
    ...
    @classmethod
    def GetUnionedTimeSamples(cls, attrs: list[Attribute | ConstraintTarget | Input | Output | Primvar | XformOp]) -> list[float]: ...
    @classmethod
    def GetUnionedTimeSamplesInInterval(cls, attrs: list[Attribute | ConstraintTarget | Input | Output | Primvar | XformOp], interval: pxr.Gf.Interval) -> list[float]: ...
...
class AttributeQuery(Boost.Python.instance):
    ...
    def GetTimeSamplesInInterval(self, interval: pxr.Gf.Interval) -> list[float]: ...
    @classmethod
    def GetUnionedTimeSamples(cls, attrQueries: list[AttributeQuery]) -> list[float]: ...
    @classmethod
    def GetUnionedTimeSamplesInInterval(cls, attrQueries: list[AttributeQuery], interval: pxr.Gf.Interval) -> list[float]: ...
    def HasAuthoredValue(self) -> bool: ...
    def HasAuthoredValueOpinion(self) -> bool: ...
    def HasFallbackValue(self) -> bool: ...
    def HasValue(self) -> bool: ...
