...
class ClipsAPI(APISchemaBase):
    ...
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    @overload
    def SetClipActive(self, activeClips: pxr.Vt.Vec2dArray | list[pxr.Gf.Vec2d], clipSet: str | pxr.Ar.ResolvedPath) -> None: ...
    @overload
    def SetClipActive(self, activeClips: pxr.Vt.Vec2dArray | list[pxr.Gf.Vec2d]) -> None: ...
    @overload
    ...
    @overload
    def SetClipTimes(self, clipTimes: pxr.Vt.Vec2dArray | list[pxr.Gf.Vec2d], clipSet: str | pxr.Ar.ResolvedPath) -> None: ...
    @overload
    def SetClipTimes(self, clipTimes: pxr.Vt.Vec2dArray | list[pxr.Gf.Vec2d]) -> None: ...
...
class _PrimFlagsPredicate(Boost.Python.instance):
    def __init__(self, *args, **kwargs) -> None: ...
    def Contradiction(self) -> typing_extensions.Self: ...
    def Tautology(self) -> typing_extensions.Self: ...
