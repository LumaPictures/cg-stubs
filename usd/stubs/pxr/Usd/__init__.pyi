...
class Attribute(Property):
    ...
    @classmethod
    def GetUnionedTimeSamples(cls, attrs: list[Attribute | pxr.UsdGeom.ConstraintTarget | pxr.UsdGeom.Primvar | pxr.UsdGeom.XformOp | pxr.UsdShade.Input | pxr.UsdShade.Output]) -> list[float]: ...
    @classmethod
    def GetUnionedTimeSamplesInInterval(cls, attrs: list[Attribute | pxr.UsdGeom.ConstraintTarget | pxr.UsdGeom.Primvar | pxr.UsdGeom.XformOp | pxr.UsdShade.Input | pxr.UsdShade.Output], interval: pxr.Gf.Interval) -> list[float]: ...
