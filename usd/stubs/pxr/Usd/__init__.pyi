...
class Attribute(Property):
    ...
    @classmethod
    def GetUnionedTimeSamples(cls, attrs: list[Attribute | ConstraintTarget | Input | Output | Primvar | XformOp]) -> list: ...
    @classmethod
    def GetUnionedTimeSamplesInInterval(cls, attrs: list[Attribute | ConstraintTarget | Input | Output | Primvar | XformOp], interval: pxr.Gf.Interval) -> list: ...
    ...
    def SetConnections(self, sources: list[pxr.Sdf.Path | str]) -> bool: ...
...
class AttributeQuery(Boost.Python.instance):
    ...
    @classmethod
    def CreateQueries(cls, prim: Prim, attributeNames: list[str | pxr.Ar.ResolvedPath]) -> list[AttributeQuery]: ...
    def Get(self, time: TimeCode = ...) -> Any: ...
...
class ClipsAPI(APISchemaBase):
    ...
    @overload
    def GetClipActive(self, clipSet: str | pxr.Ar.ResolvedPath) -> bool: ...
    @overload
    ...
    @overload
    def GetClipTimes(self, clipSet: str | pxr.Ar.ResolvedPath) -> bool: ...
    ...
    @overload
    def SetClipActive(self, activeClips: pxr.Vt.Vec2dArray, clipSet: str | pxr.Ar.ResolvedPath) -> None: ...
    @overload
    ...
    @overload
    def SetClipManifestAssetPath(self, manifestAssetPath: pxr.Sdf.AssetPath, clipSet: str | pxr.Ar.ResolvedPath) -> bool: ...
    @overload
    ...
    @overload
    def SetClipTimes(self, clipTimes: pxr.Vt.Vec2dArray, clipSet: str | pxr.Ar.ResolvedPath) -> None: ...
...
class Inherits(Boost.Python.instance):
    ...
    def SetInherits(self, arg2: list[pxr.Sdf.Path | str]) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Payloads(Boost.Python.instance):
    ...
    @overload
    def AddPayload(self, assetPath: str | pxr.Ar.ResolvedPath, primPath: pxr.Sdf.Path, layerOffset: pxr.Sdf.LayerOffset = ..., position: ListPosition = ...) -> bool: ...
...
class Prim(Object):
    ...
    @overload
    def CreateRelationship(self, name: list[str | pxr.Ar.ResolvedPath], custom: bool = ...) -> Relationship: ...
    @overload
    def CreateRelationship(self, nameElts: str | pxr.Ar.ResolvedPath, custom: bool = ...) -> Relationship: ...
    def FindAllAttributeConnectionPaths(self, predicate: typing.Callable[[Attribute | ConstraintTarget | Input | Output | Primvar | XformOp], bool] = ..., recurseOnSources: bool = ...) -> list[pxr.Sdf.Path]: ...
    ...
    @overload
    def GetAuthoredPropertiesInNamespace(self, namespaces: list[str | pxr.Ar.ResolvedPath]) -> list[Property]: ...
    @overload
    ...
    @overload
    def GetPropertiesInNamespace(self, namespaces: list[str | pxr.Ar.ResolvedPath]) -> list[Property]: ...
    @overload
    ...
    @overload
    def GetVersionIfHasAPIInFamily(self, arg2: str | pxr.Ar.ResolvedPath) -> bool: ...
    @overload
    def GetVersionIfHasAPIInFamily(self, arg2: str | pxr.Ar.ResolvedPath, arg3: str | pxr.Ar.ResolvedPath) -> bool: ...
    def GetVersionIfIsInFamily(self, arg2: str | pxr.Ar.ResolvedPath) -> bool: ...
    @overload
    ...
    def SetChildrenReorder(self, order: list[str | pxr.Ar.ResolvedPath]) -> None: ...
    def SetInstanceable(self, instanceable: bool) -> bool: ...
    @overload
    def SetPayload(self, payload: pxr.Sdf.Payload) -> bool: ...
    @overload
    def SetPayload(self, assetPath: str | pxr.Ar.ResolvedPath, primPath: pxr.Sdf.Path) -> bool: ...
    @overload
    def SetPayload(self, layer: pxr.Sdf.Layer, primPath: pxr.Sdf.Path) -> bool: ...
    def SetPropertyOrder(self, order: list[str | pxr.Ar.ResolvedPath]) -> None: ...
...
class PrimDefinition(Boost.Python.instance):
    ...
    def GetDocumentation(self) -> str: ...
    def GetMetadata(self, key: str | pxr.Ar.ResolvedPath) -> bool: ...
    def GetMetadataByDictKey(self, key: str | pxr.Ar.ResolvedPath, keyPath: str | pxr.Ar.ResolvedPath) -> bool: ...
    def GetPropertyDocumentation(self, propName: str | pxr.Ar.ResolvedPath) -> str: ...
    def GetPropertyMetadata(self, propName: str | pxr.Ar.ResolvedPath, key: str | pxr.Ar.ResolvedPath) -> bool: ...
    def GetPropertyMetadataByDictKey(self, propName: str | pxr.Ar.ResolvedPath, key: str | pxr.Ar.ResolvedPath, keyPath: str | pxr.Ar.ResolvedPath) -> bool: ...
...
class Property(Object):
    ...
    def SetNestedDisplayGroups(self, nestedGroups: list[str | pxr.Ar.ResolvedPath]) -> bool: ...
...
class References(Boost.Python.instance):
    ...
    @overload
    def AddReference(self, assetPath: str | pxr.Ar.ResolvedPath, primPath: pxr.Sdf.Path, layerOffset: pxr.Sdf.LayerOffset = ..., position: ListPosition = ...) -> bool: ...
...
class Relationship(Property):
    ...
    def SetTargets(self, targets: list[pxr.Sdf.Path | str]) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class SchemaRegistry(Boost.Python.instance):
    ...
    def BuildComposedPrimDefinition(self, arg2: str | pxr.Ar.ResolvedPath, arg3: list[str | pxr.Ar.ResolvedPath]) -> PrimDefinition: ...
    ...
    @overload
    @classmethod
    def FindSchemaInfosInFamily(cls, schemaFamily: str | pxr.Ar.ResolvedPath) -> list[SchemaInfo]: ...
    @overload
    @classmethod
    def FindSchemaInfosInFamily(cls, schemaFamily: str | pxr.Ar.ResolvedPath, schemaVersion: int, versionPolicy: SchemaRegistry.VersionPolicy) -> list[SchemaInfo]: ...
    @classmethod
...
class Specializes(Boost.Python.instance):
    ...
    def SetSpecializes(self, arg2: list[pxr.Sdf.Path | str]) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Stage(Boost.Python.instance):
    ...
    @overload
    @classmethod
    def CreateInMemory(cls, identifier: str | pxr.Ar.ResolvedPath, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateInMemory(cls, identifier: str | pxr.Ar.ResolvedPath, pathResolverContext: pxr.Ar.ResolverContext, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateInMemory(cls, identifier: str | pxr.Ar.ResolvedPath, sessionLayer: pxr.Sdf.Layer, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateInMemory(cls, identifier: str | pxr.Ar.ResolvedPath, sessionLayer: pxr.Sdf.Layer, pathResolverContext: pxr.Ar.ResolverContext, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateNew(cls, identifier: str | pxr.Ar.ResolvedPath, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateNew(cls, identifier: str | pxr.Ar.ResolvedPath, pathResolverContext: pxr.Ar.ResolverContext, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateNew(cls, identifier: str | pxr.Ar.ResolvedPath, sessionLayer: pxr.Sdf.Layer, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def CreateNew(cls, identifier: str | pxr.Ar.ResolvedPath, sessionLayer: pxr.Sdf.Layer, pathResolverContext: pxr.Ar.ResolverContext, load: InitialLoadSet = ...) -> Stage: ...
    def DefinePrim(self, path: pxr.Sdf.Path, typeName: str | pxr.Ar.ResolvedPath = ...) -> Prim: ...
    def ExpandPopulationMask(self, relationshipPredicate: typing.Callable[[Relationship], bool] = ..., attributePredicate: typing.Callable[[Attribute | ConstraintTarget | Input | Output | Primvar | XformOp], bool] = ...) -> None: ...
    ...
    def MuteAndUnmuteLayers(self, muteLayers: list[str | pxr.Ar.ResolvedPath], unmuteLayers: list[str | pxr.Ar.ResolvedPath]) -> None: ...
    def MuteLayer(self, layerIdentifier: str | pxr.Ar.ResolvedPath) -> None: ...
    @overload
    @classmethod
    def Open(cls, filePath: str | pxr.Ar.ResolvedPath, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def Open(cls, rootLayer: pxr.Sdf.Layer, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def Open(cls, filePath: str | pxr.Ar.ResolvedPath, pathResolverContext: pxr.Ar.ResolverContext, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    ...
    @overload
    @classmethod
    def OpenMasked(cls, filePath: str | pxr.Ar.ResolvedPath, mask: StagePopulationMask, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def OpenMasked(cls, rootLayer: pxr.Sdf.Layer, mask: StagePopulationMask, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    def OpenMasked(cls, filePath: str | pxr.Ar.ResolvedPath, pathResolverContext: pxr.Ar.ResolverContext, mask: StagePopulationMask, load: InitialLoadSet = ...) -> Stage: ...
    @overload
    @classmethod
    ...
    @classmethod
    def SetColorConfigFallbacks(cls, colorConfiguration: pxr.Sdf.AssetPath = ..., colorManagementSystem: str | pxr.Ar.ResolvedPath = ...) -> None: ...
