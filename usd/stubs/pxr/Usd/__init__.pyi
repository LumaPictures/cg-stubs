...
class ClipsAPI(APISchemaBase):
    ...
    @overload
    def GetClipActive(self, clipSet: pxr.Vt.Vec2dArray) -> bool: ...
    @overload
    def GetClipAssetPaths(self) -> list: ...
    @overload
    def GetClipAssetPaths(self, clipSet: pxr.Sdf.AssetPathArray) -> list: ...
    @overload
    def GetClipManifestAssetPath(self) -> pxr.Sdf.AssetPath: ...
    @overload
    def GetClipManifestAssetPath(self, clipSet: pxr.Sdf.AssetPath) -> pxr.Sdf.AssetPath: ...
    @overload
    ...
    @overload
    def GetClipTemplateActiveOffset(self, clipSet: float) -> float: ...
    @overload
    ...
    @overload
    def GetClipTemplateEndTime(self, clipSet: float) -> float: ...
    @overload
    def GetClipTemplateStartTime(self) -> float: ...
    @overload
    def GetClipTemplateStartTime(self, clipSet: float) -> float: ...
    @overload
    def GetClipTemplateStride(self) -> float: ...
    @overload
    def GetClipTemplateStride(self, clipSet: float) -> float: ...
    @overload
    def GetClipTimes(self) -> bool: ...
    @overload
    def GetClipTimes(self, clipSet: pxr.Vt.Vec2dArray) -> bool: ...
    def GetClips(self) -> bool: ...
    @overload
    def GetInterpolateMissingClipValues(self) -> bool: ...
    @overload
    def GetInterpolateMissingClipValues(self, clipSet: bool) -> bool: ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    @overload
...
class CollectionAPI(APISchemaBase):
    ...
    def CreateCollectionAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> Attribute: ...
    def CreateExcludesRel(self) -> Relationship: ...
    def CreateExpansionRuleAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> Attribute: ...
    def CreateIncludeRootAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> Attribute: ...
...
class Object(Boost.Python.instance):
    ...
    def GetAssetInfoByKey(self, keyPath: str) -> pxr.Vt.Value: ...
    def GetCustomData(self) -> dict: ...
    def GetCustomDataByKey(self, keyPath: str) -> pxr.Vt.Value: ...
    ...
    def SetAssetInfoByKey(self, keyPath: str, value: pxr.Vt.Value) -> None: ...
    def SetCustomData(self, customData: dict) -> None: ...
    def SetCustomDataByKey(self, keyPath: str, value: pxr.Vt.Value) -> None: ...
...
class Prim(Object):
    ...
    def FindAllAttributeConnectionPaths(self, predicate: Callable[[Attribute], bool] = ..., recurseOnSources: bool = ...) -> list[pxr.Sdf.Path]: ...
    def FindAllRelationshipTargetPaths(self, predicate: Callable[[Relationship], bool] = ..., recurseOnTargets: bool = ...) -> list[pxr.Sdf.Path]: ...
...
class SchemaRegistry(Boost.Python.instance):
    ...
    @classmethod
    def GetAPISchemaTypeName(cls, schemaType: Type) -> str: ...
    @classmethod
    def GetAPITypeFromSchemaTypeName(cls, typeName: str) -> Type: ...
    @classmethod
    def GetAutoApplyAPISchemas(cls) -> dict: ...
    @classmethod
    def GetConcreteSchemaTypeName(cls, schemaType: Type) -> str: ...
    @classmethod
    def GetConcreteTypeFromSchemaTypeName(cls, typeName: str) -> Type: ...
    ...
    @classmethod
    def GetTypeFromName(cls, typeName: str) -> Type: ...
    @classmethod
    def GetTypeFromSchemaTypeName(cls, typeName: str) -> Type: ...
    @classmethod
...
class Stage(Boost.Python.instance):
    ...
    def ExpandPopulationMask(self, relationshipPredicate: Callable[[Relationship], bool] = ..., attributePredicate: Callable[[Attribute], bool] = ...) -> None: ...
