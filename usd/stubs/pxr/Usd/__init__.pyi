...
class Attribute(Property):
    ...
    @classmethod
    def GetUnionedTimeSamples(cls, attrs: list[Attribute] | list[pxr.UsdGeom.ConstraintTarget] | list[pxr.UsdGeom.Primvar] | list[pxr.UsdGeom.XformOp] | list[pxr.UsdShade.Input] | list[pxr.UsdShade.Output]) -> list[float]: ...
    @classmethod
    def GetUnionedTimeSamplesInInterval(cls, attrs: list[Attribute] | list[pxr.UsdGeom.ConstraintTarget] | list[pxr.UsdGeom.Primvar] | list[pxr.UsdGeom.XformOp] | list[pxr.UsdShade.Input] | list[pxr.UsdShade.Output], interval: pxr.Gf.Interval) -> list[float]: ...
...
class Prim(Object):
    ...
    @overload
    def CreateRelationship(self, name: list[str] | list[pxr.Ar.ResolvedPath], custom: bool = ...) -> Relationship: ...
    @overload
    ...
    @overload
    def GetAuthoredPropertiesInNamespace(self, namespaces: list[str] | list[pxr.Ar.ResolvedPath]) -> list[Property]: ...
    @overload
    ...
    @overload
    def GetPropertiesInNamespace(self, namespaces: list[str] | list[pxr.Ar.ResolvedPath]) -> list[Property]: ...
    @overload
...
class Property(Object):
    ...
    def SetNestedDisplayGroups(self, nestedGroups: list[str] | list[pxr.Ar.ResolvedPath]) -> bool: ...
...
class Stage(Boost.Python.instance):
    ...
    def MuteAndUnmuteLayers(self, muteLayers: list[str] | list[pxr.Ar.ResolvedPath], unmuteLayers: list[str] | list[pxr.Ar.ResolvedPath]) -> None: ...
