...
class CollectionAPI(APISchemaBase):
    ...
    @classmethod
    def ComputeIncludedPaths(cls, query: UsdCollectionMembershipQuery, stage: Stage, predicate: _PrimFlagsPredicate = ...) -> list[pxr.Sdf.Path]: ...
...
def ComputeIncludedPathsFromCollection(query: UsdCollectionMembershipQuery, stage: Stage, predicate: _PrimFlagsPredicate = ...) -> list[pxr.Sdf.Path]: ...
@overload
