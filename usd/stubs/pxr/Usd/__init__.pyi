...
class AttributeQuery(Boost.Python.instance):
    @overload
    def __init__(self, attribute: Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> None: ...
    @overload
    def __init__(self, prim: Prim, attributeName: object) -> None: ...
    @overload
    def __init__(self, attribute: Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, resolveTarget: ResolveTarget) -> None: ...
    @classmethod
...
class Notice(Boost.Python.instance):
    ...
    class ObjectsChanged(Notice.StageNotice):
        def __init__(self, *args, **kwargs) -> None: ...
        def AffectedObject(self, arg2: Object | XformOp) -> bool: ...
        def ChangedInfoOnly(self, arg2: Object | XformOp) -> bool: ...
        @overload
        def GetChangedFields(self, arg2: Object | XformOp) -> Any: ...
        @overload
        def GetChangedFields(self, arg2: pxr.Sdf.Path | str) -> Any: ...
        def GetChangedInfoOnlyPaths(self) -> Any: ...
        def GetResyncedPaths(self) -> Any: ...
        @overload
        def HasChangedFields(self, arg2: Object | XformOp) -> bool: ...
        @overload
        def HasChangedFields(self, arg2: pxr.Sdf.Path | str) -> bool: ...
        def ResyncedObject(self, arg2: Object | XformOp) -> bool: ...
        def __reduce__(self) -> Any: ...
...
class Property(Object):
    ...
    @overload
    def FlattenTo(self, property: Property | XformOp) -> Property: ...
    @overload
...
class Stage(Boost.Python.instance):
    ...
    def FindLoadable(self, rootPath: pxr.Sdf.Path | str = ...) -> list: ...
...
class StageLoadRules(Boost.Python.instance):
    ...
    def AddRule(self, path: pxr.Sdf.Path | str, rule: Rule) -> None: ...
    def GetEffectiveRuleForPath(self, path: pxr.Sdf.Path | str) -> Rule: ...
...
@overload
def Describe(arg1: Object | XformOp) -> str: ...
@overload
...
def _UnsafeGetStageForTesting(arg1: Object | XformOp) -> Stage: ...