...
class ConnectableAPI(pxr.Usd.APISchemaBase):
    ...
    @overload
    @classmethod
    def CanConnect(cls, input: Input, source: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    @overload
    @classmethod
    def CanConnect(cls, output: Output, source: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp = ...) -> bool: ...
    @classmethod
    def ClearSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    @classmethod
    def ClearSources(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    @overload
    @classmethod
    def ConnectToSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, source: ConnectableAPI, sourceName: object, sourceType: AttributeType = ..., typeName: pxr.Sdf.ValueTypeName = ...) -> bool: ...
    @overload
    @classmethod
    def ConnectToSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, sourcePath: pxr.Sdf.Path | str) -> bool: ...
    @overload
    @classmethod
    def ConnectToSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, input: Input) -> bool: ...
    @overload
    @classmethod
    def ConnectToSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, output: Output) -> bool: ...
    @overload
    @classmethod
    def ConnectToSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, source: ConnectionSourceInfo, mod: ConnectionModification = ...) -> bool: ...
    ...
    @classmethod
    def DisconnectSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, sourceAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp = ...) -> bool: ...
    @classmethod
    def Get(cls, stage: pxr.Usd.Stage, path: pxr.Sdf.Path | str) -> ConnectableAPI: ...
    @classmethod
    def GetConnectedSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> Any: ...
    @classmethod
    def GetConnectedSources(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> Any: ...
    ...
    @classmethod
    def GetRawConnectedSourcePaths(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> list: ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    @classmethod
    def HasConnectableAPI(cls, schemaType: Type) -> bool: ...
    @classmethod
    def HasConnectedSource(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    def IsContainer(self) -> bool: ...
    @classmethod
    def IsSourceConnectionFromBaseMaterial(cls, shadingAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    def RequiresEncapsulation(self) -> bool: ...
    @classmethod
    def SetConnectedSources(cls, arg1: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, arg2: list[ConnectionSourceInfo]) -> bool: ...
    @classmethod
...
class Input(Boost.Python.instance):
    ...
    def CanConnect(self, source: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    ...
    def DisconnectSource(self, sourceAttr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp = ...) -> bool: ...
    ...
    @classmethod
    def IsInput(cls, arg1: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    @classmethod
...
class Output(Boost.Python.instance):
    ...
    def HasSdrMetadataByKey(self, key: str | pxr.Ar.ResolvedPath) -> bool: ...
    @classmethod
    def IsOutput(cls, arg1: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    def IsSourceConnectionFromBaseMaterial(self) -> bool: ...
    def Set(self, value: object, time: TimeCode = ...) -> bool: ...
    def SetConnectedSources(self, arg2: list[ConnectionSourceInfo]) -> bool: ...
    def SetRenderType(self, renderType: str | pxr.Ar.ResolvedPath) -> bool: ...
