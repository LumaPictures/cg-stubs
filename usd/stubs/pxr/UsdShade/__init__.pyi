...
class MaterialBindingAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateMaterialBindSubset(self, subsetName: str, indices: IntArray, elementType: str = ...) -> pxr.UsdGeom.Subset: ...
    @classmethod
...
class NodeDefAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def CreateIdAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateImplementationSourceAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
    ...
    def GetSourceAsset(self, sourceType: pxr.Sdf.AssetPath = ...) -> bool: ...
