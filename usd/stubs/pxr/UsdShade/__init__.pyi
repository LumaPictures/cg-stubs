...
class ConnectableAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def SetConnectedSources(cls, arg1: pxr.Usd.Attribute | pxr.UsdGeom.ConstraintTarget | pxr.UsdGeom.Primvar | pxr.UsdGeom.XformOp | Input | Output, arg2: list[ConnectionSourceInfo]) -> bool: ...
    @classmethod
...
class MaterialBindingAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateMaterialBindSubset(self, subsetName: str | pxr.Ar.ResolvedPath, indices: pxr.Vt.IntArray | list[int], elementType: str | pxr.Ar.ResolvedPath = ...) -> pxr.UsdGeom.Subset: ...
    @classmethod
