...
class FrameRecorder(Boost.Python.instance):
    ...
    def GetCurrentRendererId(self) -> object: ...
    def Record(self, stage: Stage, usdCamera: Camera, timeCode: TimeCode, outputImagePath: object) -> bool: ...
...
def GetCameraAtPath(stage: Stage, cameraPath: Path) -> Camera: ...