...
class Debug(Boost.Python.instance):
    ...
    @classmethod
    def GetDebugSymbolNames(cls) -> object: ...
    @classmethod
    def IsDebugSymbolNameEnabled(cls, arg1: str) -> bool: ...
    @classmethod
    def SetDebugSymbolsByName(cls, pattern: str, value: bool) -> object: ...
    @classmethod
    def SetOutputFile(cls, arg1: object) -> None: ...
    def __reduce__(self) -> Any: ...
...
class Enum(Boost.Python.instance):
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def GetValueFromFullName(cls, arg1: str) -> object: ...
    def __reduce__(self) -> Any: ...
...
class ScopeDescription(Boost.Python.instance):
    ...
    def SetDescription(self, arg1: ScopeDescription, arg2: str) -> None: ...
...
class Tf_PyEnumWrapper(Enum):
    def __init__(self, *args, **kwargs) -> None: ...
    @overload
    def __and__(self, arg2: int) -> object: ...
    @overload
    def __and__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    @overload
    def __eq__(self, arg2: int) -> object: ...
    @overload
    def __eq__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    def __ge__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    def __gt__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    def __hash__(self) -> int: ...
    def __invert__(self) -> object: ...
    def __le__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    def __lt__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    @overload
    def __or__(self, arg2: int) -> object: ...
    @overload
    def __or__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    def __rand__(self, arg2: int) -> object: ...
    def __reduce__(self) -> Any: ...
    def __ror__(self, arg2: int) -> object: ...
    def __rxor__(self, arg2: int) -> object: ...
    @overload
    def __xor__(self, arg2: int) -> object: ...
    @overload
    def __xor__(self, arg2: Tf_PyEnumWrapper) -> object: ...
    @property
...
class Tf_TestPyContainerConversions(Boost.Python.instance):
    __instance_size__: ClassVar[int] = ...
    def __init__(self) -> None: ...
    def GetPairTimesTwo(self) -> object: ...
    def GetTokens(self) -> object: ...
    def GetVectorTimesTwo(self) -> object: ...
    def __reduce__(self) -> Any: ...
...
class Tf_TestPyOptional(Boost.Python.instance):
    ...
    def TestOptionalChar(self) -> object: ...
    def TestOptionalDouble(self) -> object: ...
    def TestOptionalFloat(self) -> object: ...
    def TestOptionalInt(self) -> object: ...
    def TestOptionalLong(self) -> object: ...
    def TestOptionalShort(self) -> object: ...
    def TestOptionalString(self) -> object: ...
    def TestOptionalStringVector(self) -> object: ...
    def TestOptionalUChar(self) -> object: ...
    def TestOptionalUInt(self) -> object: ...
    def TestOptionalULong(self) -> object: ...
    def TestOptionalUShort(self) -> object: ...
    def __reduce__(self) -> Any: ...
...
class Type(Boost.Python.instance):
    ...
    @classmethod
    def AddAlias(cls, arg1: Type, arg2: Type, arg3: str) -> None: ...
    @classmethod
    ...
    @classmethod
    def FindDerivedByName(cls, arg1: Type, arg2: str) -> Type: ...
    ...
    def IsA(self, arg1: Type, arg2: Type) -> bool: ...
    def _DumpTypeHierarchy(self, TfType) -> Any: ...
    def __bool__(self) -> object: ...
    def __eq__(self, arg2: Type) -> object: ...
    def __ge__(self, arg2: Type) -> object: ...
    def __gt__(self, arg2: Type) -> object: ...
    def __hash__(self) -> int: ...
    def __le__(self, arg2: Type) -> object: ...
    def __lt__(self, arg2: Type) -> object: ...
    def __ne__(self, arg2: Type) -> object: ...
    def __reduce__(self) -> Any: ...
    @property
...
def GetCurrentScopeDescriptionStack() -> list: ...
def GetEnvSetting(arg1: str) -> object: ...
...
def StringSplit(arg1: str, arg2: str) -> list: ...
...
def _ConvertByteListToByteArray(arg1: list) -> object: ...
...
def _ReturnsBase(arg1: object) -> object: ...
def _ReturnsBaseRefPtr(arg1: object) -> object: ...
def _ReturnsConstBase(arg1: object) -> object: ...
def _RoundTripWrapperCallTest(arg1: object) -> object: ...
def _RoundTripWrapperIndexTest(arg1: object, arg2: int) -> object: ...
def _RoundTripWrapperTest(arg1: object) -> object: ...
...
def _returnsTfEnum(arg1: object) -> object: ...
