...
class Enum(Boost.Python.instance):
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def GetValueFromFullName(cls, arg1: str | pxr.Ar.ResolvedPath) -> Enum: ...
    def __reduce__(self) -> Any: ...
...
class Notice(Boost.Python.instance):
    ...
    @overload
    def Send(self, sender: Sender) -> Any: ...
...
class Type(Boost.Python.instance):
    ...
    @classmethod
    def AddAlias(cls, arg2: Type, arg3: str | pxr.Ar.ResolvedPath) -> None: ...
    @classmethod
    def Define(cls) -> Type: ...
    @classmethod
    def Find(cls) -> Type: ...
    ...
    @classmethod
    def FindDerivedByName(cls, arg2: str | pxr.Ar.ResolvedPath) -> Type: ...
