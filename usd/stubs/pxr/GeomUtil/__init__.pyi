...
class CapsuleMeshGenerator(Boost.Python.instance):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        """
    @staticmethod
    def ComputeNumPoints(numRadial: int, numCapAxial: int, closedSweep: bool) -> int: ...
    @staticmethod
    def GeneratePoints(arg1: int, arg2: int, arg3: float, arg4: float) -> pxr.Vt.Vec3fArray: ...
    @staticmethod
    def GenerateTopology(numRadial: int, numCapAxial: int, closedSweep: bool) -> pxr.PxOsd.MeshTopology: ...
...
class ConeMeshGenerator(Boost.Python.instance):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        """
    @staticmethod
    def ComputeNumPoints(numRadial: int, closedSweep: bool) -> int: ...
    @staticmethod
    def GeneratePoints(arg1: int, arg2: float, arg3: float) -> pxr.Vt.Vec3fArray: ...
    @staticmethod
    def GenerateTopology(numRadial: int, closedSweep: bool) -> pxr.PxOsd.MeshTopology: ...
...
class SphereMeshGenerator(Boost.Python.instance):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        """
    @staticmethod
    def ComputeNumPoints(numRadial: int, numAxial: int, closedSweep: bool) -> int: ...
    @staticmethod
    def GeneratePoints(arg1: int, arg2: int, arg3: float) -> pxr.Vt.Vec3fArray: ...
    @staticmethod
    def GenerateTopology(numRadial: int, numAxial: int, closedSweep: bool) -> pxr.PxOsd.MeshTopology: ...
