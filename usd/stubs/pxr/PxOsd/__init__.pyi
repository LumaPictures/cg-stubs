...
class MeshTopology(Boost.Python.instance):
    ...
    def __eq__(self, arg2: MeshTopology) -> object: ...
    def __ne__(self, arg2: MeshTopology) -> object: ...
...
class MeshTopologyValidation(Boost.Python.instance):
    ...
    class Invalidation(Boost.Python.instance):
        code: Any
        message: Any
        def __init__(self, arg2: object) -> Invalidation: ...
        def __reduce__(self) -> Any: ...
    __instance_size__: ClassVar[int] = ...
    def __init__(self) -> None: ...
...
class SubdivTags(Boost.Python.instance):
    ...
    def GetCreaseMethod(self) -> object: ...
    def GetCreaseWeights(self) -> FloatArray: ...
    def GetFaceVaryingInterpolationRule(self) -> object: ...
    def GetTriangleSubdivision(self) -> object: ...
    def GetVertexInterpolationRule(self) -> object: ...
    ...
    def __eq__(self, arg2: SubdivTags) -> object: ...
    def __ne__(self, arg2: SubdivTags) -> object: ...
    def __reduce__(self) -> Any: ...