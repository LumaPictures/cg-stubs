...
class MeshTopology(Boost.Python.instance):
    ...
    @overload
    def __init__(self, arg2: object, arg3: object, arg4: pxr.Vt.IntArray | list[int], arg5: pxr.Vt.IntArray | list[int], arg6: pxr.Vt.IntArray | list[int], arg7: SubdivTags) -> None: ...
    @overload
    def __init__(self, arg2: object, arg3: object, arg4: pxr.Vt.IntArray | list[int], arg5: pxr.Vt.IntArray | list[int], arg6: pxr.Vt.IntArray | list[int]) -> None: ...
    @overload
    def __init__(self, arg2: object, arg3: object, arg4: pxr.Vt.IntArray | list[int], arg5: pxr.Vt.IntArray | list[int], arg6: SubdivTags) -> None: ...
    @overload
    def __init__(self, arg2: object, arg3: object, arg4: pxr.Vt.IntArray | list[int], arg5: pxr.Vt.IntArray | list[int]) -> None: ...
    @overload
    ...
    def WithHoleIndices(self, arg2: pxr.Vt.IntArray | list[int]) -> MeshTopology: ...
...
class SubdivTags(Boost.Python.instance):
    __instance_size__: ClassVar[int] = ...
    @overload
    def __init__(self, arg2: object, arg3: object, arg4: object, arg5: object, arg6: pxr.Vt.IntArray | list[int], arg7: pxr.Vt.IntArray | list[int], arg8: pxr.Vt.FloatArray | list[float], arg9: pxr.Vt.IntArray | list[int], arg10: pxr.Vt.FloatArray | list[float]) -> None: ...
    @overload
    def __init__(self) -> None: ...
    def ComputeHash(self) -> int: ...
    ...
    def SetCornerIndices(self, arg2: pxr.Vt.IntArray | list[int]) -> None: ...
    def SetCornerWeights(self, arg2: pxr.Vt.FloatArray | list[float]) -> None: ...
    def SetCreaseIndices(self, arg2: pxr.Vt.IntArray | list[int]) -> None: ...
    def SetCreaseLengths(self, arg2: pxr.Vt.IntArray | list[int]) -> None: ...
    def SetCreaseMethod(self, arg2: str | pxr.Ar.ResolvedPath) -> None: ...
    def SetCreaseWeights(self, arg2: pxr.Vt.FloatArray | list[float]) -> None: ...
