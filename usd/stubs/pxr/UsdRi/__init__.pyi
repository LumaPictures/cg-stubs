...
class MaterialAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateDisplacementAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateSurfaceAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateVolumeAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class SplineAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def CreateInterpolationAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreatePositionsAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    def CreateValuesAttr(self, defaultValue: pxr.Vt.Value = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
...
class StatementsAPI(pxr.Usd.APISchemaBase):
    ...
    @overload
    def CreateRiAttribute(self, name: str, tfType: Type, nameSpace: str = ...) -> pxr.Usd.Attribute: ...
    @classmethod
    ...
    @classmethod
    def GetRiAttributeName(cls, prop: Property) -> str: ...
    @classmethod
    def GetRiAttributeNameSpace(cls, prop: Property) -> str: ...
