...
class Complex(Simple):
    ...
    def Define(self, stage: pxr.Usd.Stage, path: pxr.Sdf.Path | str) -> Complex: ...
    def Get(self, stage: pxr.Usd.Stage, path: pxr.Sdf.Path | str) -> Complex: ...
...
class ParamsAPI(pxr.Usd.APISchemaBase):
    ...
    def Get(self, stage: pxr.Usd.Stage, path: pxr.Sdf.Path | str) -> ParamsAPI: ...
...
class Simple(pxr.Usd.Typed):
    ...
    def Get(self, stage: pxr.Usd.Stage, path: pxr.Sdf.Path | str) -> Simple: ...
