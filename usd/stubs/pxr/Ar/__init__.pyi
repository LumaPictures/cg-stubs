...
class DefaultResolver(Resolver):
    ...
    @classmethod
    def SetDefaultSearchPath(cls, searchPath: list[str] | list[ResolvedPath]) -> None: ...
    def __reduce__(self) -> Any: ...
...
class Resolver(Boost.Python.instance):
    ...
    def CreateContextFromStrings(self, contextStrs: list[tuple[str | ResolvedPath, str | ResolvedPath]]) -> ResolverContext: ...
...
@overload
def JoinPackageRelativePath(paths: list[str] | list[ResolvedPath]) -> str: ...
@overload
