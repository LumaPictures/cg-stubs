...
class AssetInfo(Boost.Python.instance):
    ...
    @overload
    def __init__(self) -> None: ...
    def __eq__(self, arg2: AssetInfo) -> object: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg2: AssetInfo) -> object: ...
...
class DefaultResolverContext(Boost.Python.instance):
    ...
    def GetSearchPath(self) -> object: ...
    def __eq__(self, arg2: DefaultResolverContext) -> object: ...
    def __hash__(self) -> int: ...
    def __ne__(self, arg2: DefaultResolverContext) -> object: ...
    def __reduce__(self) -> Any: ...
...
class ResolvedPath(Boost.Python.instance):
    ...
    @overload
    def __eq__(self, arg2: ResolvedPath) -> object: ...
    @overload
    def __eq__(self, arg2: object) -> object: ...
    @overload
    def __ge__(self, arg2: ResolvedPath) -> object: ...
    @overload
    def __ge__(self, arg2: object) -> object: ...
    @overload
    def __gt__(self, arg2: ResolvedPath) -> object: ...
    @overload
    def __gt__(self, arg2: object) -> object: ...
    def __hash__(self) -> int: ...
    @overload
    def __le__(self, arg2: ResolvedPath) -> object: ...
    @overload
    def __le__(self, arg2: object) -> object: ...
    @overload
    def __lt__(self, arg2: ResolvedPath) -> object: ...
    @overload
    def __lt__(self, arg2: object) -> object: ...
    @overload
    def __ne__(self, arg2: ResolvedPath) -> object: ...
    @overload
...
class ResolverContext(Boost.Python.instance):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg2: object) -> object: ...
    def Get(self) -> list: ...
    def GetDebugString(self) -> str: ...
    def IsEmpty(self) -> bool: ...
    def __eq__(self, arg2: ResolverContext) -> object: ...
    def __hash__(self) -> int: ...
    def __lt__(self, arg2: ResolverContext) -> object: ...
    def __ne__(self, arg2: ResolverContext) -> object: ...
    def __reduce__(self) -> Any: ...
...
class Timestamp(Boost.Python.instance):
    ...
    def __eq__(self, arg2: Timestamp) -> object: ...
    def __ge__(self, arg2: Timestamp) -> object: ...
    def __gt__(self, arg2: Timestamp) -> object: ...
    def __hash__(self) -> int: ...
    def __le__(self, arg2: Timestamp) -> object: ...
    def __lt__(self, arg2: Timestamp) -> object: ...
    def __ne__(self, arg2: Timestamp) -> object: ...
    def __reduce__(self) -> Any: ...
...
def SplitPackageRelativePathInner(path: object) -> object: ...
def SplitPackageRelativePathOuter(path: object) -> object: ...
