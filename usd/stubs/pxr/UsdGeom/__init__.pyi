...
class BasisCurves(Curves):
    ...
    def ComputeInterpolationForSize(self, arg2: int, arg3: TimeCode) -> tuple[str, ComputeInterpolationInfo]: ...
...
class Boundable(Xformable):
    ...
    @overload
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def ComputeExtent(self, time: TimeCode) -> pxr.Vt.Vec3fArray: ...
    @overload
    @classmethod
    def ComputeExtentFromPlugins(cls, boundable: Boundable, time: TimeCode) -> pxr.Vt.Vec3fArray: ...
    @overload
    @classmethod
    def ComputeExtentFromPlugins(cls, boundable: Boundable, time: TimeCode, transform: pxr.Gf.Matrix4d) -> pxr.Vt.Vec3fArray: ...
...
class ModelAPI(pxr.Usd.APISchemaBase):
    ...
    def GetExtentsHint(self, time: TimeCode = ...) -> pxr.Vt.Vec3fArray: ...
...
class PointBased(Gprim):
    ...
    def ComputePointsAtTimes(self, times: list[pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode], baseTime: TimeCode) -> list[pxr.Vt.Array[pxr.Gf.Vec3f]]: ...
...
class PointInstancer(Boundable):
    ...
    def ComputeInstanceTransformsAtTimes(self, times: list[pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode], baseTime: TimeCode, doProtoXforms: ProtoXformInclusion = ..., applyMask: MaskApplication = ...) -> list[pxr.Vt.Array[pxr.Gf.Matrix4d]]: ...
...
class Subset(pxr.Usd.Typed):
    ...
    @classmethod
    def ValidateFamily(cls, geom: Imageable, elementType: str | pxr.Ar.ResolvedPath = ..., familyName: str | pxr.Ar.ResolvedPath = ...) -> str | pxr.Ar.ResolvedPath: ...
    @classmethod
    def ValidateSubsets(cls, subsets: list[Subset], elementCount: int, familyType: str | pxr.Ar.ResolvedPath) -> str | pxr.Ar.ResolvedPath: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
