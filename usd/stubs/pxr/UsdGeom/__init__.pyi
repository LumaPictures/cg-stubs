...
class HermiteCurves(Curves):
    class PointAndTangentArrays(Boost.Python.instance):
        __instance_size__: ClassVar[int] = ...
        @overload
        def __init__(self, arg2: pxr.Vt.Vec3fArray | list[pxr.Gf.Vec3f], arg3: pxr.Vt.Vec3fArray | list[pxr.Gf.Vec3f]) -> None: ...
        @overload
        def __init__(self) -> None: ...
        ...
        def Separate(self, arg1: pxr.Vt.Vec3fArray | list[pxr.Gf.Vec3f]) -> HermiteCurves.PointAndTangentArrays: ...
        def __bool__(self) -> bool: ...
...
class Mesh(PointBased):
    ...
    @classmethod
    def ValidateTopology(cls, faceVertexIndices: pxr.Vt.IntArray | list[int], faceVertexCounts: pxr.Vt.IntArray | list[int], numPoints: int) -> tuple: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class ModelAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    def SetExtentsHint(self, extents: pxr.Vt.Vec3fArray | list[pxr.Gf.Vec3f], time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class PointInstancer(Boundable):
    ...
    def ActivateIds(self, ids: pxr.Vt.Int64Array | list[int]) -> bool: ...
    ...
    def DeactivateIds(self, ids: pxr.Vt.Int64Array | list[int]) -> bool: ...
    @classmethod
    ...
    def InvisIds(self, ids: pxr.Vt.Int64Array | list[int], time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> bool: ...
    ...
    def VisIds(self, ids: pxr.Vt.Int64Array | list[int], time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Primvar(Boost.Python.instance):
    ...
    def SetIndices(self, indices: pxr.Vt.IntArray | list[int], time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
...
class PrimvarsAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateIndexedPrimvar(self, name: str | pxr.Ar.ResolvedPath, typeName: pxr.Sdf.ValueTypeName, value: T, indices: pxr.Vt.IntArray | list[int], interpolation: str | pxr.Ar.ResolvedPath = ..., elementSize: int = ..., time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> Primvar: ...
...
class Subset(pxr.Usd.Typed):
    ...
    @classmethod
    def CreateGeomSubset(cls, geom: Imageable, subsetName: str | pxr.Ar.ResolvedPath, elementType: str | pxr.Ar.ResolvedPath, indices: pxr.Vt.IntArray | list[int], familyName: str | pxr.Ar.ResolvedPath = ..., familyType: str | pxr.Ar.ResolvedPath = ...) -> Subset: ...
    def CreateIndicesAttr(self, defaultValue: Any = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
    def CreateUniqueGeomSubset(cls, geom: Imageable, subsetName: str | pxr.Ar.ResolvedPath, elementType: str | pxr.Ar.ResolvedPath, indices: pxr.Vt.IntArray | list[int], familyName: str | pxr.Ar.ResolvedPath = ..., familyType: str | pxr.Ar.ResolvedPath = ...) -> Subset: ...
    @classmethod
