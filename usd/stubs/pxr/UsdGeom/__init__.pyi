...
class BBoxCache(Boost.Python.instance):
    ...
    def ComputePointInstanceLocalBounds(self, instancer: PointInstancer, instanceIds: int) -> bool: ...
    ...
    def ComputePointInstanceRelativeBounds(self, instancer: PointInstancer, instanceIds: int, relativeToAncestorPrim: pxr.Usd.Prim) -> bool: ...
    def ComputePointInstanceUntransformedBound(self, instancer: PointInstancer, instanceId: int) -> pxr.Gf.BBox3d: ...
    def ComputePointInstanceUntransformedBounds(self, instancer: PointInstancer, instanceIds: int) -> bool: ...
    def ComputePointInstanceWorldBound(self, instancer: PointInstancer, instanceId: int) -> pxr.Gf.BBox3d: ...
    def ComputePointInstanceWorldBounds(self, instancer: PointInstancer, instanceIds: int) -> bool: ...
    ...
    def SetBaseTime(self, time: pxr.Usd.TimeCode) -> None: ...
    def SetIncludedPurposes(self, includedPurposes: list[str]) -> None: ...
    def SetTime(self, time: pxr.Usd.TimeCode) -> None: ...
...
class BasisCurves(Curves):
    ...
    def ComputeInterpolationForSize(self, arg2: int, arg3: pxr.Usd.TimeCode) -> str: ...
    def ComputeUniformDataSize(self, arg2: pxr.Usd.TimeCode) -> int: ...
    def ComputeVaryingDataSize(self, arg2: pxr.Usd.TimeCode) -> int: ...
    def ComputeVertexDataSize(self, arg2: pxr.Usd.TimeCode) -> int: ...
...
class Boundable(Xformable):
    ...
    @overload
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def ComputeExtent(self, time: pxr.Usd.TimeCode) -> bool: ...
    @overload
    @classmethod
    def ComputeExtentFromPlugins(cls, boundable: Boundable, time: pxr.Usd.TimeCode) -> bool: ...
    @overload
    @classmethod
    def ComputeExtentFromPlugins(cls, boundable: Boundable, time: pxr.Usd.TimeCode, transform: pxr.Gf.Matrix4d) -> bool: ...
...
class Camera(Xformable):
    ...
    def GetCamera(self, time: pxr.Usd.TimeCode = ...) -> Camera: ...
    ...
    def SetFromCamera(self, camera: Camera, time: pxr.Usd.TimeCode = ...) -> None: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class ConstraintTarget(Boost.Python.instance):
    ...
    def ComputeInWorldSpace(self, time: pxr.Usd.TimeCode = ...) -> pxr.Gf.Matrix4d: ...
    def Get(self, arg2: pxr.Gf.Matrix4d, time: pxr.Usd.TimeCode = ...) -> bool: ...
    ...
    def Set(self, value: pxr.Gf.Matrix4d, time: pxr.Usd.TimeCode = ...) -> bool: ...
...
class Curves(PointBased):
    ...
    def GetCurveCount(self, timeCode: pxr.Usd.TimeCode = ...) -> int: ...
...
class HermiteCurves(Curves):
    class PointAndTangentArrays(Boost.Python.instance):
        ...
        def __init__(self) -> None: ...
        @overload
        def __init__(self, arg2: pxr.Vt.Vec3fArray, arg3: pxr.Vt.Vec3fArray) -> None: ...
        def GetPoints(self) -> pxr.Vt.Vec3fArray: ...
        def GetTangents(self) -> pxr.Vt.Vec3fArray: ...
        def Interleave(self) -> pxr.Vt.Vec3fArray: ...
        def IsEmpty(self) -> bool: ...
        def Separate(self, arg1: pxr.Vt.Vec3fArray) -> HermiteCurves.PointAndTangentArrays: ...
        def __bool__(self) -> bool: ...
...
class Imageable(pxr.Usd.Typed):
    ...
    @overload
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def ComputeEffectiveVisibility(self, purpose: str = ..., time: pxr.Usd.TimeCode = ...) -> str: ...
    def ComputeLocalBound(self, time: pxr.Usd.TimeCode, purpose1: str = ..., purpose2: str = ..., purpose3: str = ..., purpose4: str = ...) -> pxr.Gf.BBox3d: ...
    def ComputeLocalToWorldTransform(self, time: pxr.Usd.TimeCode) -> pxr.Gf.Matrix4d: ...
    def ComputeParentToWorldTransform(self, time: pxr.Usd.TimeCode) -> pxr.Gf.Matrix4d: ...
    ...
    def ComputeUntransformedBound(self, time: pxr.Usd.TimeCode, purpose1: str = ..., purpose2: str = ..., purpose3: str = ..., purpose4: str = ...) -> pxr.Gf.BBox3d: ...
    def ComputeVisibility(self, time: pxr.Usd.TimeCode = ...) -> str: ...
    def ComputeWorldBound(self, time: pxr.Usd.TimeCode, purpose1: str = ..., purpose2: str = ..., purpose3: str = ..., purpose4: str = ...) -> pxr.Gf.BBox3d: ...
    ...
    def MakeInvisible(self, time: pxr.Usd.TimeCode = ...) -> None: ...
    def MakeVisible(self, time: pxr.Usd.TimeCode = ...) -> None: ...
    @overload
...
class Mesh(PointBased):
    ...
    def GetFaceCount(self, timeCode: pxr.Usd.TimeCode = ...) -> int: ...
    ...
    @classmethod
    def ValidateTopology(cls, faceVertexIndices: pxr.Vt.IntArray, faceVertexCounts: pxr.Vt.IntArray, numPoints: int) -> tuple: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class ModelAPI(pxr.Usd.APISchemaBase):
    ...
    def GetExtentsHint(self, time: pxr.Usd.TimeCode = ...) -> bool: ...
    ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    def SetExtentsHint(self, extents: pxr.Vt.Vec3fArray, time: pxr.Usd.TimeCode = ...) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class MotionAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def CanApply(cls, prim: pxr.Usd.Prim) -> _CanApplyResult: ...
    def ComputeMotionBlurScale(self, time: pxr.Usd.TimeCode = ...) -> float: ...
    def ComputeNonlinearSampleCount(self, time: pxr.Usd.TimeCode = ...) -> int: ...
    def ComputeVelocityScale(self, time: pxr.Usd.TimeCode = ...) -> float: ...
...
class PointBased(Gprim):
    ...
    @classmethod
    def ComputePointsAtTime(cls, time: TimeCode, baseTime: TimeCode) -> pxr.Vt.Vec3fArray: ...
    def ComputePointsAtTimes(self, times: list[pxr.Usd.TimeCode], baseTime: pxr.Usd.TimeCode) -> bool: ...
...
class PointInstancer(Boundable):
    ...
    def ActivateIds(self, ids: pxr.Vt.Int64Array) -> bool: ...
    def ComputeExtentAtTime(self, time: TimeCode, baseTime: TimeCode) -> pxr.Vt.Vec3fArray: ...
    def ComputeExtentAtTimes(self, times: object, baseTime: TimeCode) -> Any: ...
    @classmethod
    def ComputeInstanceTransformsAtTime(cls, time: TimeCode, baseTime: TimeCode, doProtoXforms: object = ..., applyMask: object = ...) -> pxr.Vt.Matrix4dArray: ...
    def ComputeInstanceTransformsAtTimes(self, times: list[pxr.Usd.TimeCode], baseTime: pxr.Usd.TimeCode, doProtoXforms: ProtoXformInclusion = ..., applyMask: MaskApplication = ...) -> bool: ...
    def ComputeMaskAtTime(self, time: pxr.Usd.TimeCode) -> list[bool]: ...
    def CreateAccelerationsAttr(self, defaultValue: Any = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    ...
    def DeactivateIds(self, ids: pxr.Vt.Int64Array) -> bool: ...
    @classmethod
    ...
    def GetInstanceCount(self, timeCode: pxr.Usd.TimeCode = ...) -> int: ...
    ...
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    def GetVelocitiesAttr(self) -> pxr.Usd.Attribute: ...
    def InvisId(self, id: int, time: pxr.Usd.TimeCode) -> bool: ...
    def InvisIds(self, ids: pxr.Vt.Int64Array, time: pxr.Usd.TimeCode) -> bool: ...
    def VisAllIds(self, time: pxr.Usd.TimeCode) -> bool: ...
    def VisId(self, id: int, time: pxr.Usd.TimeCode) -> bool: ...
    def VisIds(self, ids: pxr.Vt.Int64Array, time: pxr.Usd.TimeCode) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Points(PointBased):
    ...
    def GetIdsAttr(self) -> pxr.Usd.Attribute: ...
    def GetPointCount(self, timeCode: pxr.Usd.TimeCode = ...) -> int: ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    def GetWidthsAttr(self) -> pxr.Usd.Attribute: ...
    def GetWidthsInterpolation(self) -> str: ...
...
class Primvar(Boost.Python.instance):
    ...
    def GetIndices(self, time: pxr.Usd.TimeCode = ...) -> pxr.Vt.IntArray: ...
    ...
    def Set(self, value: T, time: pxr.Usd.TimeCode = ...) -> bool: ...
    def SetElementSize(self, eltSize: int) -> bool: ...
    def SetIdTarget(self, arg2: pxr.Sdf.Path) -> bool: ...
    def SetIndices(self, indices: pxr.Vt.IntArray, time: pxr.Usd.TimeCode = ...) -> bool: ...
...
class PrimvarsAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateIndexedPrimvar(self, name: str, typeName: pxr.Sdf.ValueTypeName, value: T, indices: pxr.Vt.IntArray, interpolation: str = ..., elementSize: int = ..., time: pxr.Usd.TimeCode = ...) -> Primvar: ...
    def CreateNonIndexedPrimvar(self, name: str, typeName: pxr.Sdf.ValueTypeName, value: T, interpolation: str = ..., elementSize: int = ..., time: pxr.Usd.TimeCode = ...) -> Primvar: ...
...
class Subset(pxr.Usd.Typed):
    ...
    @classmethod
    def CreateGeomSubset(cls, geom: Imageable, subsetName: str, elementType: str, indices: pxr.Vt.IntArray, familyName: str = ..., familyType: str = ...) -> Subset: ...
    def CreateIndicesAttr(self, defaultValue: Any = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
    def CreateUniqueGeomSubset(cls, geom: Imageable, subsetName: str, elementType: str, indices: pxr.Vt.IntArray, familyName: str = ..., familyType: str = ...) -> Subset: ...
    @classmethod
    ...
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    @classmethod
    def GetUnassignedIndices(cls, subsets: list[Subset], elementCount: int, time: pxr.Usd.TimeCode = ...) -> pxr.Vt.IntArray: ...
    @classmethod
...
class XformCommonAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    def GetXformVectors(self, time: pxr.Usd.TimeCode) -> tuple: ...
    def GetXformVectorsByAccumulation(self, time: pxr.Usd.TimeCode) -> tuple: ...
    def SetPivot(self, pivot: pxr.Gf.Vec3f, time: pxr.Usd.TimeCode = ...) -> bool: ...
    def SetResetXformStack(self, resetXformStack: bool) -> bool: ...
    def SetRotate(self, rotation: pxr.Gf.Vec3f, rotationOrder: XformCommonAPI.RotationOrder = ..., time: pxr.Usd.TimeCode = ...) -> bool: ...
    def SetScale(self, scale: pxr.Gf.Vec3f, time: pxr.Usd.TimeCode = ...) -> bool: ...
    def SetTranslate(self, translation: pxr.Gf.Vec3d, time: pxr.Usd.TimeCode = ...) -> bool: ...
    def SetXformVectors(self, translation: pxr.Gf.Vec3d, rotation: pxr.Gf.Vec3f, scale: pxr.Gf.Vec3f, pivot: pxr.Gf.Vec3f, rotationOrder: RotationOrder, time: pxr.Usd.TimeCode) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class XformOp(Boost.Python.instance):
    ...
    TypeInvalid: ClassVar[XformOp.Type] = ...
    TypeOrient: ClassVar[XformOp.Type] = ...
    TypeRotateX: ClassVar[XformOp.Type] = ...
    TypeRotateXYZ: ClassVar[XformOp.Type] = ...
    TypeRotateXZY: ClassVar[XformOp.Type] = ...
    TypeRotateY: ClassVar[XformOp.Type] = ...
    TypeRotateYXZ: ClassVar[XformOp.Type] = ...
    TypeRotateYZX: ClassVar[XformOp.Type] = ...
    TypeRotateZ: ClassVar[XformOp.Type] = ...
    TypeRotateZXY: ClassVar[XformOp.Type] = ...
    TypeRotateZYX: ClassVar[XformOp.Type] = ...
    TypeScale: ClassVar[XformOp.Type] = ...
    TypeTransform: ClassVar[XformOp.Type] = ...
    TypeTranslate: ClassVar[XformOp.Type] = ...
    __instance_size__: ClassVar[int] = ...
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, attr: pxr.Usd.Attribute, isInverseOp: bool = ...) -> None: ...
    def Get(self, time: pxr.Usd.TimeCode = ...) -> bool: ...
    def GetAttr(self) -> pxr.Usd.Attribute: ...
    def GetBaseName(self) -> str: ...
    def GetName(self) -> str: ...
    def GetNamespace(self) -> str: ...
