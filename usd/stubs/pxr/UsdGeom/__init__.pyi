...
class BBoxCache(Boost.Python.instance):
    ...
    @overload
    def ComputeUntransformedBound(self, prim: pxr.Usd.Prim, pathsToSkip: pxr.Sdf.PathSet, ctmOverrides: pxr.Tf.HashMap[pxr.Sdf.Path | str, pxr.Gf.Matrix4d, pxr.Sdf.Path.Hash]) -> pxr.Gf.BBox3d: ...
    @overload
    ...
    def ComputeWorldBoundWithOverrides(self, prim: pxr.Usd.Prim, pathsToSkip: pxr.Sdf.PathSet, primOverride: pxr.Gf.Matrix4d, ctmOverrides: pxr.Tf.HashMap[pxr.Sdf.Path | str, pxr.Gf.Matrix4d, pxr.Sdf.Path.Hash]) -> pxr.Gf.BBox3d: ...
...
class Camera(Xformable):
    ...
    def SetFromCamera(self, camera: Camera, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> None: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class ModelAPI(pxr.Usd.APISchemaBase):
    ...
    @classmethod
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    def SetExtentsHint(self, extents: pxr.Vt.Vec3fArray, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class PointBased(Gprim):
    ...
    def ComputePointsAtTimes(self, times: list[pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode], baseTime: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> list[pxr.Vt.Array[pxr.Gf.Vec3f]]: ...
...
class PointInstancer(Boundable):
    ...
    def ComputeInstanceTransformsAtTimes(self, times: list[pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode], baseTime: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode, doProtoXforms: PointInstancer.ProtoXformInclusion = ..., applyMask: PointInstancer.MaskApplication = ...) -> list[pxr.Vt.Array[pxr.Gf.Matrix4d]]: ...
    ...
    def InvisIds(self, ids: pxr.Vt.Int64Array, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> bool: ...
    ...
    def VisIds(self, ids: pxr.Vt.Int64Array, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Primvar(Boost.Python.instance):
    ...
    def SetIndices(self, indices: pxr.Vt.IntArray, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
...
class PrimvarsAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateIndexedPrimvar(self, name: str | pxr.Ar.ResolvedPath, typeName: pxr.Sdf.ValueTypeName, value: T, indices: pxr.Vt.IntArray, interpolation: str | pxr.Ar.ResolvedPath = ..., elementSize: int = ..., time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> Primvar: ...
...
class Subset(pxr.Usd.Typed):
    ...
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    @classmethod
    def GetUnassignedIndices(cls, subsets: list[Subset], elementCount: int, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> pxr.Vt.IntArray: ...
    @classmethod
    ...
    @classmethod
    def ValidateSubsets(cls, subsets: list[Subset], elementCount: int, familyType: str | pxr.Ar.ResolvedPath) -> str: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class XformCommonAPI(pxr.Usd.APISchemaBase):
    ...
    def SetPivot(self, pivot: pxr.Gf.Vec3f, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    def SetResetXformStack(self, resetXformStack: bool) -> bool: ...
    def SetRotate(self, rotation: pxr.Gf.Vec3f, rotationOrder: XformCommonAPI.RotationOrder = ..., time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    def SetScale(self, scale: pxr.Gf.Vec3f, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    def SetTranslate(self, translation: pxr.Gf.Vec3d, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    def SetXformVectors(self, translation: pxr.Gf.Vec3d, rotation: pxr.Gf.Vec3f, scale: pxr.Gf.Vec3f, pivot: pxr.Gf.Vec3f, rotationOrder: XformCommonAPI.RotationOrder, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class XformOp(Boost.Python.instance):
    ...
    def GetOpType(self) -> XformOp.Type: ...
    @classmethod
    def GetOpTypeEnum(cls, arg1: str | pxr.Ar.ResolvedPath) -> XformOp.Type: ...
    @classmethod
    def GetOpTypeToken(cls, arg1: XformOp.Type) -> str: ...
