...
class ConstraintTarget(Boost.Python.instance):
    ...
    @classmethod
    def IsValid(cls, arg1: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
...
class Primvar(Boost.Python.instance):
    ...
    @classmethod
    def IsPrimvar(cls, attr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp) -> bool: ...
    @classmethod
...
class XformOp(Boost.Python.instance):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, attr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, isInverseOp: bool = ...) -> None: ...
