...
class PointBased(Gprim):
    ...
    def ComputePointsAtTimes(self, times: list[pxr.Usd.TimeCode] | list[float] | list[pxr.Sdf.TimeCode], baseTime: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode) -> list[pxr.Vt.Array[pxr.Gf.Vec3f]]: ...
...
class PointInstancer(Boundable):
    ...
    def ComputeInstanceTransformsAtTimes(self, times: list[pxr.Usd.TimeCode] | list[float] | list[pxr.Sdf.TimeCode], baseTime: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode, doProtoXforms: PointInstancer.ProtoXformInclusion = ..., applyMask: PointInstancer.MaskApplication = ...) -> list[pxr.Vt.Array[pxr.Gf.Matrix4d]]: ...
