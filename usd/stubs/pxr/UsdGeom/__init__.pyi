...
class BBoxCache(Boost.Python.instance):
    ...
    @overload
    def ComputeUntransformedBound(self, prim: pxr.Usd.Prim, pathsToSkip: pxr.Sdf.PathSet, ctmOverrides: pxr.Tf.HashMap[pxr.Sdf.Path | str, pxr.Gf.Matrix4d, pxr.Sdf.Path | str.Hash]) -> pxr.Gf.BBox3d: ...
    def ComputeWorldBound(self, prim: pxr.Usd.Prim) -> pxr.Gf.BBox3d: ...
    def ComputeWorldBoundWithOverrides(self, prim: pxr.Usd.Prim, pathsToSkip: pxr.Sdf.PathSet, primOverride: pxr.Gf.Matrix4d, ctmOverrides: pxr.Tf.HashMap[pxr.Sdf.Path | str, pxr.Gf.Matrix4d, pxr.Sdf.Path | str.Hash]) -> pxr.Gf.BBox3d: ...
    ...
    def SetIncludedPurposes(self, includedPurposes: list[str | pxr.Ar.ResolvedPath]) -> None: ...
...
class Imageable(pxr.Usd.Typed):
    ...
    @overload
    def __init__(self, schemaObj: pxr.Usd.SchemaBase) -> None: ...
    def ComputeEffectiveVisibility(self, purpose: str | pxr.Ar.ResolvedPath = ..., time: TimeCode = ...) -> str: ...
    def ComputeLocalBound(self, time: TimeCode, purpose1: str | pxr.Ar.ResolvedPath = ..., purpose2: str | pxr.Ar.ResolvedPath = ..., purpose3: str | pxr.Ar.ResolvedPath = ..., purpose4: str | pxr.Ar.ResolvedPath = ...) -> pxr.Gf.BBox3d: ...
    ...
    def ComputeUntransformedBound(self, time: TimeCode, purpose1: str | pxr.Ar.ResolvedPath = ..., purpose2: str | pxr.Ar.ResolvedPath = ..., purpose3: str | pxr.Ar.ResolvedPath = ..., purpose4: str | pxr.Ar.ResolvedPath = ...) -> pxr.Gf.BBox3d: ...
    def ComputeVisibility(self, time: TimeCode = ...) -> str: ...
    def ComputeWorldBound(self, time: TimeCode, purpose1: str | pxr.Ar.ResolvedPath = ..., purpose2: str | pxr.Ar.ResolvedPath = ..., purpose3: str | pxr.Ar.ResolvedPath = ..., purpose4: str | pxr.Ar.ResolvedPath = ...) -> pxr.Gf.BBox3d: ...
...
class PointBased(Gprim):
    ...
    def ComputePointsAtTimes(self, times: list[pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode], baseTime: TimeCode) -> bool: ...
...
class PointInstancer(Boundable):
    ...
    def ComputeInstanceTransformsAtTimes(self, times: list[pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode], baseTime: TimeCode, doProtoXforms: ProtoXformInclusion = ..., applyMask: MaskApplication = ...) -> bool: ...
    ...
    def InvisIds(self, ids: pxr.Vt.Int64Array, time: TimeCode) -> bool: ...
    def VisAllIds(self, time: TimeCode) -> bool: ...
    def VisId(self, id: int, time: TimeCode) -> bool: ...
    def VisIds(self, ids: pxr.Vt.Int64Array, time: TimeCode) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Primvar(Boost.Python.instance):
    ...
    def GetIndices(self, time: TimeCode = ...) -> pxr.Vt.IntArray: ...
    ...
    def SetIndices(self, indices: pxr.Vt.IntArray, time: TimeCode = ...) -> bool: ...
...
class PrimvarsAPI(pxr.Usd.APISchemaBase):
    ...
    def CreateIndexedPrimvar(self, name: str | pxr.Ar.ResolvedPath, typeName: pxr.Sdf.ValueTypeName, value: T, indices: pxr.Vt.IntArray, interpolation: str | pxr.Ar.ResolvedPath = ..., elementSize: int = ..., time: TimeCode = ...) -> Primvar: ...
    def CreateNonIndexedPrimvar(self, name: str | pxr.Ar.ResolvedPath, typeName: pxr.Sdf.ValueTypeName, value: T, interpolation: str | pxr.Ar.ResolvedPath = ..., elementSize: int = ..., time: TimeCode = ...) -> Primvar: ...
    ...
    @overload
    def FindPrimvarWithInheritance(self, name: str | pxr.Ar.ResolvedPath, inheritedFromAncestors: list[Primvar]) -> Primvar: ...
    @overload
...
class Subset(pxr.Usd.Typed):
    ...
    @classmethod
    def CreateGeomSubset(cls, geom: Imageable, subsetName: str | pxr.Ar.ResolvedPath, elementType: str | pxr.Ar.ResolvedPath, indices: pxr.Vt.IntArray, familyName: str | pxr.Ar.ResolvedPath = ..., familyType: str | pxr.Ar.ResolvedPath = ...) -> Subset: ...
    def CreateIndicesAttr(self, defaultValue: Any = ..., writeSparsely: bool = ...) -> pxr.Usd.Attribute: ...
    @classmethod
    def CreateUniqueGeomSubset(cls, geom: Imageable, subsetName: str | pxr.Ar.ResolvedPath, elementType: str | pxr.Ar.ResolvedPath, indices: pxr.Vt.IntArray, familyName: str | pxr.Ar.ResolvedPath = ..., familyType: str | pxr.Ar.ResolvedPath = ...) -> Subset: ...
    @classmethod
    ...
    def GetSchemaAttributeNames(cls, includeInherited: bool = ...) -> list[str]: ...
    @classmethod
    def GetUnassignedIndices(cls, subsets: list[Subset], elementCount: int, time: TimeCode = ...) -> pxr.Vt.IntArray: ...
    @classmethod
    def SetFamilyType(cls, geom: Imageable, familyName: str | pxr.Ar.ResolvedPath, familyType: str | pxr.Ar.ResolvedPath) -> bool: ...
    @classmethod
    def ValidateFamily(cls, geom: Imageable, elementType: str | pxr.Ar.ResolvedPath = ..., familyName: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
    @classmethod
    def ValidateSubsets(cls, subsets: list[Subset], elementCount: int, familyType: str | pxr.Ar.ResolvedPath) -> bool: ...
    @classmethod
    def _GetStaticTfType(cls) -> pxr.Tf.Type: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class XformOp(Boost.Python.instance):
    ...
    @classmethod
    def GetOpTypeEnum(cls, arg1: str | pxr.Ar.ResolvedPath) -> Type: ...
    @classmethod
