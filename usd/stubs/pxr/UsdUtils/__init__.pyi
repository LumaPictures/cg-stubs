...
class ConditionalAbortDiagnosticDelegateErrorFilters(Boost.Python.instance):
    ...
    def SetCodePathFilters(self, codePathFilters: list[str | pxr.Ar.ResolvedPath]) -> None: ...
    def SetStringFilters(self, stringFilters: list[str | pxr.Ar.ResolvedPath]) -> None: ...
    def __reduce__(self) -> Any: ...
...
class StageCache(Boost.Python.instance):
    ...
    @classmethod
    def GetSessionLayerForVariantSelections(cls, arg1: str | pxr.Ar.ResolvedPath, arg2: list[tuple[str | pxr.Ar.ResolvedPath, str | pxr.Ar.ResolvedPath]]) -> pxr.Sdf.Layer: ...
    def __reduce__(self) -> Any: ...
...
def AuthorCollection(collectionName: str | pxr.Ar.ResolvedPath, usdPrim: pxr.Usd.Prim, pathsToInclude: list[pxr.Sdf.Path | str], pathsToExclude: list[pxr.Sdf.Path | str] = ...) -> pxr.Usd.CollectionAPI: ...
...
@overload
def ComputeUsdStageStats(arg1: str | pxr.Ar.ResolvedPath) -> pxr.Usd.Stage: ...
@overload
...
def CreateCollections(assignments: list[tuple[str | pxr.Ar.ResolvedPath, pxr.Sdf.PathSet]], usdPrim: pxr.Usd.Prim, minInclusionRatio: float = ..., maxNumExcludesBelowInclude: int = ..., minIncludeExcludeCollectionSize: int = ...) -> list[pxr.Usd.CollectionAPI]: ...
def CreateNewARKitUsdzPackage(assetPath: pxr.Sdf.AssetPath, usdzFilePath: str | pxr.Ar.ResolvedPath, firstLayerName: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
def CreateNewUsdzPackage(assetPath: pxr.Sdf.AssetPath, usdzFilePath: str | pxr.Ar.ResolvedPath, firstLayerName: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
...
def StitchClips(resultLayer: pxr.Sdf.Layer, clipLayerFiles: list[str | pxr.Ar.ResolvedPath], clipPath: pxr.Sdf.Path, startFrame: float = ..., endFrame: float = ..., interpolateMissingClipValues: bool = ..., clipSet: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
def StitchClipsManifest(manifestLayer: pxr.Sdf.Layer, topologyLayer: pxr.Sdf.Layer, clipPath: list[str | pxr.Ar.ResolvedPath], clipLayerFiles: pxr.Sdf.Path) -> bool: ...
def StitchClipsTemplate(resultLayer: pxr.Sdf.Layer, topologyLayer: pxr.Sdf.Layer, manifestLayer: pxr.Sdf.Layer, clipPath: pxr.Sdf.Path, templatePath: str | pxr.Ar.ResolvedPath, startTimeCode: float, endTimeCode: float, stride: float, activeOffset: float = ..., interpolateMissingClipValues: bool = ..., clipSet: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
def StitchClipsTopology(topologyLayer: pxr.Sdf.Layer, clipLayerFiles: list[str | pxr.Ar.ResolvedPath]) -> bool: ...
