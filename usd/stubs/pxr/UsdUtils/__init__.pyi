...
class ConditionalAbortDiagnosticDelegateErrorFilters(Boost.Python.instance):
    ...
    def SetCodePathFilters(self, codePathFilters: list[str] | list[pxr.Ar.ResolvedPath]) -> None: ...
    def SetStringFilters(self, stringFilters: list[str] | list[pxr.Ar.ResolvedPath]) -> None: ...
    def __reduce__(self) -> Any: ...
...
def StitchClips(resultLayer: pxr.Sdf.Layer, clipLayerFiles: list[str] | list[pxr.Ar.ResolvedPath], clipPath: pxr.Sdf.Path | str, startFrame: float = ..., endFrame: float = ..., interpolateMissingClipValues: bool = ..., clipSet: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
def StitchClipsManifest(manifestLayer: pxr.Sdf.Layer, topologyLayer: pxr.Sdf.Layer, clipPath: list[str] | list[pxr.Ar.ResolvedPath], clipLayerFiles: pxr.Sdf.Path | str) -> bool: ...
...
def StitchClipsTopology(topologyLayer: pxr.Sdf.Layer, clipLayerFiles: list[str] | list[pxr.Ar.ResolvedPath]) -> bool: ...
