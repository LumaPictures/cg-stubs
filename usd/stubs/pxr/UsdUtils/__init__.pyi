...
def ComputeCollectionIncludesAndExcludes(includedRootPaths: pxr.Sdf.PathSet, usdStage: pxr.Usd.Stage, minInclusionRatio: float = ..., maxNumExcludesBelowInclude: int = ..., minIncludeExcludeCollectionSize: int = ..., pathsToIgnore: unsignedint = ...) -> bool: ...
@overload
