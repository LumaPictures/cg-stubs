...
class SparseAttrValueWriter(Boost.Python.instance):
    def __init__(self, attr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, defaultValue: object = ...) -> None: ...
...
class SparseValueWriter(Boost.Python.instance):
    ...
    def SetAttribute(self, attr: pxr.Usd.Attribute | ConstraintTarget | Input | Output | Primvar | XformOp, value: object, time: TimeCode = ...) -> bool: ...
    def __reduce__(self) -> Any: ...
...
def ComputeCollectionIncludesAndExcludes(includedRootPaths: pxr.Sdf.PathSet, usdStage: pxr.Usd.Stage, minInclusionRatio: float = ..., maxNumExcludesBelowInclude: int = ..., minIncludeExcludeCollectionSize: int = ..., pathsToIgnore: PathHashSet = ...) -> tuple[list[pxr.Sdf.Path], list[pxr.Sdf.Path]]: ...
@overload
...
def StitchClips(resultLayer: pxr.Sdf.Layer, clipLayerFiles: list[str | pxr.Ar.ResolvedPath], clipPath: pxr.Sdf.Path | str, startFrame: float = ..., endFrame: float = ..., interpolateMissingClipValues: bool = ..., clipSet: str | pxr.Ar.ResolvedPath = ...) -> bool: ...
def StitchClipsManifest(manifestLayer: pxr.Sdf.Layer, topologyLayer: pxr.Sdf.Layer, clipPath: list[str | pxr.Ar.ResolvedPath], clipLayerFiles: pxr.Sdf.Path | str) -> bool: ...
