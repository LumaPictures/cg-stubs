...
class HydraObserver(Boost.Python.instance):
    ...
    def GetChildPrimPaths(self, arg2: pxr.Sdf.Path) -> list[pxr.Sdf.Path]: ...
    def GetDisplayName(self) -> str: ...
    def GetInputDisplayNames(self, arg2: IndexList) -> list[str]: ...
    def GetPendingNotices(self) -> list[NoticeEntry]: ...
    def GetPrim(self, arg2: pxr.Sdf.Path) -> HdSceneIndexPrim: ...
    @classmethod
    ...
    def TargetToNamedSceneIndex(self, arg2: str) -> bool: ...
    def __reduce__(self) -> Any: ...
...
class Utils(Boost.Python.instance):
    ...
    @classmethod
    def _GetAllPrimsOfType(cls, arg1: pxr.Usd.Stage, arg2: Type) -> list[pxr.Usd.Prim]: ...
    def __reduce__(self) -> Any: ...
