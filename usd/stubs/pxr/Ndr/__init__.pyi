...
class DiscoveryPlugin(Boost.Python.instance):
    ...
    @overload
    def DiscoverNodes(self, arg1: DiscoveryPlugin, arg2: DiscoveryPluginContext) -> object: ...
    @overload
    def DiscoverNodes(self, arg1: DiscoveryPlugin, arg2: DiscoveryPluginContext) -> None: ...
    @overload
    def GetSearchURIs(self, arg1: DiscoveryPlugin) -> object: ...
    @overload
    def GetSearchURIs(self, arg1: DiscoveryPlugin) -> None: ...
...
class DiscoveryPluginContext(Boost.Python.instance):
    def __init__(self, *args, **kwargs) -> None: ...
    @overload
    def GetSourceType(self, arg1: DiscoveryPluginContext, arg2: object) -> object: ...
    @overload
    def GetSourceType(self, arg1: DiscoveryPluginContext, arg2: object) -> None: ...
    def __bool__(self) -> bool: ...
    def __eq__(self, other) -> bool: ...
    def __lt__(self, other) -> bool: ...
    def __ne__(self, other) -> bool: ...
...
class Registry(Boost.Python.instance):
    def __init__(self, *args, **kwargs) -> None: ...
    def GetAllNodeSourceTypes(self) -> object: ...
    ...
    def GetNodeFromAsset(self, asset: AssetPath, metadata: object = ..., subIdentifier: object = ..., sourceType: object = ...) -> Node: ...
    def GetNodeFromSourceCode(self, sourceCode: object, sourceType: object, metadata: object = ...) -> Node: ...
    def GetNodeIdentifiers(self, family: object = ..., filter: object = ...) -> object: ...
    def GetNodeNames(self, family: object = ...) -> object: ...
    ...
    def GetSearchURIs(self) -> object: ...
    def SetExtraDiscoveryPlugins(self, arg1: Registry, arg2: list) -> None: ...
...
class Version(Boost.Python.instance):
    ...
    def __eq__(self, arg2: Version) -> object: ...
    def __ge__(self, arg2: Version) -> object: ...
    def __gt__(self, arg2: Version) -> object: ...
    def __hash__(self) -> int: ...
    def __le__(self, arg2: Version) -> object: ...
    def __lt__(self, arg2: Version) -> object: ...
    def __ne__(self, arg2: Version) -> object: ...
    def __reduce__(self) -> Any: ...
...
def FsHelpersDiscoverNodes(searchPaths: object, allowedExtensions: object, followSymlinks: bool = ..., context: DiscoveryPluginContext = ...) -> object: ...
def FsHelpersSplitShaderIdentifier(identifier: object) -> object: ...
