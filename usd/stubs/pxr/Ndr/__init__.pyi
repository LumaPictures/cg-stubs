...
class Registry(Boost.Python.instance):
    ...
    def GetNodeFromAsset(self, asset: pxr.Sdf.AssetPath, metadata: TokenMap = ..., subIdentifier: str | pxr.Ar.ResolvedPath = ..., sourceType: str | pxr.Ar.ResolvedPath = ...) -> Node: ...
...
def FsHelpersSplitShaderIdentifier(identifier: str | pxr.Ar.ResolvedPath) -> bool: ...
