...
class Node(Boost.Python.instance):
    ...
    def GetInput(self, arg2: str) -> Property: ...
    def GetInputNames(self) -> TokenVec: ...
    def GetMetadata(self) -> dict: ...
    def GetName(self) -> str: ...
    def GetOutput(self, arg2: str) -> Property: ...
...
class Property(Boost.Python.instance):
    ...
    def GetDefaultValue(self) -> pxr.Vt.Value: ...
    def GetInfoString(self) -> str: ...
    def GetMetadata(self) -> dict: ...
    def GetName(self) -> str: ...
...
class Registry(Boost.Python.instance):
    ...
    def GetNodeByIdentifierAndType(self, identifier: Identifier, nodeType: str) -> Node: ...
    def GetNodeByName(self, name: str, typePriority: TokenVec = ..., filter: VersionFilter = ...) -> Node: ...
    def GetNodeByNameAndType(self, name: str, nodeType: str, filter: VersionFilter = ...) -> Node: ...
    def GetNodeFromAsset(self, asset: pxr.Sdf.AssetPath, metadata: TokenMap = ..., subIdentifier: str = ..., sourceType: str = ...) -> Node: ...
    def GetNodeFromSourceCode(self, sourceCode: str, sourceType: str, metadata: TokenMap = ...) -> Node: ...
    def GetNodeIdentifiers(self, family: str = ..., filter: VersionFilter = ...) -> IdentifierVec: ...
    def GetNodeNames(self, family: str = ...) -> StringVec: ...
    def GetNodesByFamily(self, family: str = ..., filter: VersionFilter = ...) -> NodeList: ...
    def GetNodesByIdentifier(self, identifier: Identifier) -> NodeList: ...
    def GetNodesByName(self, name: str, filter: VersionFilter = ...) -> NodeList: ...
...
def FsHelpersDiscoverNodes(searchPaths: StringVec, allowedExtensions: StringVec, followSymlinks: bool = ..., context: DiscoveryPluginContext = ...) -> NodeDiscoveryResultVec: ...
def FsHelpersSplitShaderIdentifier(identifier: str) -> bool: ...
