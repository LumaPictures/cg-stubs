...
class Registry(Boost.Python.instance):
    ...
    @classmethod
    def FindTypeByName(cls, arg1: str) -> pxr.Tf.Type: ...
    @classmethod
    ...
    def GetStringFromPluginMetaData(self, arg2: pxr.Tf.Type, arg3: str) -> str: ...
    @overload
    def RegisterPlugins(self, arg2: str) -> list[Plugin]: ...
    @overload
    def RegisterPlugins(self, arg2: list[str | pxr.Ar.ResolvedPath]) -> list[Plugin]: ...
    def __bool__(self) -> bool: ...
    def __eq__(self, other: object) -> bool: ...
    def __lt__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
