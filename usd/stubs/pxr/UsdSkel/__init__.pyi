...
class SkinningQuery(Boost.Python.instance):
    ...
    @overload
    def ComputeSkinnedPoints(self, xforms: pxr.Vt.Matrix4dArray, points: pxr.Vt.Vec3fArray, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    @overload
    def ComputeSkinnedPoints(self, xforms: pxr.Vt.Matrix4fArray, points: pxr.Vt.Vec3fArray, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> bool: ...
    @overload
    def ComputeSkinnedTransform(self, xforms: pxr.Vt.Matrix4dArray, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> pxr.Gf.Matrix4d: ...
    @overload
    def ComputeSkinnedTransform(self, xforms: pxr.Vt.Matrix4fArray, time: pxr.Usd.TimeCode | float | pxr.Sdf.TimeCode = ...) -> pxr.Gf.Matrix4f: ...
