...
class AnimMapper(Boost.Python.instance):
    @overload
    def __init__(self, sourceOrder: pxr.Vt.TokenArray | typing.Iterable[pxr.Gf.Token], targetOrder: pxr.Vt.TokenArray | typing.Iterable[pxr.Gf.Token]) -> None: ...
    @overload
...
class BlendShapeQuery(Boost.Python.instance):
    ...
    def ComputeDeformedPoints(self, subShapeWeights: pxr.Vt.FloatArray | typing.Iterable[float], blendShapeIndices: pxr.Vt.UIntArray | typing.Iterable[int], subShapeIndices: pxr.Vt.UIntArray | typing.Iterable[int], blendShapePointIndices: list[pxr.Vt.IntArray] | list[typing.Iterable[int]], subShapePointOffset: list[pxr.Vt.Vec3fArray] | list[typing.Iterable[pxr.Gf.Vec3f]], points: pxr.Vt.Vec3fArray | typing.Iterable[pxr.Gf.Vec3f]) -> bool: ...
...
class Topology(Boost.Python.instance):
    ...
    @overload
    def __init__(self, arg2: pxr.Vt.TokenArray | typing.Iterable[pxr.Gf.Token]) -> None: ...
    @overload
