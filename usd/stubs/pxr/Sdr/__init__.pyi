...
class Registry(pxr.Ndr.Registry):
    ...
    def GetShaderNodeFromAsset(self, shaderAsset: pxr.Sdf.AssetPath, metadata: pxr.Ndr.TokenMap = ..., subIdentifier: str | pxr.Ar.ResolvedPath = ..., sourceType: str | pxr.Ar.ResolvedPath = ...) -> ShaderNode: ...
