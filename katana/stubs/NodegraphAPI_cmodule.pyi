...
class Context:
    ...
    @classmethod
    def GetNodeGraphContext(cls, node) -> str: ...
...
class GraphState:
    ...
    def getDynamicEntry(self, *args, **kwargs) -> Any: ...
    def getDynamicHash(self) -> int: ...
    def getHash(self) -> int: ...
    def getMaxTimeSamples(self) -> int: ...
    def getOpSystemArgs(self, *args, **kwargs) -> Any: ...
    ...
    def getStaticEntry(self, *args, **kwargs) -> Any: ...
...
class Node:
    ...
    def getDefaultParameter(self, *args, **kwargs) -> Any: ...
    def getGraphState(self, *args, **kwargs) -> Any: ...
    def getInfoString(self) -> str: ...
    def getInputPort(self, *args, **kwargs) -> Any: ...
    def getInputPortAndGraphState(self, outputPort: NodegraphAPI.Port, graphState) -> tuple: ...
    def getInputPortByIndex(self, index: int) -> NodegraphAPI.Port: ...
    def getInputPorts(self) -> list: ...
    def getInputSource(self, name: str, graphState) -> tuple: ...
    def getName(self) -> str: ...
    def getNumInputPorts(self) -> int: ...
    def getNumOutputPorts(self) -> int: ...
    def getOutputPort(self, *args, **kwargs) -> Any: ...
    ...
    def getParameterValue(self, *args, **kwargs) -> Any: ...
    def getParameters(self) -> GroupParameter: ...
    def getParent(self, *args, **kwargs) -> Any: ...
    def getSourcePort(self, port: NodegraphAPI.Port, graphState) -> tuple: ...
    ...
    def renameInputPort(self, *args, **kwargs) -> Any: ...
    def renameOutputPort(self, *args, **kwargs) -> Any: ...
...
class Parameter:
    ...
    def __init__(self) -> None: ...
    def buildXmlIO(self, *args, **kwargs) -> Any: ...
    ...
    def setValue(self, value: Any, time: float, final: bool = ..., sendNotifyMessage: bool = ...) -> None: ...
    def setValueAutoKey(self, value: Any, time: float, final: bool = ...) -> None: ...
    ...
    def writeOpaqueDataToXmlIO(self, *args, **kwargs) -> Any: ...
    def __hash__(self) -> int: ...
...
def BuildAttrFromGroupParameter(param: Parameter, graphState: GraphState = ..., multisampleDefault: bool = ..., numberAttrTypeDefault: Any = ..., includeEmptyGroups: bool = ..., groupInherit: bool = ...) -> Any: ...
...
def node_getAllConnectedInputs(sourceNodes: Iterable) -> set: ...
...
def node_registerExtension(extension: Any) -> None: ...
def node_registerPythonGroupType(typeName: str, constructor: Callable) -> None: ...
def node_registerPythonNodeFactory(nodeType: str, factory: Callable) -> None: ...
def node_registerPythonNodeType(typeName: str, constructor: Callable) -> None: ...
def node_registerQueryFlag(callbacK: Callable) -> None: ...
def node_removeNodeFlavor(nodeType: str, flavor: str) -> None: ...
def node_setExpressionObject(arg0: Any) -> None: ...
...
def notify_setNotificationFn(handler: Callable) -> None: ...
...
def parameter_getExpressionReferences(referents: Any = ..., referers: Any = ...) -> dict: ...
...
def parameter_setExpressionGlobals(globals: Any) -> None: ...
def parameter_setExpressionLocalFn(locals: Callable) -> None: ...
def parameter_setOpaqueParameterBuildXmlIOHandler(handler: Any) -> None: ...
def port_registerComplexConnector(connector: Callable) -> None: ...
