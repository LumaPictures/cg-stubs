...
class BakePrePostHandlerBase:
    def notify(self, assetId: str, rootLocationProducers, progressCallback: Callable | None, abortCallback: Callable | None): ...
...
class LookFileBaker:
    ...
    def bake(self, referenceOp: FnGeolib.GeolibRuntimeOp, passNamesAndOps, rootLocations: Iterable[str], outputPath) -> list[str]: ...
    def bakeAndPublish(self, referenceOp: FnGeolib.GeolibRuntimeOp, passNamesAndOps, rootLocations: Iterable[str], assetId: str, assetArgs: Incomplete | None = ..., preBakeHandler: Incomplete | None = ..., postBakeHandler: Incomplete | None = ...) -> str: ...