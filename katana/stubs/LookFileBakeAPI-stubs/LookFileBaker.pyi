...
class LookFileBaker:
    ...
    def bake(self, referenceOp: FnGeolib.GeolibRuntimeOp, passNamesAndOps, rootLocations: typing.Iterable[str], outputPath) -> list[str]: ...
    def bakeAndPublish(self, referenceOp: FnGeolib.GeolibRuntimeOp, passNamesAndOps, rootLocations: typing.Iterable[str], assetId: str, assetArgs: Incomplete | None = ..., preBakeHandler: Incomplete | None = ..., postBakeHandler: Incomplete | None = ...) -> str: ...