...
import PyFnGeolib.Util as Util
...
class Geolib:
    ...
    def createRuntime(self, *args, **kwargs) -> Any: ...
...
class GeolibRuntime:
    ...
    def _sendMessageInternal(self, arg0: Any) -> Any: ...
    @overload
...
class GeolibRuntimeTransaction:
    def __init__(self, *args, **kwargs) -> None: ...
    def createClient(self, *args, **kwargs) -> Any: ...
...
def GetRegisteredRuntimeInstance(*args, **kwargs) -> Any: ...
