...
class CallbackMixin(Mixin):
    ...
    @classmethod
    def onSceneGraphViewShaderSelected(cls, objectHash: Incomplete | None = ..., node: Incomplete | None = ..., parameterPolicy: Incomplete | None = ...): ...
    @classmethod
...
class DummyGroupPackage(GroupPackage):
    ...
    def __init__(self, packageNode: NodegraphAPI.Node | None, locationPath: Incomplete | None = ..., mainNode: Incomplete | None = ...): ...
    ...
    def createChildPackage(self, *args, **kwargs): ...
    @classmethod
...
class MuteAndSoloMixin(Mixin):
    ...
    def _getState(self, node, name: str, default: bool = ...) -> bool: ...
    def _setState(self, node, name: str, state: bool): ...
...
class Package(Upgradable):
    ...
    def __init__(self, packageNode: NodegraphAPI.Node): ...
    ...
    @classmethod
    def walkUpPackageHierarchy(cls, leafPackage: Package, includeLeaf: bool = ...) -> Iterator: ...
