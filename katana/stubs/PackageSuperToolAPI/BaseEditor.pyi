...
class BaseEditor(PyQt5.QtWidgets.QWidget):
    ...
    def _BaseEditor__adoptLocationsForEditing(self, locationPaths: list[str], locationAttributes: list[FnAttribute.GroupAttribute | FnAttribute.GroupAttribute]): ...
    ...
    def _BaseEditor__populateAddMenu(self, menu: QtWidgets.QMenu, package: PackageSuperToolAPI.Packages.Package): ...
    ...
    def getAttribute(self, locationPath: str, attributeName: str) -> FnAttribute | None: ...
    ...
    @classmethod
    def getSceneGraphViewTerminalOpUpdates(cls, graphState: NodegraphAPI.GraphState, rootLocations: tuple[str, ...]) -> list[tuple[str, FnAttribute.GroupAttribute, str]]: ...
    @classmethod
    def getSceneGraphViewTerminalOps(cls, graphState: NodegraphAPI.GraphState, rootLocations: tuple[str, ...]) -> list[tuple[str, FnAttribute.GroupAttribute] | Tuple[str, FnAttribute.GroupAttribute, str]]: ...
