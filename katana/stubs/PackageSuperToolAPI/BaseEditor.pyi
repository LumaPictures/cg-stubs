...
class BaseEditor(PyQt5.QtWidgets.QWidget):
    ...
    def _BaseEditor__iterTabs(self) -> Iterator[str, QtWidgets.QWidget]: ...
    ...
    def _executeCallbackWhenChildrenReady(self, parentLocationPath: str, callback: Callable, errorMessage: Incomplete | None = ..., **kwargs): ...
