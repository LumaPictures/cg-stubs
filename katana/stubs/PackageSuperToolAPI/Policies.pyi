...
class DeferredParameterCreatePolicy(QT4FormWidgets.ValuePolicy.AbstractValuePolicy):
    def __init__(self, parent: QT4FormWidgets.AbstractValuePolicy, node: NodegraphAPI.Node, checkboxText: str, package: Package, getterCallback: typing.Callable, setterCallback: typing.Callable, exposedParameterName: str, monitoredParameterNames: Incomplete | None = ...): ...
