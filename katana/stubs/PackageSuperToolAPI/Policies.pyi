...
class DeferredNodeBypassPolicy(QT4FormWidgets.ValuePolicy.AbstractValuePolicy):
    def __init__(self, parent: QT4FormWidgets.AbstractValuePolicy, nodeType: str, policyName: str, checkboxText: str, policyTitle: str, package: PackageSuperToolAPI.Packages.Package, parameterNames: list[str], parameterPolicyConstructor: Callable = ..., newPolicyCreatedCallback: Incomplete | None = ...) -> None: ...
