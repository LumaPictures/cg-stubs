...
class NetworkMaterialSplice(NetworkMaterialNode):
    def __init__(self): ...
    def AddGroup(self, param): ...
    def DeleteGroup(self, index, param): ...
    def ReorderGroup(self, index, newIndex, param): ...
    def _NetworkMaterialSplice__buildOpArgs(self, graphState): ...
    def _areInputsAndParametersDirty(self, port, graphState, visitedState, reset: bool = ...): ...
