...
def __ConvertArgsAttributeToObject(attribute: PyFnAttribute | None, isDefaultAttribute: bool = ...) -> collections.OrderedDict | int | float | str | list | FnAttribute.DataAttribute: ...
