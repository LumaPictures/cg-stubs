...
class Node3D(NodegraphAPI_cmodule.PythonNode, Node3D_geolib3.NodeGeolib3):
    def __init__(self): ...
...
def GetRenderTerminalOpSpecs(rendererName: str, renderMethodType: str, graphState: NodegraphAPI.GraphState) -> list[tuple[str, FnAttribute.GroupAttribute]]: ...
def GetRenderTerminalOps(txn: FnGeolib.GeolibRuntimeTransaction, rendererName: str, renderMethodType: str, graphState: Incomplete | None = ...) -> list[FnGeolib.GeolibRuntimeOp]: ...
