...
_Parameter_XML: str
__refresh_active_attribute_editor_nodes_on_idle: bool

class AttributeEditorNode3D(NodegraphAPI_cmodule.PythonGroupNode):
    def __init__(self): ...
    @classmethod
    def GetAttrType(cls, attr: FnAttribute.Attribute, default: Incomplete | None = ...) -> str | None: ...
    ...
    def _AttributeEditorNode3D__isolateNode(self, node): ...
...
def GetAttributeEditorsForAttr(attributeEditorAttr: FnAttribute.GroupAttribute) -> AttributeEditorsDict: ...
def _GetAttributeEditors(attr: FnAttribute.GroupAttribute) -> AttributeEditorsDict: ...
def __refreshActiveAttributeEditorNodes(): ...