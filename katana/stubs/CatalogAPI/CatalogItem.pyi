...
class CatalogItem:
    ...
    def __init__(self, catalogItemID): ...
...
def QueueCatalogItemPropertyUpdate(item): ...
def _ClearItemAttrs(catalogItemIDs: Incomplete | None = ...): ...
def _DelItemAttr(catalogItemID, name): ...
def _GetCachedBufferOrCreate(filename, sampleRate): ...
