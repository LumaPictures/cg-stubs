...
import PyUtilModule.FarmAPI.FarmManager as FarmManager
import PyUtilModule.FarmAPI.FarmPluginManager as FarmPluginManager
...
class FarmSetting:
    ...
    def __init__(self, name: str = ..., farmType: str = ..., defaultValue: Incomplete | None = ..., size: int = ..., hints: Incomplete | None = ...): ...
...
class NodeRenderSettings:
    def __init__(self, dependencyListEntry: Incomplete | None = ...): ...
...
def AddFarmMenuOption(menuCommandText: str, callback: Callable): ...
def AddFarmPopupMenuOption(menuCommandText: str, callback: Callable): ...
...
def WriteXML(**kwargs): ...
def _AddCustomFarmSetting(name: str = ..., setting: Incomplete | None = ...): ...
def __getGroupContentsAsList(self, node: NodegraphAPI.Node, recurse: bool = ...): ...
