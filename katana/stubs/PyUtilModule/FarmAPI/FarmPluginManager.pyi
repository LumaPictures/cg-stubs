...
class JobRequest:
    def __init__(self, nodeName: str, renderContextName: str, frames: list[int], commands: list[str], environment, tempDir: str): ...
...
def _GetFarmPlugin(farm: Incomplete | None = ...) -> FarmAPI.BaseFarmPlugin: ...
