...
class BaseFarmPlugin:
    class InstallationMetadata:
        def __init__(self, katanaRoot: str, renderPluginDsoPaths, renderbootCommand: Incomplete | None = ...): ...
...
class Job:
    ...
    def __init__(self, jobId: str, name: str, startTime: int, endTime: int, state: str, renderLogFilename: str): ...

class JobNotFoundException(FarmPluginException):
    def __init__(self, jobId: str, contextMessage: str): ...
