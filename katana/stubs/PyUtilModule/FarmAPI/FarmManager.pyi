...
def GetNodeDeps(node: NodegraphAPI.Node, nodeInfo: dict[str, dict], parentPass: str | None, includeInternalDeps: bool = ..., ignoreBypassed: bool = ...): ...
...
def __getNodeDeps(node: NodegraphAPI.Node, nodeInfo: dict[str, dict], parentPass: str | None, includeInternalDeps: bool, ignoreBypassed: bool, nodeVisitCache: None): ...
