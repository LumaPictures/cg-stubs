...
class WorkingSetClient:
    ...
    def __init__(self, txn: PyFnGeolib.GeolibRuntime.Transaction, op: PyFnGeolib.GeolibRuntime.Op) -> None: ...
    ...
    def setOp(self, transaction: PyFnGeolib.GeolibRuntime.Transaction, op: PyFnGeolib.GeolibRuntime.Op): ...
