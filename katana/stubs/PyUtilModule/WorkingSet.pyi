...
class LocationStateMap(dict):
    ...
    def items(self, rootPath: Incomplete | None = ...) -> Iterator: ...
    def keys(self, rootPath: Incomplete | None = ...) -> Iterator: ...
    def pop(self, key: str, *args) -> Any: ...
    def values(self, rootPath: Incomplete | None = ...) -> Iterator: ...
...
class WorkingSet:
    ...
    def __init__(self): ...
    def _WorkingSet__checkCallback(self, callback: Callable, expectedArgNames: tuple[str, ...]): ...
    ...
    def addAllowedStatesChangedCallback(self, callback: Callable): ...
    def addLocationStateChangedCallback(self, callback: Callable): ...
    def addWorkingSetClearedCallback(self, callback: Callable): ...
    def asGroupAttribute(self) -> FnAttribute.GroupAttribute: ...
    ...
    @classmethod
    def fromGroupAttribute(cls, groupAttribute: FnAttribute.GroupAttribute, sender: Incomplete | None = ..., useCallbacks: bool = ..., workingSetInstance: Incomplete | None = ...) -> WorkingSet: ...
    ...
    def iterateLocationAncestors(self, locationPath: str, includeLocation: bool = ...) -> Iterator: ...
    ...
    def removeAllowedStatesChangedCallback(self, callback: Callable): ...
    def removeLocationStateChangedCallback(self, callback: Callable): ...
    def removeWorkingSetClearedCallback(self, callback: Callable): ...
