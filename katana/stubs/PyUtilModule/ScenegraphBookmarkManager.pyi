...
def GetScenegraphBookmark(bookmarkName: str) -> dict | None: ...
...
def _GetBookmarkParam(bookmarkName: str, create: bool = ..., deleteExisting: bool = ...) -> Parameter | None: ...
def _GetRootBookmarksParam(create: bool = ...) -> Parameter | None: ...
def _MakeSafeGroupName(fullName): ...
