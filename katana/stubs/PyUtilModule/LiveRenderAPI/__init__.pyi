...
def AppendTerminalOp(opKey: Any, opType: str, opArgs: PyFnAttribute.GroupAttribute): ...
def ClearAllTerminalOps(): ...
def GetTerminalOps() -> list[None]: ...
def InsertTerminalOp(opKey: Any, opType: str, opArgs: PyFnAttribute.GroupAttribute, insertIndex: int): ...
