...
_ConditionalVisBooleanOps: dict
_ConditionalVisOps: dict
_ConditionalVisOpsPathIsNotParameter: dict

class ConditionalVisibilityOpBase(PyQt5.QtCore.QObject):
    conditionalStateEval: ClassVar[PyQt5.QtCore.pyqtSignal] = ...
    def __init__(self, targetPolicy, hints, prefix): ...
...
class _OpBoolean(PyQt5.QtCore.QObject):
    conditionalStateEval: ClassVar[PyQt5.QtCore.pyqtSignal] = ...
    def __init__(self, policy, hints, prefix): ...
...
def _BuildOpFromPrefix(policy, hints, prefix): ...
