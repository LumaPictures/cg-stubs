...
class FButton(FLabel):
    ...
    def __init__(self, parent, text, font: Incomplete | None = ..., pad: int = ...): ...
...
class FDisclosureTriangle(FWidget):
    ...
    def __init__(self, parent, size: int = ..., neverOpen: bool = ..., aspect: float = ...): ...
    def _FDisclosureTriangle__doTimer(self): ...
    def enterEvent(self, event: QtCore.QEvent): ...
    def fontChange(self, _oldFont: QtGui.QFont): ...
    def isExpanded(self): ...
...
class FMenu(FWidget):
    ...
    def __init__(self, parent, size: int = ..., text: Incomplete | None = ..., font: Incomplete | None = ..., pad: int = ..., pixmap: Incomplete | None = ...): ...
...
class FPixmap(FWidget):
    def __init__(self, parent, pixmap: Incomplete | None = ...): ...
    def mousePressEvent(self, event): ...
    def paint(self, painter, width, height): ...
    def pixmap(self): ...
    def setPixmap(self, pixmap): ...
...
class FStateBadge(FWidget):
    def __init__(self, parent, letter, color, size: int = ..., textColor: Incomplete | None = ...): ...
    def enterEvent(self, event): ...
    def getSize(self): ...
    def leaveEvent(self, event): ...
...
class FSvgIcon(FWidget):
    def __init__(self, parent, filename, size: int = ...): ...
    def paint(self, painter, width, height): ...

class FToggleStateBadge(FWidget):
    def __init__(self, parent, color, size: int = ...): ...
    def enterEvent(self, event): ...
    def getSize(self): ...
    def leaveEvent(self, event): ...
    def paint(self, painter, width, height, testHover: bool = ...): ...
