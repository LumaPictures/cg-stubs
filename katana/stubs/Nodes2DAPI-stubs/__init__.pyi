...
import Nodes2DAPI.Expression as Expression
import Nodes2DAPI.FileInNodeUtil as FileInNodeUtil
import Nodes2DAPI.FileOutNodeUtil as FileOutNodeUtil
import Nodes2DAPI.GradientNodeUtil as GradientNodeUtil
import Nodes2DAPI.NodeColorDelegate as NodeColorDelegate
import NodegraphAPI as NodegraphAPI
import Nodes2DAPI_cmodule as Nodes2DAPI_cmodule
import RenderingAPI as RenderingAPI
import Nodes2DAPI.ThumbnailManager as ThumbnailManager
import Nodes2DAPI.TransformUtil as TransformUtil
...
PRIORITIZER_WINDOW_MODE_FOLLOW_VIEW_AREA: int
PRIORITIZER_WINDOW_MODE_MOUSE_CLICK: int
PRIORITIZER_WINDOW_MODE_STATIC: int
...
_InLoad: bool
_PrioritizerViewRect: None
_ViewBasedPrioritization: bool
_global_renders: list
global_prioritizerWindowMode: int
global_prioritizer_center: None
global_prioritizer_samplerate: tuple
global_prioritizer_type: int
saveflags: int
useFlags: bool

def GetErrorMessages(): ...
def GetNewRenders(): ...
def GetPrioritizerCenter(): ...
def GetPrioritizerWindow(): ...
def GetPrioritizerWindowMode(): ...
def GetRenderMessages(): ...
def GetViewBasedPrioritization(): ...
def IsUpstreamNode2D(node, frame: Incomplete | None = ...): ...
...
def ReportErrorMessage(sequenceID, errorCode, nodeName, message): ...
...
def __loadbegin_callback(*args, **kwargs): ...
def __loadend_callback(*args, **kwargs): ...
def __recook_callback(*args, **kwargs): ...
def _idle_poll(eventType, eventID, **kwargs): ...
def cacheManager_flush_CB(*args, **kwargs): ...