...
class LiveAttributeWorker:
    def __init__(self, runtime, client: Incomplete | None = ...): ...
    def applyQueuedAttributeChanges(self): ...
    def canApplyUpdate(self) -> bool: ...
    def getLiveAttributeOp(self) -> FnGeolib.GeolibRuntimeOp: ...
    def queueLiveAttribute(self, locationPath, attrValue, attrPath: str = ...): ...
    def setClient(self, client: PyFnGeolib.GeolibRuntime.client): ...
    def setLiveAttributeOp(self, liveAttrOp: FnGeolib.GeolibRuntimeOp): ...

def AddSettingsToRerenderRecipe(): ...
def ApplyTerminalOpDelegates(inputOp: FnGeolib.GeolibRuntimeOp, txn: transaction): ...
def CheckLiveRenderSettings(attributes: FnAttribute.GroupAttribute): ...
def CheckOutputsRenderSettings(attributes: FnAttribute.GroupAttribute): ...
...
def GetDefaultTerminalOps(txn: transaction, opInput) -> list[FnGeolib.GeolibRuntimeOp]: ...
def GetDeletedLocationsUpdate(deletedLocations: list[str]) -> FnAttribute.GroupAttribute: ...
def GetInteractiveRenderFiltersOps(opInput: FnGeolib.GeolibRuntimeOp, activatePorts: bool = ...) -> list[FnGeolib.GeolibRuntimeOp]: ...
def GetLightListChanges(location: str, locationAttrs): ...
def GetLiveRenderNodeAndPort() -> Tuple[Node3D, port]: ...
def GetRenderCameraChanges(location: str, locationAttrs): ...
...
def OnCancelled(*args, **kwargs): ...
def OnCompleted(*args, **kwargs): ...
def OnErrored(*args, **kwargs): ...
def OnIdle(*args, **kwds): ...
def OnLiveRenderClearAllTerminalOps(eventType, eventID): ...
def OnLiveRenderInsertTerminalOp(eventType: str, eventID: Any, opKey: Incomplete | None = ..., opType: str = ..., opArgs: Incomplete | None = ..., insertIndex: Incomplete | None = ...): ...
def OnLiveRenderRemoveTerminalOp(eventType: str, eventID: Any, opKey: Incomplete | None = ..., deferred: bool = ...): ...
def OnLiveRenderRestoreDefaultTerminalOps(eventType, eventID): ...
def OnManualUpdate(eventType: str, eventID: Any, updateMode: Incomplete | None = ...): ...
def OnNodeDeleted(eventType: str, eventID: Any, node: NodegraphAPI.Node, oldName: str): ...
def OnNodeRenamed(eventType: str, eventID: Any, node: NodegraphAPI.Node, oldName: str, newName: str): ...
def OnNodeSetBypassed(eventType, eventID, node, **kwargs): ...
def OnParameterFinalize(eventType, eventID, param, **kwargs): ...
def OnRerenderCameraChanged(eventType: str, eventID: Any, cameraType: Incomplete | None = ..., cameraPath: Incomplete | None = ...): ...
def OnRoiChanged(*args, **kwargs): ...
def OnSendCommand(*args, **kwargs): ...
def OnSendData(*args, **kwargs): ...
def OnSetCurrentTime(*args, **kwargs): ...
def OnStarted(*args, **kwargs): ...
def OnStop(*args, **kwargs): ...
def OnStopped(sequenceIDs): ...
def OnUpdate(*args, **kwargs): ...
def OnUpdateModeChanged(eventType: str, eventID: Any, updateMode: Incomplete | None = ...): ...
def OnViewMatrixChanged(*args, **kwargs): ...
def OnViewerLiveAttributeChanged(eventType: str, eventID: Any, locationPath: str, attrPath: str, attrValue: FnAttribute.Attribute): ...
...
def __RemoveTerminalOp(opKey: Any): ...
...
def __setPruneOpChainInputOpArgs(*args, **kwargs): ...
...
def getImplicitTerminalOps(txn: transaction, opInput: FnGeolib.GeolibRuntimeOp, renderNode: NodegraphAPI.Node) -> list[FnGeolib.GeolibRuntimeOp]: ...
