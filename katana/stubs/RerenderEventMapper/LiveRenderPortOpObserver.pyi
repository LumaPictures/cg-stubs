...
class LiveRenderPortOpObserver(PortOpClient):
    ...
    @classmethod
    def _LiveRenderPortOpObserver__onCatalogGSVPinned(cls, objectHash: Any, catalogItem: CatalogAPI.Catalog.CatalogItem, gsvID: str, isPinned: bool): ...
    @classmethod
    def _LiveRenderPortOpObserver__onDirtyEvent(cls, *args, **kwargs): ...
    ...
    @classmethod
    def _LiveRenderPortOpObserver__onVirtualCameraMoved(cls, eventType: str, eventID: Any, attrName: str, attrValue: PyFnAttribute.Attribute, isFinal: bool): ...
...
class _TransactionProxy:
    ...
    def localOnly(self, *args, **kwds) -> None: ...
    ...
    def useOpPool(self, *args, **kwds) -> None: ...
