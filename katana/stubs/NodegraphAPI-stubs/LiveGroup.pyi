...
_ChangeEventTypes: set
_LiveGroupExtraHints: dict
_LiveGroupMixinParameter_XML: str
_LiveGroupStackExtraHints: dict
_NumberOfTrackedEditableLiveGroupNodes: int
__IGNORE_CHANGES_ATTRIBUTE_NAME: str
__liveGroupCachingEnabled: bool
__liveGroupLoadingEnabled: bool
...
class LiveGroupMixin:
    ...
    def __init__(self): ...
    def _LiveGroupMixin__adoptPortConfiguration(self, node): ...
...
class LiveGroupNode(PythonGroupNode, LiveGroupMixin):
...
class LiveGroupStack(GroupStack.GroupStackNode, LiveGroupMixin):
    def __init__(self): ...
    def addParameterHints(self, attrName, inputDict): ...
...
class UndoConvertGroupToLiveGroup(UndoStack.UndoEntry):
    def __init__(self, groupNodeName, liveGroupNodeName): ...
    def getName(self) -> str: ...
    def redo(self): ...
    def undo(self): ...

class UndoConvertLiveGroupToGroup(UndoStack.UndoEntry):
    def __init__(self, groupNodeName, liveGroupNodeName, filenameOrAssetID, isEditable): ...
    def getName(self) -> str: ...
    def redo(self): ...
    def undo(self): ...
...
def LiveGroupEventFilter(eventType: str | None, eventID: Any, **kwargs): ...
...
def ReleaseAllLiveGroups(node: NodegraphAPI.GroupNode | NodegraphAPI.Node): ...
def RenameLiveGroupExpressions(node, oldName, newName): ...
def RunAssetPluginCommand(filenameOrAssetID: str, command: str, commandArgs: Incomplete | None = ...) -> bool: ...
...
def _IgnoreLiveGroupNodeChanges(liveGroupNode: LiveGroupNode) -> bool: ...
def _MarkFirstAncestorLiveGroupNodeAsModified(liveGroupNode: LiveGroupNode, processedNodes: Incomplete | None = ...): ...
def _OnNewScene(objectHash): ...
def _ResetLiveGroupTracking(): ...
def _SetIgnoreLiveGroupNodeChanges(liveGroupNode: LiveGroupNode, ignoreChanges: bool): ...
def _StopTrackingChangesInEditableLiveGroupNode(liveGroupNode: LiveGroupNode): ...
def _TrackChangesInEditableLiveGroupNode(liveGroupNode: LiveGroupNode): ...
def __cacheManager_flush_CB(eventType, eventID, isNodeGraphLoading): ...
def __node_setBypassed_callback_livegroups(eventType: str | None, eventID: Any, node: NodegraphAPI.Node, **kwargs): ...
def __on_node_delete(eventType: str | None, eventID: Any, node: NodegraphAPI.Node, oldName: str): ...
def __on_nodegraph_changed(args: list[tuple[str, Any, dict]]): ...
def __parameter_finalizeValue_callback_livegroups(eventType: str | None, eventID: Any, param: NodegraphAPI.Parameter, **kwargs): ...
def _load_live_content(filename: str, nodeTypeName: str, nodeName: str) -> NodegraphAPI.GroupNode | None: ...
def _lock_children(node, locked: bool = ...): ...
def _remove_children(node: NodegraphAPI.GroupNode | NodegraphAPI.Node): ...
def _rewire_internal_ports_for_bypassing(liveGroupNode): ...
def _unviewedit_node(node): ...
def onShutdown(**kwargs): ...