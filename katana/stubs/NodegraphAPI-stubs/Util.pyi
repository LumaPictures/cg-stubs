...
def GenericParameterReset(node): ...
...
def IsSpecifiedNodeTypeUpstream(node, nodeTypes, checkedNodes: Incomplete | None = ...): ...
def IsolateNode(node: NodegraphAPI.Node): ...
def ParameterReset(node): ...
...
def _GetConnectedNodesFromOutputPort(outputPort, processedNodes): ...
def __expressionNodes(sourceNode, destNode, recursively: bool = ...): ...
def __recursivelyExpressionParameters(sourceGroup, destGroup): ...
def __syncParameterTree(oldParam, newParam): ...