...
class CallersCalleesNavigationPopup(PyQt5.QtWidgets.QFrame):
    ...
    def __init__(self, functionName, functionType, parent: Incomplete | None = ...): ...
...
class ProfileStatsWidget(PyQt5.QtWidgets.QFrame):
    ...
    def __init__(self, parent, stats: Incomplete | None = ..., defaultStatusText: str = ...): ...
...
class ProfileTreeWidgetItem(PyQt5.QtWidgets.QTreeWidgetItem):
    def __init__(self, parent, func, stats): ...
