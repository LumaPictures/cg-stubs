...
class RenderNode:
    def __init__(self, node, graphState): ...
    def _RenderNode__addRenderOutputEnabledStatesToRecipe(self, txn, op, enabledOutputNames): ...
    def _RenderNode__addRenderTargetLocationsToRecipe(self, txn, op, renderTargetLocations): ...
...
def __on_port_connect(changeEvents): ...