...
class CallbackPortOpClient(PortOpClient):
    ...
    def __init__(self, port: PortId = ..., opChangeCallback: Incomplete | None = ..., initialGraphStateSpec: GraphStateId = ..., nodeTraversalEndpointsSpec: str = ..., initialGraphStateModifier: Incomplete | None = ..., postTraversalGraphStateModifier: Incomplete | None = ..., applyTerminalOpDelegates: bool = ...) -> None: ...
    @staticmethod
    def _getCallback(weakCallback): ...
    @staticmethod
