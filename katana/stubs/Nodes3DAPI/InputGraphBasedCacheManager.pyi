...
class InputGraphBasedCacheManager:
    def __init__(self): ...
    def _InputGraphBasedCacheManager__on_node_delete(self, eventType, eventID, node, oldName): ...
    ...
    def cacheValue(self, node: NodegraphAPI.Node, graphState: NodegraphAPI.GraphState, portIndex: int, value: Any, getInputNodesFnc: typing.Callable): ...
    def clear(self): ...
...
class _NodeRecord:
    def __init__(self): ...
    def getValue(self, graphState, portIndex): ...
    def invalidate(self): ...
    def invalidateCache(self): ...
    def setValue(self, graphState, portIndex, value): ...