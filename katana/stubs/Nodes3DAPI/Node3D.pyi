...
def GetGeometryProducer(node: Incomplete | None = ..., graphState: Incomplete | None = ..., portIndex: int = ...) -> PyFnGeolibProducers.GeometryProducer | None: ...
...
def GetRenderProducer(node: Incomplete | None = ..., graphState: Incomplete | None = ..., useMaxSamples: bool = ..., portIndex: int = ..., applyRenderSelectedMask: bool = ...) -> PyFnGeolibProducers.GeometryProducer | None: ...
