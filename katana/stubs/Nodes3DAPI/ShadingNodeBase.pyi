...
ShadingNodeSubClasses: dict
_ExtraHints: dict
_Parameter_XML: str
_RegisteredNodeTypes: set

class ShadingNodeBase(Node3D):
    def __init__(self): ...
    def _ShadingNodeBase__buildOpArgs(self, graphState, inputNames, parentInputs, paramTracker): ...
    ...
    def _ShadingNodeBase__getUpstreamMaterialParameterDefaultsOp(self, transaction, graphState, locationPath): ...
    def _ShadingNodeBase__on_parameter_setValue(self, eventName: str, eventId: str, param: Incomplete | None = ..., node: Incomplete | None = ..., **_kwargs): ...
    ...
    def _validateExistingPortConnections(self, port): ...
...
def ShadingNodeBase_addParameterHints(self, attrName, inputDict): ...
def ShadingNodeBase_getExtraHints(self): ...
def ShadingNodeBase_getRendererName(self): ...
def _AssignPortColor(port): ...
def _HexToRGB(color: str) -> list: ...
def _ParsePortColor(colorValues: Incomplete | None = ...) -> list: ...
