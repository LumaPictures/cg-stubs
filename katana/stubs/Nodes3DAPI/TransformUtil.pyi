...
def CanOverrideTransform(node, attrName): ...
def FindOverrideParameterTransform(node, path, attrName, time, index: Incomplete | None = ..., editable: bool = ...): ...
...
def GetTransformAttrWithMotionUsingGraphState(param, graphState): ...
...
def SetOverrideTransform(node, path, attrName, time, attrData, index: Incomplete | None = ..., *args, **kwargs): ...
