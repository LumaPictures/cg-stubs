...
class WorkingSetTerminalOpDelegate(TerminalOpDelegate):
    ...
    def appendOp(self, op: PyFnGeolib.GeolibRuntime.Op, txn: PyFnGeolib.GeolibRuntime.Transaction, port: NodegraphAPI.Port | None, graphState: NodegraphAPI.GraphState) -> PyFnGeolib.GeolibRuntime.Op: ...
