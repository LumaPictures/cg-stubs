...
class _LayoutAttributesFactory:
    ...
    def _LayoutAttributesFactory__getBackdropAttributes(self, node: NodegraphAPI.Node, nodeShapeAttrs: dict) -> PyFnAttribute.GroupAttribute: ...
    def _LayoutAttributesFactory__getDotNodeAttributes(self, node: NodegraphAPI.Node, nodeShapeAttrs: dict) -> PyFnAttribute.GroupAttribute: ...
    ...
    def _LayoutAttributesFactory__writeColorAttribute(self, groupBuilder: PyFnAttribute.GroupBuilder, nodeShapeAttrs: dict): ...
    ...
    def _LayoutAttributesFactory__writeInputPorts(self, groupBuilder: PyFnAttribute.GroupBuilder, node: NodegraphAPI.Node): ...
    ...
    def _LayoutAttributesFactory__writePagesAttribute(self, groupBuilder: PyFnAttribute.GroupAttributes, attrsDict: dict): ...
    def _LayoutAttributesFactory__writePublicInterfaceConfigParams(self, groupBuilder: PyFnAttribute.GroupBuilder, node: NodegraphAPI.Node): ...
    ...
    def _LayoutAttributesFactory__writeViewState(self, groupBuilder: PyFnAttribute.GroupBuilder, nodeShapeAttrs: dict): ...
