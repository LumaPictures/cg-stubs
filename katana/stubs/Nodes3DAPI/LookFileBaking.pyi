...
def GetLookFileBakeOp(node: NodegraphAPI.Node, inputPortName: str, graphState: typing.Optional[Nodegraph], txn: FnGeolib.GeolibRuntimeTransaction | None) -> FnGeolib.GeolibRuntimeOp | None: ...
def GetLookFileBakeOps(node: NodegraphAPI.Node, inputPortNames: Sequence[str], graphState: typing.Optional[Nodegraph], txn: Incomplete | None = ...) -> list[FnGeolib.GeolibRuntimeOp | None]: ...
def PostLookFileBake(node: NodegraphAPI.Node | None, assetId: str, rootLocationProducers, progressCallback: Callable | None, abortCallback: Callable | None): ...
def PreLookFileBake(node: NodegraphAPI.Node | None, assetId: str, rootLocationProducers, progressCallback: Callable | None, abortCallback: Callable | None): ...
