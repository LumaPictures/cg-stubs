...
def ReadImageThreaded(filename: str, mipSizeX: int, mipSizeY: int, callback: Callable = ..., tileLocation: Any = ...) -> bool: ...
...
def SetCatalogEventReceiver(callable: Callable) -> None: ...
...
def _Set_GetRenderProducer_Fn(callable: Callable) -> None: ...
def _internalRegisterCommandLineNode(nodeType: str, paramXML: str, ctor: Callable) -> None: ...
