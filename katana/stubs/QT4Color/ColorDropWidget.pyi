...
class ColorDropWidget(PyQt5.QtWidgets.QWidget):
    ...
    def __init__(self, parent, enableFilmlook: bool = ..., enableNoFilmlookColorSpace: bool = ..., enableMinimalMode: bool = ..., hasAlpha: bool = ..., autoMaxHeight: bool = ..., fstopOffset: float = ...): ...
