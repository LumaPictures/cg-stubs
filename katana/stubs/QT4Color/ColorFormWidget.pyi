...
class ColorComponentTabGroup(PyQt5.QtWidgets.QTabWidget):
    ...
    def __init__(self, parent, policy, factory, enableFilmlook: Incomplete | None = ..., enableNoFilmlookColorSpace: Incomplete | None = ..., readOnly: bool = ..., rgbaTab: bool = ..., hslTab: bool = ..., hsvTab: bool = ..., tmlTab: bool = ..., tabToSelect: str = ...): ...
...
def _AddPoliciesToWidget(widget, policies, factory): ...
def _WrapRGBAPolicies(policies): ...