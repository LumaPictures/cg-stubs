...
class HistogramChannel:
    def __init__(self, name, data, count: Incomplete | None = ..., size: Incomplete | None = ..., stats: Incomplete | None = ..., domain: Incomplete | None = ...): ...
...
def _GetMax(data): ...
def _GetMin(data): ...
def _GetNumHorizontalDivisions(width): ...
