...
class FrameBuffer:
    ...
    def copyImageData(self, data: object, rect: List[int[4]], rowBytes: int, numChannels: int) -> None: ...
    def dirtyBufferRects(self, updateRects: sequence, texturePool: dict) -> bool: ...
    ...
    def getTiles(self, clipWindow: List[int[4]], adjustClipWindowForProxyScale: bool = ...) -> list: ...
    ...
    def queryHistogram(self, rect: List[int[4]], binMin: List[float[4]], binMax: List[float[4]], size: int, colorspace: str) -> dict: ...
    def queryRegionStats(self, rect: List[int[4]], ignoreNanInfValues: bool = ..., minInfValue: object = ..., maxInfValue: object = ...) -> dict: ...
...
def ConvertUpdateRectsToFnAttribute(arg0: List[List[int[4]]]) -> PyFnAttribute.IntAttribute: ...
...
def GetExternalRenderListenerInfo() -> object: ...
...
def ReadImage(filename: str, scale: float) -> object: ...
def ReadImageThreaded(filename: str, mipSizeX: int, mipSizeY: int, callback: function = ..., tileLocation: object = ...) -> bool: ...
...
def SetCatalogEventReceiver(callable: function) -> None: ...
...
def TileStitch(xTiles: int, yTiles: int, inputFilenames: List[str], outputImageOptions: str, outputFilename: dict, outputDataRect: List[int[4]], outputDisplayRect: List[int[4]], clampOutput: bool, colorConvert: bool, computeStats: str) -> None: ...
def UnregisterNukeSession(mainSequenceID: int) -> None: ...
def _Register2DFactories() -> None: ...
def _Set_GetRenderProducer_Fn(callable: function) -> None: ...
def _internalRegisterCommandLineNode(nodeType: str, paramXML: str, ctor: function) -> None: ...
def _internalSetFarmPluginManager(farmManagerModule: module) -> None: ...
def fbo_bind(arg0: int) -> None: ...
def fbo_create(arg0: int, arg1: int) -> tuple: ...
def fbo_delete(arg0: int) -> None: ...
def fbo_init() -> None: ...
def fbo_unbind() -> None: ...
def glBatchVertex(vertexSequence: sequence) -> None: ...
def glDrawProjectedLatLongLine(startPt: List[float[3]], endPt: List[float[3]], latLngWidthHeight: List[float[2]], subdivisions: int) -> None: ...
