...
def Parameter_setValue(parm: PyXmlIO.Element, value: Incomplete | None = ..., expression: Incomplete | None = ..., fcurve: Incomplete | None = ..., isexpression: Incomplete | None = ..., autokey: Incomplete | None = ...): ...
...
def _getTypeRecursive(node: PyXmlIO.Element, childType: str) -> list[PyXmlIO.Element]: ...