...
def BuildAttrFromGroupParameter(parameter: Parameter, graphState: Incomplete | None = ..., multisampleDefault: bool = ..., numberAttrTypeDefault: Type[FnAttribute.FloatAttribute] = ..., includeEmptyGroups: bool = ..., groupInherit: bool = ...) -> FnAttribute.GroupAttribute | None: ...
def BuildAttrFromNumberParameter(parameter: Parameter, graphState: Incomplete | None = ..., multisample: bool = ..., attrType: Type[FnAttribute.FloatAttribute] = ...) -> attrType | None: ...
def BuildAttrFromStringParameter(parameter: Parameter, graphState: Incomplete | None = ..., multisample: bool = ...) -> FnAttribute.StringAttribute | None: ...
def BuildDoubleAttrFromNumberParameter(parameter: Parameter, graphState: Incomplete | None = ..., multisample: bool = ...) -> FnAttribute.DoubleAttribute | None: ...
def BuildFloatAttrFromNumberParameter(parameter: Parameter, graphState: Incomplete | None = ..., multisample: bool = ...) -> FnAttribute.FloatAttribute | None: ...
def BuildIntAttrFromNumberParameter(parameter: Parameter, graphState: Incomplete | None = ..., multisample: bool = ...) -> FnAttribute.IntAttribute | None: ...
...
def RegisterPythonNodeFactory(type: str, factory: Callable): ...
