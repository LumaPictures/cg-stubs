...
def CalculateLiveGroupDepth(liveGroupNode: NodegraphAPI.LiveGroupMixin | NodegraphAPI.Node) -> int: ...
...
def LiveGroupEventFilter(eventType: str | None, eventID: object, **kwargs): ...
...
def __node_setBypassed_callback_livegroups(eventType: str | None, eventID: object, node: NodegraphAPI.Node, **kwargs): ...
def __on_node_delete(eventType: str | None, eventID: object, node: NodegraphAPI.Node, oldName: str): ...
def __on_nodegraph_changed(args: list[tuple[str, object, dict]]): ...
def __parameter_finalizeValue_callback_livegroups(eventType: str | None, eventID: object, param: NodegraphAPI.Parameter, **kwargs): ...
