...
RTLD_NOW: int
__default_graph: str
_loadingEventDepth: int
useFlags: bool

def CheckNodeType(node, stringOrClassTypes): ...
...
def _GetRootParameter(paramName): ...
def _KatanaModifiedHeader(element, compress, archive): ...
def _LoadBegin(*args, **kwargs): ...
def _LoadEnd(*args, **kwargs): ...
def _LoadXmlFromStream(stream): ...
def _WriteKatanaStream(stream: io.IOBase, element: PyXmlIO.Element, compress: bool, archive: bool, opaqueParams: dict | None): ...
def __nodegraph_setCurrentTime_callback(eventType, eventID, **kwargs): ...
def __parameter_finalizeValue_callback(eventType, eventID, param, **kwargs): ...
