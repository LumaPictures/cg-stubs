...
class node_addInputPort_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, portName, portIndex): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_addOutputPort_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, portName, portIndex): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_create_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, nodeType): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_delete_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, nodeParentName, xmlElement, locked): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_paste_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeNames, nodeParentName, xmlElement): ...
    def redo(self): ...
    def undo(self): ...

class node_removeInputPort_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, portName, portIndex, portMetadata, portTags): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_removeOutputPort_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, portName, portIndex, portMetadata, portTags): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_renameInputPort_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, oldPortName, newPortName): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_renameOutputPort_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, oldPortName, newPortName): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setAutoRenameAllowed_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, value): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setBypassRouting_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, oldVal, newVal): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setBypassed_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, bypassValue): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setName_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, undoName, redoName): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setParent_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, undoParentName, redoParentName): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setPosition_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, oldPosition, newPosition): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setThumbnailEnabled_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, newValue, oldValue): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_setType_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, nodeName, oldType, newType): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class node_shapeAttrsChanged_UndoEntry(UndoStack.UndoEntry):
...
class parameter_createChild_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterFullName, element, index): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class parameter_deleteChild_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterFullName, element, childName, index): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class parameter_floatVector_setValue_UndoEntry(UndoStack.UndoEntry):
...
class parameter_reorderChild_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterFullName, oldIndex, newIndex): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class parameter_reorderChildren_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterFullName, oldIndex, newIndex, count): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class parameter_reparentAtomic_UndoEntry(UndoStack.UndoEntry):
...
class parameter_replaceXML_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterFullName, undoXML, redoXML): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class parameter_setName_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterParentFullName, undoName, redoName): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class parameter_setValue_UndoEntry(UndoStack.UndoEntry):
    def __init__(self, parameterFullName, undoXML, redoXML): ...
    def getName(self): ...
    def redo(self): ...
    def undo(self): ...

class port_connect_UndoEntry(UndoStack.UndoEntry):
...
class port_disconnect_UndoEntry(UndoStack.UndoEntry):
...
class port_metadataUpdated_UndoEntry(UndoStack.UndoEntry):
...
class port_setTags_UndoEntry(UndoStack.UndoEntry):
...
class roto_event_UndoEntry(UndoStack.UndoEntry):
