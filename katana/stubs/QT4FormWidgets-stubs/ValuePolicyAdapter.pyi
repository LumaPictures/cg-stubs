...
class ValuePolicyAdapter(ValuePolicy.AbstractValuePolicy):
    def __init__(self, alias, policyMap, parent: Incomplete | None = ...): ...
...
class ValuePolicyAlias(ValuePolicy.AbstractValuePolicy):
    def __init__(self, alias, valuePolicy, parent: Incomplete | None = ...): ...
