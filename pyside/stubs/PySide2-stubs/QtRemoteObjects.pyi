...
class QRemoteObjectRegistry(QRemoteObjectReplica):
    ...
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    @classmethod
    def __init__(cls, *args, destroyed: typing.Callable = ..., initialized: typing.Callable = ..., node: typing.Any = ..., notified: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., remoteObjectAdded: typing.Callable = ..., remoteObjectRemoved: typing.Callable = ..., sourceLocations: dict[str, QRemoteObjectSourceLocationInfo] = ..., state: QRemoteObjectRegistry.State = ..., stateChanged: typing.Callable = ..., **kwargs) -> None: ...
