...
class QAccessible(shiboken2.Object):
    ...
    def isActive() -> bool: ...
    @staticmethod
    def qAccessibleTextBoundaryHelper(cursor: QTextCursor, boundaryType: QAccessible.TextBoundaryType) -> typing.Tuple[int, int]: ...
    @staticmethod
...
class QAccessibleInterface(shiboken2.Object):
    ...
    def relations(self, match: QAccessible.Relation | QAccessible.RelationFlag = ...) -> typing.List[typing.Tuple[QAccessibleInterface, QAccessible.Relation]]: ...
...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def convertToFormat(self, f: QImage.Format, colorTable: typing.List[int], flags: PySide2.QtCore.Qt.ImageConversionFlags | PySide2.QtCore.Qt.ImageConversionFlag = ...) -> QImage: ...
    @typing.overload
...
class QImageReader(shiboken2.Object):
    ...
    @staticmethod
    def imageFormatsForMimeType(mimeType: PySide2.QtCore.QByteArray | bytes) -> typing.List[PySide2.QtCore.QByteArray]: ...
    def jumpToImage(self, imageNumber: int) -> bool: ...
    def jumpToNextImage(self) -> bool: ...
    def loopCount(self) -> int: ...
    def nextImageDelay(self) -> int: ...
...
class QKeySequence(shiboken2.Object):
    ...
    @typing.overload
    def __init__(self, ks: QKeySequence | QKeySequence.StandardKey | str | int) -> None: ...
    @typing.overload
    ...
    def matches(self, seq: QKeySequence | QKeySequence.StandardKey | str | int) -> QKeySequence.SequenceMatch: ...
    @staticmethod
    def mnemonic(text: str) -> QKeySequence: ...
    def swap(self, other: QKeySequence | QKeySequence.StandardKey | str | int) -> None: ...
...
class QOpenGLDebugLogger(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def disableMessages(self, ids: typing.List[int], sources: QOpenGLDebugMessage.Sources | QOpenGLDebugMessage.Source = ..., types: QOpenGLDebugMessage.Types | QOpenGLDebugMessage.Type = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def enableMessages(self, ids: typing.List[int], sources: QOpenGLDebugMessage.Sources | QOpenGLDebugMessage.Source = ..., types: QOpenGLDebugMessage.Types | QOpenGLDebugMessage.Type = ...) -> None: ...
...
class QOpenGLShaderProgram(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def addCacheableShaderFromSourceCode(self, type: QOpenGLShader.ShaderType | QOpenGLShader.ShaderTypeBit, source: bytes) -> bool: ...
    ...
    @typing.overload
    def addShaderFromSourceCode(self, type: QOpenGLShader.ShaderType | QOpenGLShader.ShaderTypeBit, source: bytes) -> bool: ...
...
class QPaintDeviceWindow(QWindow, QPaintDevice):
    staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
    @classmethod
    def __init__(cls, *args, active: bool = ..., activeChanged: typing.Callable = ..., contentOrientation: PySide2.QtCore.Qt.ScreenOrientation = ..., contentOrientationChanged: typing.Callable = ..., destroyed: typing.Callable = ..., flags: PySide2.QtCore.Qt.WindowFlags | PySide2.QtCore.Qt.WindowType = ..., focusObjectChanged: typing.Callable = ..., height: int = ..., heightChanged: typing.Callable = ..., maximumHeight: int = ..., maximumHeightChanged: typing.Callable = ..., maximumWidth: int = ..., maximumWidthChanged: typing.Callable = ..., minimumHeight: int = ..., minimumHeightChanged: typing.Callable = ..., minimumWidth: int = ..., minimumWidthChanged: typing.Callable = ..., modality: PySide2.QtCore.Qt.WindowModality = ..., modalityChanged: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., opacity: float = ..., opacityChanged: typing.Callable = ..., screenChanged: typing.Callable = ..., title: str = ..., transientParent: typing.Any = ..., transientParentChanged: typing.Callable = ..., visibility: QPaintDeviceWindow.Visibility = ..., visibilityChanged: typing.Callable = ..., visible: bool = ..., visibleChanged: typing.Callable = ..., width: int = ..., widthChanged: typing.Callable = ..., windowStateChanged: typing.Callable = ..., windowTitleChanged: typing.Callable = ..., x: int = ..., xChanged: typing.Callable = ..., y: int = ..., yChanged: typing.Callable = ..., **kwargs) -> None: ...
...
class QPolygon(shiboken2.Object):
    ...
    @staticmethod
    def fromList(list: typing.Iterable[PySide2.QtCore.QPoint]) -> typing.List[PySide2.QtCore.QPoint]: ...
...
class QPolygonF(shiboken2.Object):
    ...
    @staticmethod
    def fromList(list: typing.Iterable[PySide2.QtCore.QPointF]) -> typing.List[PySide2.QtCore.QPointF]: ...
...
class QRawFont(shiboken2.Object):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def advancesForGlyphIndexes(self, glyphIndexes: typing.List[int], layoutFlags: QRawFont.LayoutFlags | QRawFont.LayoutFlag) -> typing.List[PySide2.QtCore.QPointF]: ...
    @typing.overload
...
class QScreen(PySide2.QtCore.QObject):
    ...
    @classmethod
    def __init__(cls, *args, availableGeometry: PySide2.QtCore.QRect = ..., availableGeometryChanged: typing.Callable = ..., availableSize: PySide2.QtCore.QSize = ..., availableVirtualGeometry: PySide2.QtCore.QRect = ..., availableVirtualSize: PySide2.QtCore.QSize = ..., depth: int = ..., destroyed: typing.Callable = ..., devicePixelRatio: float = ..., geometry: PySide2.QtCore.QRect = ..., geometryChanged: typing.Callable = ..., logicalDotsPerInch: float = ..., logicalDotsPerInchChanged: typing.Callable = ..., logicalDotsPerInchX: float = ..., logicalDotsPerInchY: float = ..., manufacturer: str = ..., model: str = ..., name: str = ..., nativeOrientation: PySide2.QtCore.Qt.ScreenOrientation = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., orientation: PySide2.QtCore.Qt.ScreenOrientation = ..., orientationChanged: typing.Callable = ..., physicalDotsPerInch: float = ..., physicalDotsPerInchChanged: typing.Callable = ..., physicalDotsPerInchX: float = ..., physicalDotsPerInchY: float = ..., physicalSize: PySide2.QtCore.QSizeF = ..., physicalSizeChanged: typing.Callable = ..., primaryOrientation: PySide2.QtCore.Qt.ScreenOrientation = ..., primaryOrientationChanged: typing.Callable = ..., refreshRate: float = ..., refreshRateChanged: typing.Callable = ..., serialNumber: str = ..., size: PySide2.QtCore.QSize = ..., virtualGeometry: PySide2.QtCore.QRect = ..., virtualGeometryChanged: typing.Callable = ..., virtualSize: PySide2.QtCore.QSize = ..., **kwargs) -> None: ...
...
class QShortcutEvent(PySide2.QtCore.QEvent):
    def __init__(self, key: QKeySequence | QKeySequence.StandardKey | str | int, id: int, ambiguous: bool = ...) -> None: ...
...
class QStandardItemModel(PySide2.QtCore.QAbstractItemModel):
    ...
    def findItems(self, text: str, flags: PySide2.QtCore.Qt.MatchFlags | PySide2.QtCore.Qt.MatchFlag = ..., column: int = ...) -> typing.List[QStandardItem]: ...
...
class QTransform(shiboken2.Object):
    ...
    @typing.overload
    @staticmethod
    def quadToQuad(arg__1: QPolygonF, arg__2: QPolygonF) -> object: ...
    @typing.overload
    @staticmethod
    def quadToSquare(quad: QPolygonF, result: QTransform) -> bool: ...
    @typing.overload
    @staticmethod
    def quadToSquare(arg__1: QPolygonF) -> object: ...
    def reset(self) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def squareToQuad(arg__1: QPolygonF) -> object: ...
    def toAffine(self) -> QMatrix: ...
...
class QWindow(PySide2.QtCore.QObject, QSurface):
    ...
    def nativeEvent(self, eventType: PySide2.QtCore.QByteArray | bytes, message: int) -> typing.Tuple[bool, int]: ...
    def opacity(self) -> float: ...
    @typing.overload
