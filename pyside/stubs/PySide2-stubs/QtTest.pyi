...
class QTest(shiboken2.Object):
    ...
    @typing.overload
    @staticmethod
    def keySequence(window: PySide2.QtGui.QWindow, keySequence: PySide2.QtGui.QKeySequence | PySide2.QtGui.QKeySequence.StandardKey | str | int) -> None: ...
    @typing.overload
    @staticmethod
    def keySequence(widget: PySide2.QtWidgets.QWidget, keySequence: PySide2.QtGui.QKeySequence | PySide2.QtGui.QKeySequence.StandardKey | str | int) -> None: ...
    @staticmethod
