...
class Qt3DInput(shiboken2.Object):
    ...
    class QActionInput(Qt3DInput.QAbstractActionInput):
        ...
        sourceDeviceChanged: typing.ClassVar[PySide2.QtCore.Signal] = ...
        staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
        def __init__(self, parent: PySide2.Qt3DCore.Qt3DCore.QNode | None = ..., buttons: typing.List[int] = ..., buttonsChanged: typing.Callable = ..., defaultPropertyTrackingMode: Qt3DInput.QActionInput.PropertyTrackingMode = ..., defaultPropertyTrackingModeChanged: typing.Callable = ..., destroyed: typing.Callable = ..., enabled: bool = ..., enabledChanged: typing.Callable = ..., nodeDestroyed: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., parentChanged: typing.Callable = ..., sourceDevice: Qt3DInput.QAbstractPhysicalDevice = ..., sourceDeviceChanged: typing.Callable = ...) -> None: ...
    ...
    class QAxisSetting(PySide2.Qt3DCore.Qt3DCore.QNode):
        ...
        staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
        def __init__(self, parent: PySide2.Qt3DCore.Qt3DCore.QNode | None = ..., axes: typing.List[int] = ..., axesChanged: typing.Callable = ..., deadZoneRadius: float = ..., deadZoneRadiusChanged: typing.Callable = ..., defaultPropertyTrackingMode: Qt3DInput.QAxisSetting.PropertyTrackingMode = ..., defaultPropertyTrackingModeChanged: typing.Callable = ..., destroyed: typing.Callable = ..., enabled: bool = ..., enabledChanged: typing.Callable = ..., nodeDestroyed: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., parentChanged: typing.Callable = ..., smooth: bool = ..., smoothChanged: typing.Callable = ...) -> None: ...
    ...
    class QMouseEvent(PySide2.QtCore.QObject):
        ...
        staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
        @classmethod
        def __init__(cls, *args, accepted: bool = ..., button: typing.Any = ..., buttons: int = ..., destroyed: typing.Callable = ..., modifiers: typing.Any = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., wasHeld: bool = ..., x: int = ..., y: int = ..., **kwargs) -> None: ...
    ...
    class QWheelEvent(PySide2.QtCore.QObject):
        ...
        staticMetaObject: typing.ClassVar[PySide2.QtCore.QMetaObject] = ...
        @classmethod
        def __init__(cls, *args, accepted: bool = ..., angleDelta: PySide2.QtCore.QPoint = ..., buttons: int = ..., destroyed: typing.Callable = ..., modifiers: typing.Any = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., x: int = ..., y: int = ..., **kwargs) -> None: ...
