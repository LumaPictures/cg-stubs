...
class QGeoRouteRequest(shiboken2.Object):
    ...
    def setDepartureTime(self, departureTime: typing.Union[PySide2.QtCore.QDateTime, datetime.datetime]) -> None: ...
...
class QPlaceReview(QPlaceContent):
    ...
    def setDateTime(self, dt: typing.Union[PySide2.QtCore.QDateTime, datetime.datetime]) -> None: ...
    def setLanguage(self, data: str) -> None: ...
