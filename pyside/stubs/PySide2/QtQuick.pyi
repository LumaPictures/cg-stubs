...
class QQuickPaintedItem(QQuickItem):
    ...
    def setFillColor(self, arg__1: typing.Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QSGSimpleRectNode(QSGGeometryNode):
    @typing.overload
    def __init__(self, rect: PySide2.QtCore.QRectF, color: typing.Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, int]) -> None: ...
    @typing.overload
    def __init__(self) -> None: ...
    def color(self) -> PySide2.QtGui.QColor: ...
