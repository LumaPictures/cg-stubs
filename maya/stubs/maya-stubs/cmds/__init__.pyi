...
def mayaDpiSetting(*args, mode: int = ..., query: bool | int = ..., realScaleValue: bool | int = ..., scaleValue: bool | int | float = ..., systemDpi: bool | int = ...) -> Any: ...
