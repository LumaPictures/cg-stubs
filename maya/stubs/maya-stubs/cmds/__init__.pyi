...
def listConnections(*args, connections: bool | int = ..., destination: bool | int = ..., exactType: bool | int = ..., fullNodeName: bool | int = ..., plugs: bool | int = ..., shapes: bool | int = ..., skipConversionNodes: bool | int = ..., source: bool | int = ..., type: str = ...) -> list[str]: ...
...
def menu(*args, allowOptionBoxes: bool | int = ..., defineTemplate: str = ..., deleteAllItems: bool | int = ..., docTag: bool | int | str = ..., edit: bool | int = ..., enable: bool | int = ..., exists: bool | int = ..., familyImage: bool | int | str = ..., helpMenu: bool | int = ..., itemArray: bool | int = ..., label: bool | int | str = ..., mnemonic: bool | int | str = ..., numberOfItems: bool | int = ..., parent: str = ..., postMenuCommand: str | Callable = ..., postMenuCommandOnce: bool | int = ..., query: bool | int = ..., scrollable: bool | int = ..., tearOff: bool | int = ..., useTemplate: str = ..., version: bool | int | str = ..., visible: bool | int = ...) -> Any: ...
