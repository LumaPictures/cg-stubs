...
def listAttr(*args, array: bool | int = ..., caching: bool | int = ..., category: str | list[str] = ..., changedSinceFileOpen: bool | int = ..., channelBox: bool | int = ..., connectable: bool | int = ..., extension: bool | int = ..., fromPlugin: bool | int = ..., hasData: bool | int = ..., hasNullData: bool | int = ..., inUse: bool | int = ..., keyable: bool | int = ..., leaf: bool | int = ..., locked: bool | int = ..., multi: bool | int = ..., output: bool | int = ..., ramp: bool | int = ..., read: bool | int = ..., readOnly: bool | int = ..., scalar: bool | int = ..., scalarAndArray: bool | int = ..., settable: bool | int = ..., shortNames: bool | int = ..., string: str | list[str] = ..., unlocked: bool | int = ..., usedAsFilename: bool | int = ..., userDefined: bool | int = ..., visible: bool | int = ..., write: bool | int = ...) -> list[str]: ...
def listAttrPatterns(*args, patternType: bool | int = ..., verbose: bool | int = ...) -> list[str]: ...
def listCameras(*args, orthographic: bool | int = ..., perspective: bool | int = ..., ufeCameras: bool | int = ...) -> list[str]: ...
def listConnections(*args, connections: bool | int = ..., destination: bool | int = ..., exactType: bool | int = ..., plugs: bool | int = ..., shapes: bool | int = ..., skipConversionNodes: bool | int = ..., source: bool | int = ..., type: str = ...) -> list[str]: ...
def listDeviceAttachments(*args, attribute: str = ..., axis: str = ..., clutch: str = ..., device: str = ..., file: str = ..., selection: bool | int = ..., write: bool | int = ...) -> list[str]: ...
def listHistory(*args, allConnections: bool | int = ..., allFuture: bool | int = ..., allGraphs: bool | int = ..., breadthFirst: bool | int = ..., fastIteration: bool | int = ..., future: bool | int = ..., futureLocalAttr: bool | int = ..., futureWorldAttr: bool | int = ..., groupLevels: bool | int = ..., historyAttr: bool | int = ..., interestLevel: int = ..., leaf: bool | int = ..., levels: int = ..., pruneDagObjects: bool | int = ..., query: bool | int = ...) -> list[str]: ...
def listInputDeviceAxes(*args) -> list[str]: ...
def listInputDeviceButtons(*args) -> list[str]: ...
def listInputDevices(*args, free: bool | int = ..., primary: bool | int = ..., secondary: bool | int = ...) -> list[str]: ...
def listNodeTypes(*args, exclude: str = ...) -> list[str]: ...
def listNodesWithIncorrectNames(*args) -> list[str]: ...
def listRelatives(*args, allDescendents: bool | int = ..., allParents: bool | int = ..., children: bool | int = ..., fullPath: bool | int = ..., noIntermediate: bool | int = ..., parent: bool | int = ..., path: bool | int = ..., shapes: bool | int = ..., type: str | list[str] = ...) -> list[str]: ...
def listSets(*args, allSets: bool | int = ..., extendToShape: bool | int = ..., object: str = ..., type: int = ...) -> list[str]: ...
