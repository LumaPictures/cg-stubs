...
def GhostSelected(*args, **keywords): ...
...
def OpenGhostEditor(*args, **keywords): ...
...
def ToggleCutView(*args, **keywords): ...
...
def UnghostSelected(*args, **keywords): ...
...
def animLayer(*args, addRelatedKG: bool | int = ..., addSelectedObjects: bool | int = ..., affectedLayers: bool | int = ..., animCurves: bool | int = ..., attribute: bool | int | str | list[str] = ..., baseAnimCurves: bool | int = ..., bestAnimLayer: bool | int = ..., bestLayer: bool | int = ..., blendNodes: bool | int = ..., children: bool | int | str = ..., collapse: bool | int = ..., copy: str = ..., copyAnimation: str = ..., copyNoAnimation: str = ..., edit: bool | int = ..., excludeBoolean: bool | int = ..., excludeDynamic: bool | int = ..., excludeEnum: bool | int = ..., excludeRotate: bool | int = ..., excludeScale: bool | int = ..., excludeTranslate: bool | int = ..., excludeVisibility: bool | int = ..., exists: bool | int = ..., extractAnimation: str = ..., findCurveForPlug: bool | int | str = ..., forceUIRebuild: bool | int = ..., forceUIRefresh: bool | int = ..., layeredPlug: bool | int | str = ..., lock: bool | int = ..., maxLayers: bool | int = ..., moveLayerAfter: str = ..., moveLayerBefore: str = ..., mute: bool | int = ..., override: bool | int = ..., parent: bool | int | str = ..., passthrough: bool | int = ..., preferred: bool | int = ..., query: bool | int = ..., removeAllAttributes: bool | int = ..., removeAttribute: str | list[str] = ..., root: bool | int | str = ..., selected: bool | int = ..., solo: bool | int = ..., weight: bool | int | float = ..., writeBlendnodeDestinations: bool | int = ...) -> Any: ...
...
def appHome(*args, edit: bool | int = ..., query: bool | int = ..., visible: bool | int = ...) -> Any: ...
...
def bakeDeformer(*args, colorizeSkeleton: bool | int = ..., customRangeOfMotion: str | tuple[float, float] | tuple[float] = ..., dstMeshName: str = ..., dstSkeletonName: str = ..., hierarchy: bool | int = ..., influences: str = ..., maxInfluences: int = ..., pruneWeights: float = ..., smoothWeights: int = ..., srcMeshName: str = ..., srcSkeletonName: str = ...) -> Any: ...
...
def blendShape(*args, after: bool | int = ..., afterReference: bool | int = ..., automatic: bool | int = ..., before: bool | int = ..., copyDelta: tuple[int, int, int] = ..., copyInBetweenDelta: tuple[int, int, int, int] = ..., deformerTools: bool | int = ..., edit: bool | int = ..., envelope: bool | int | float = ..., exclusive: bool | int | str = ..., export: str = ..., exportTarget: tuple[int, int] | list[tuple[int, int]] = ..., flipTarget: tuple[int, int] | list[tuple[int, int]] = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., inBetween: bool | int = ..., inBetweenIndex: int = ..., inBetweenType: str = ..., includeHiddenSelections: bool | int = ..., ip: str = ..., mergeSource: int | list[int] = ..., mergeTarget: int = ..., mirrorDirection: int = ..., mirrorTarget: tuple[int, int] | list[tuple[int, int]] = ..., name: str = ..., normalizationGroups: bool | int = ..., origin: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., resetTargetDelta: tuple[int, int] | list[tuple[int, int]] = ..., split: bool | int = ..., suppressDialog: bool | int = ..., symmetryAxis: bool | int | str = ..., symmetryEdge: bool | int | str | list[str] = ..., symmetrySpace: int = ..., tangentSpace: bool | int = ..., target: bool | int | tuple[str, int, str, float] | list[tuple[str, int, str, float]] = ..., topologyCheck: bool | int = ..., transform: bool | int | str = ..., useComponentTags: bool | int = ..., weight: bool | int | tuple[int, float] | list[tuple[int, float]] = ..., weightCount: int = ...) -> Any: ...
...
def boneLattice(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., bicep: bool | int | float = ..., deformerTools: bool | int = ..., edit: bool | int = ..., exclusive: bool | int | str = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., joint: bool | int | str = ..., lengthIn: bool | int | float = ..., lengthOut: bool | int | float = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., split: bool | int = ..., transform: str = ..., tricep: bool | int | float = ..., useComponentTags: bool | int = ..., widthLeft: bool | int | float = ..., widthRight: bool | int | float = ...) -> Any: ...
...
def colorIndex(*args, hueSaturationValue: bool | int = ..., query: bool | int = ..., resetToFactory: bool | int = ..., resetToSaved: bool | int = ...) -> Any: ...
...
def connectAttr(*args, force: bool | int = ..., lock: bool | int = ..., nextAvailable: bool | int = ..., referenceDest: str = ...) -> Any: ...
...
def connectionInfo(*args, destinationFromSource: bool | int = ..., getExactDestination: bool | int = ..., getExactSource: bool | int = ..., getLockedAncestor: bool | int = ..., isDestination: bool | int = ..., isExactDestination: bool | int = ..., isExactSource: bool | int = ..., isLocked: bool | int = ..., isSource: bool | int = ..., sourceFromDestination: bool | int = ...) -> Any: ...
...
def copySkinWeights(*args, destinationSkin: bool | int | str = ..., edit: bool | int = ..., influenceAssociation: bool | int | str | list[str] = ..., mirrorInverse: bool | int = ..., mirrorMode: bool | int | str = ..., noBlendWeight: bool | int = ..., noMirror: bool | int = ..., normalize: bool | int = ..., query: bool | int = ..., sampleSpace: int = ..., smooth: bool | int = ..., sourceSkin: bool | int | str = ..., surfaceAssociation: bool | int | str = ..., uvSpace: bool | int | tuple[str, str] = ...) -> Any: ...
def crashInfo(*args, crashFile: bool | int = ..., query: bool | int = ..., savedBeforeCrash: bool | int = ...) -> Any: ...
...
def createNode(*args, name: str = ..., parent: str = ..., shared: bool | int = ..., skipSelect: bool | int = ...) -> Any: ...
...
def dbtrace(*args, filter: bool | int | str = ..., info: bool | int = ..., keyword: bool | int | str | list[str] = ..., mark: bool | int = ..., off: Any = ..., output: bool | int | str = ..., query: bool | int = ..., timed: bool | int = ..., title: str = ..., verbose: bool | int = ...) -> Any: ...
def debug(*args) -> Any: ...
...
def deformableShape(*args, chain: bool | int = ..., createOriginalGeometry: bool | int = ..., createTweakNode: bool | int = ..., createUpstreamTagInjectionNode: bool | int = ..., frontOfChain: bool | int = ..., localShapeInAttr: bool | int = ..., localShapeOutAttr: bool | int = ..., nodeChain: bool | int = ..., originalGeometry: bool | int = ..., outputPlugChain: bool | int = ..., plugChain: bool | int = ..., tagInjectionList: bool | int = ..., tagInjectionNode: bool | int = ..., tweakNode: bool | int = ..., upstreamTagInjectionNode: bool | int = ..., worldShapeOutAttr: bool | int = ...) -> Any: ...
def deformer(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., deformerTools: bool | int = ..., edit: bool | int = ..., exclusive: bool | int | str = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., split: bool | int = ..., type: str = ..., useComponentTags: bool | int = ...) -> Any: ...
...
def deltaMush(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., deformerTools: bool | int = ..., edit: bool | int = ..., envelope: bool | int | float = ..., exclusive: bool | int | str = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., inwardConstraint: bool | int | float = ..., name: str = ..., outwardConstraint: bool | int | float = ..., parallel: bool | int = ..., pinBorderVertices: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., smoothingIterations: int = ..., smoothingStep: bool | int | float = ..., split: bool | int = ..., useComponentTags: bool | int = ...) -> Any: ...
...
def disconnectAttr(*args, nextAvailable: bool | int = ...) -> Any: ...
...
def displayRGBColor(*args, create: bool | int = ..., hueSaturationValue: bool | int = ..., list: bool | int = ..., query: bool | int = ..., resetToFactory: bool | int = ..., resetToSaved: bool | int = ...) -> Any: ...
...
def dopeSheetEditor(*args, autoFit: bool | int | str = ..., autoFitTime: bool | int | str = ..., control: bool | int = ..., defineTemplate: str = ..., displayActiveKeyTangents: str = ..., displayActiveKeys: str = ..., displayInfinities: str = ..., displayKeys: str = ..., displayTangents: str = ..., displayValues: str = ..., docTag: bool | int | str = ..., edit: bool | int = ..., exists: bool | int = ..., filter: bool | int | str = ..., forceMainConnection: bool | int | str = ..., hierarchyBelow: bool | int = ..., highlightConnection: bool | int | str = ..., lockMainConnection: bool | int = ..., lookAt: str = ..., mainListConnection: bool | int | str = ..., outliner: bool | int | str = ..., panel: bool | int | str = ..., parent: bool | int | str = ..., query: bool | int = ..., selectionConnection: bool | int | str = ..., selectionWindow: bool | int | tuple[float, float, float, float] = ..., showScene: bool | int = ..., showSummary: bool | int = ..., showTicks: bool | int = ..., snapTime: bool | int | str = ..., snapValue: bool | int | str = ..., stateString: bool | int = ..., unParent: bool | int = ..., unlockMainConnection: bool | int = ..., updateMainConnection: bool | int = ..., useTemplate: str = ...) -> Any: ...
...
def editDisplayLayerMembers(*args, fullNames: bool | int = ..., noRecurse: bool | int = ..., query: bool | int = ...) -> Any: ...
...
def editorTemplate(*args, addAdskAssetControls: bool | int = ..., addComponents: bool | int = ..., addControl: tuple[str, str | Callable] = ..., addDynamicControl: tuple[str, str | Callable] = ..., addExtraControls: bool | int = ..., addSeparator: bool | int = ..., annotateFieldOnly: bool | int = ..., annotation: str = ..., beginLayout: str = ..., beginNoOptimize: bool | int = ..., beginScrollLayout: bool | int = ..., callCustom: tuple[str | Callable, str | Callable] = ..., collapse: bool | int = ..., debugMode: bool | int = ..., dimControl: tuple[str, str, bool | int] = ..., endLayout: bool | int = ..., endNoOptimize: bool | int = ..., endScrollLayout: bool | int = ..., extraControlsLabel: str = ..., interruptOptimize: bool | int = ..., label: str = ..., listExtraAttributes: str = ..., preventOverride: bool | int = ..., queryControl: tuple[str, str] = ..., queryLabel: tuple[str, str] = ..., queryName: tuple[str, str] = ..., removeControl: tuple[str, str] = ..., suppress: str = ...) -> Any: ...
...
def getAttr(*args, asString: bool | int = ..., caching: bool | int = ..., channelBox: bool | int = ..., expandEnvironmentVariables: bool | int = ..., keyable: bool | int = ..., lock: bool | int = ..., multiIndices: bool | int = ..., settable: bool | int = ..., silent: bool | int = ..., size: bool | int = ..., time: int | float = ..., type: bool | int = ...) -> Any: ...
...
def grabColor(*args, hsvValue: bool | int = ..., rgbValue: bool | int = ...) -> Any: ...
def gradientControl(*args, adaptiveScaling: bool | int = ..., annotation: bool | int | str = ..., attribute: str = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., defineTemplate: str = ..., docTag: bool | int | str = ..., dragCallback: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., exists: bool | int = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., isObscured: bool | int = ..., manage: bool | int = ..., noBackground: bool | int = ..., numberOfControls: int = ..., numberOfPopupMenus: bool | int = ..., parent: bool | int | str = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., refreshOnRelease: int = ..., selectedColorControl: str = ..., selectedInterpControl: str = ..., selectedPositionControl: str = ..., staticNumberOfControls: bool | int = ..., staticPositions: bool | int = ..., statusBarMessage: str = ..., upperLimitControl: bool | int | str = ..., useTemplate: str = ..., verticalLayout: bool | int = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., width: int = ...) -> Any: ...
def gradientControlNoAttr(*args, annotation: bool | int | str = ..., asString: bool | int | str = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., changeCommand: str | Callable = ..., currentKey: int = ..., currentKeyChanged: str | Callable = ..., currentKeyColorValue: bool | int | tuple[float, float, float] = ..., currentKeyCurveValue: bool | int = ..., currentKeyInterpValue: int = ..., defineTemplate: str = ..., docTag: bool | int | str = ..., dragCallback: str | Callable = ..., dragCommand: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., exists: bool | int = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., isObscured: bool | int = ..., manage: bool | int = ..., noBackground: bool | int = ..., numberOfPopupMenus: bool | int = ..., optionVar: bool | int | str = ..., parent: bool | int | str = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., rampAsColor: bool | int = ..., statusBarMessage: str = ..., useTemplate: str = ..., valueAtPoint: bool | int | float = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., width: int = ...) -> Any: ...
...
def internalVar(*args, userAppDir: bool | int = ..., userBitmapsDir: bool | int = ..., userHotkeyDir: bool | int = ..., userMarkingMenuDir: bool | int = ..., userPrefDir: bool | int = ..., userPresetsDir: bool | int = ..., userScriptDir: bool | int = ..., userShelfDir: bool | int = ..., userTmpDir: bool | int = ..., userWorkspaceDir: bool | int = ...) -> Any: ...
...
def layoutDialog(*args, backgroundColor: tuple[float, float, float] = ..., dismiss: str = ..., parent: str = ..., title: str = ..., uiScript: str | Callable = ...) -> Any: ...
...
def listAnimatable(*args, active: bool | int = ..., manip: bool | int = ..., manipHandle: bool | int = ..., shape: bool | int = ..., type: bool | int = ...) -> Any: ...
def listAttr(*args, array: bool | int = ..., caching: bool | int = ..., category: str | list[str] = ..., changedSinceFileOpen: bool | int = ..., channelBox: bool | int = ..., connectable: bool | int = ..., extension: bool | int = ..., fromPlugin: bool | int = ..., hasData: bool | int = ..., hasNullData: bool | int = ..., inUse: bool | int = ..., keyable: bool | int = ..., leaf: bool | int = ..., locked: bool | int = ..., multi: bool | int = ..., output: bool | int = ..., ramp: bool | int = ..., read: bool | int = ..., readOnly: bool | int = ..., scalar: bool | int = ..., scalarAndArray: bool | int = ..., settable: bool | int = ..., shortNames: bool | int = ..., string: str | list[str] = ..., unlocked: bool | int = ..., usedAsFilename: bool | int = ..., userDefined: bool | int = ..., visible: bool | int = ..., write: bool | int = ...) -> Any: ...
def listAttrPatterns(*args, patternType: bool | int = ..., verbose: bool | int = ...) -> Any: ...
def listCameras(*args, orthographic: bool | int = ..., perspective: bool | int = ..., ufeCameras: bool | int = ...) -> Any: ...
def listConnections(*args, connections: bool | int = ..., destination: bool | int = ..., exactType: bool | int = ..., plugs: bool | int = ..., shapes: bool | int = ..., skipConversionNodes: bool | int = ..., source: bool | int = ..., type: str = ...) -> Any: ...
def listDeviceAttachments(*args, attribute: str = ..., axis: str = ..., clutch: str = ..., device: str = ..., file: str = ..., selection: bool | int = ..., write: bool | int = ...) -> Any: ...
def listHistory(*args, allConnections: bool | int = ..., allFuture: bool | int = ..., allGraphs: bool | int = ..., breadthFirst: bool | int = ..., fastIteration: bool | int = ..., future: bool | int = ..., futureLocalAttr: bool | int = ..., futureWorldAttr: bool | int = ..., groupLevels: bool | int = ..., historyAttr: bool | int = ..., interestLevel: int = ..., leaf: bool | int = ..., levels: int = ..., pruneDagObjects: bool | int = ..., query: bool | int = ...) -> Any: ...
def listInputDeviceAxes(*args) -> Any: ...
def listInputDeviceButtons(*args) -> Any: ...
def listInputDevices(*args, free: bool | int = ..., primary: bool | int = ..., secondary: bool | int = ...) -> Any: ...
def listNodeTypes(*args, exclude: str = ...) -> Any: ...
def listNodesWithIncorrectNames(*args) -> Any: ...
def listRelatives(*args, allDescendents: bool | int = ..., allParents: bool | int = ..., children: bool | int = ..., fullPath: bool | int = ..., noIntermediate: bool | int = ..., parent: bool | int = ..., path: bool | int = ..., shapes: bool | int = ..., type: str | list[str] = ...) -> Any: ...
def listSets(*args, allSets: bool | int = ..., extendToShape: bool | int = ..., object: str = ..., type: int = ...) -> Any: ...
...
def loadPlugin(*args, addCallback: str | Callable = ..., allPlugins: bool | int = ..., name: str = ..., qObsolete: bool | int = ..., quiet: bool | int = ..., removeCallback: str | Callable = ...) -> Any: ...
...
def makeLive(*args, none: bool | int = ...) -> Any: ...
...
def menu(*args, allowOptionBoxes: bool | int = ..., defineTemplate: str = ..., deleteAllItems: bool | int = ..., docTag: bool | int | str = ..., edit: bool | int = ..., enable: bool | int = ..., exists: bool | int = ..., familyImage: bool | int | str = ..., helpMenu: bool | int = ..., itemArray: bool | int = ..., label: bool | int | str = ..., ltVersion: bool | int | str = ..., mnemonic: bool | int | str = ..., numberOfItems: bool | int = ..., parent: str = ..., postMenuCommand: str | Callable = ..., postMenuCommandOnce: bool | int = ..., query: bool | int = ..., scrollable: bool | int = ..., tearOff: bool | int = ..., useTemplate: str = ..., version: bool | int | str = ..., visible: bool | int = ...) -> Any: ...
def menuBarLayout(*args, annotation: bool | int | str = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., childArray: bool | int = ..., defineTemplate: str = ..., docTag: bool | int | str = ..., dragCallback: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., exists: bool | int = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., isObscured: bool | int = ..., manage: bool | int = ..., menuArray: bool | int = ..., menuBarVisible: bool | int = ..., menuIndex: tuple[str, int] = ..., noBackground: bool | int = ..., numberOfChildren: bool | int = ..., numberOfMenus: bool | int = ..., numberOfPopupMenus: bool | int = ..., parent: bool | int | str = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., statusBarMessage: str = ..., useTemplate: str = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., width: int = ...) -> Any: ...
def menuEditor(*args, annotation: bool | int | str = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., cellHeight: int = ..., cellWidth: int = ..., cellWidthHeight: tuple[int, int] = ..., checkBoxPresent: bool | int | tuple[bool | int, str, int] = ..., checkBoxState: bool | int | tuple[bool | int, str, int] = ..., childArray: bool | int = ..., command: bool | int | tuple[str, str, int] = ..., defineTemplate: str = ..., delete: tuple[str, int] = ..., docTag: bool | int | str = ..., dragCallback: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., exists: bool | int = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., iconMenuCallback: str = ..., image: bool | int | tuple[str, str, int] = ..., isObscured: bool | int = ..., label: bool | int | tuple[str, str, int] = ..., manage: bool | int = ..., menuItemTypes: bool | int = ..., noBackground: bool | int = ..., numberOfChildren: bool | int = ..., numberOfPopupMenus: bool | int = ..., optionBoxCommand: bool | int | tuple[str, str, int] = ..., optionBoxPresent: bool | int | tuple[bool | int, str, int] = ..., parent: bool | int | str = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., radioButtonPresent: bool | int | tuple[bool | int, str, int] = ..., radioButtonState: bool | int | tuple[bool | int, str, int] = ..., separator: bool | int | tuple[str, int] = ..., statusBarMessage: str = ..., style: bool | int | str = ..., subMenuAt: tuple[str, int] = ..., subMenuEditorWindow: str = ..., subMenuEditorsOpen: bool | int = ..., subMenuOf: tuple[str, str, int] = ..., topLevelMenu: bool | int | str = ..., useTemplate: str = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., width: int = ...) -> Any: ...
def menuItem(*args, allowOptionBoxes: bool | int = ..., altModifier: bool | int = ..., annotation: bool | int | str = ..., boldFont: bool | int = ..., checkBox: bool | int = ..., collection: bool | int | str = ..., command: bool | int | str | Callable = ..., commandModifier: bool | int = ..., ctrlModifier: bool | int = ..., data: int = ..., defineTemplate: str = ..., divider: bool | int = ..., dividerLabel: bool | int | str = ..., docTag: bool | int | str = ..., dragDoubleClickCommand: bool | int | str | Callable = ..., dragMenuCommand: bool | int | str | Callable = ..., echoCommand: bool | int = ..., edit: bool | int = ..., enable: bool | int = ..., enableCommandRepeat: bool | int = ..., exists: bool | int = ..., familyImage: bool | int | str = ..., image: bool | int | str = ..., imageOverlayLabel: bool | int | str = ..., insertAfter: str = ..., isCheckBox: bool | int = ..., isOptionBox: bool | int = ..., isRadioButton: bool | int = ..., italicized: bool | int = ..., keyEquivalent: str = ..., label: bool | int | str = ..., longDivider: bool | int = ..., ltVersion: bool | int | str = ..., mnemonic: str = ..., optionBox: bool | int = ..., optionBoxIcon: bool | int | str = ..., optionModifier: bool | int = ..., parent: str = ..., postMenuCommand: bool | int | str | Callable = ..., postMenuCommandOnce: bool | int = ..., query: bool | int = ..., radialPosition: bool | int | str = ..., radioButton: bool | int = ..., runTimeCommand: str = ..., shiftModifier: bool | int = ..., sourceType: bool | int | str = ..., subMenu: bool | int = ..., tearOff: bool | int = ..., useTemplate: str = ..., version: bool | int | str = ..., visible: bool | int = ...) -> Any: ...
...
def nodeEditor(*args, activeTab: int = ..., addNewNodes: bool | int = ..., addNode: str | list[str] = ..., additiveGraphingMode: bool | int = ..., allAttributes: bool | int = ..., allNodes: bool | int = ..., allowNewTabs: bool | int = ..., allowTabTearoff: bool | int = ..., autoSizeNodes: bool | int = ..., backToParentView: bool | int = ..., beginCreateNode: bool | int = ..., beginNewConnection: str = ..., breakSelectedConnections: bool | int = ..., closeAllTabs: bool | int = ..., closeTab: int = ..., connectNodeOnCreation: bool | int = ..., connectOnDrop: bool | int = ..., connectSelectedNodes: bool | int = ..., connectionMinSegment: bool | int | float = ..., connectionOffset: bool | int | float = ..., connectionRoundness: bool | int | float = ..., connectionStyle: bool | int | str = ..., connectionTension: int = ..., consistentNameSize: bool | int = ..., contentsChangedCommand: bool | int | str | Callable = ..., control: bool | int = ..., copyConnectionsOnPaste: bool | int = ..., createInfo: str = ..., createNodeCommand: bool | int | str | Callable = ..., createTab: tuple[int, str] = ..., crosshairOnEdgeDragging: bool | int = ..., customAttributeListEdit: bool | int | tuple[str, str] = ..., cycleHUD: bool | int = ..., defaultPinnedState: bool | int = ..., defineTemplate: str = ..., deleteSelected: bool | int = ..., docTag: bool | int | str = ..., dotFormat: bool | int | str = ..., downstream: bool | int = ..., duplicateTab: tuple[int, int] = ..., edit: bool | int = ..., editorMode: str = ..., enableOpenGL: bool | int = ..., exists: bool | int = ..., extendToShapes: bool | int = ..., feedbackConnection: bool | int = ..., feedbackNode: bool | int = ..., feedbackPlug: bool | int = ..., feedbackTabIndex: bool | int = ..., feedbackType: bool | int = ..., filter: bool | int | str = ..., filterCreateNodeTypes: bool | int | str | Callable = ..., focusCommand: bool | int | str | Callable = ..., forceMainConnection: bool | int | str = ..., frameAll: bool | int = ..., frameModelSelection: bool | int = ..., frameSelected: bool | int = ..., getNodeList: bool | int = ..., graphSelectedConnections: bool | int = ..., graphSelection: bool | int = ..., gridSnap: bool | int = ..., gridVisibility: bool | int = ..., hasWatchpoint: bool | int = ..., highlightConnection: bool | int | str = ..., highlightConnections: bool | int | tuple[str, bool | int] | list[tuple[str, bool | int]] = ..., hudMessage: tuple[str, int, float] = ..., ignoreAssets: bool | int = ..., inContainerView: bool | int = ..., isContainerNode: str = ..., island: bool | int = ..., keyPressCommand: bool | int | str | Callable = ..., keyReleaseCommand: bool | int | str | Callable = ..., layout: bool | int = ..., layoutCommand: bool | int | str | Callable = ..., lockMainConnection: bool | int = ..., mainListConnection: bool | int | str = ..., nodeSwatchSize: str = ..., nodeTitleMode: bool | int | str = ..., nodeViewMode: str = ..., openContainerView: tuple[str, bool | int] = ..., overrideNodeDropPosition: tuple[float, float] = ..., panView: tuple[float, float] = ..., panel: bool | int | str = ..., parent: bool | int | str = ..., pinSelectedNodes: bool | int = ..., popupMenuScript: bool | int | str | Callable = ..., primary: bool | int = ..., query: bool | int = ..., redockTab: bool | int = ..., removeDownstream: bool | int = ..., removeNode: str | list[str] = ..., removeUnselected: bool | int = ..., removeUpstream: bool | int = ..., renameNode: str = ..., renameTab: tuple[int, str] = ..., restoreInfo: str = ..., restoreLastClosedTab: bool | int = ..., rootNode: str | list[str] = ..., rootsFromSelection: bool | int = ..., scaleView: float = ..., selectAll: bool | int = ..., selectConnectionNodes: bool | int = ..., selectDownstream: bool | int = ..., selectFeedbackConnection: bool | int = ..., selectNode: bool | int | str | list[str] = ..., selectUpstream: bool | int = ..., selectionConnection: bool | int | str = ..., setWatchpoint: bool | int = ..., settingsChangedCallback: bool | int | str | Callable = ..., shaderNetworks: bool | int = ..., showAllNodeAttributes: str = ..., showNamespace: bool | int = ..., showSGShapes: bool | int = ..., showShapes: bool | int = ..., showTabs: bool | int = ..., showTransforms: bool | int = ..., showUnitConversions: bool | int = ..., stateString: bool | int = ..., syncedSelection: bool | int = ..., tabChangeCommand: str | Callable = ..., toggleAttrFilter: bool | int = ..., toggleSelectedPins: bool | int = ..., toggleSwatchSize: str = ..., toolTipCommand: bool | int | str | Callable = ..., traversalDepthLimit: int = ..., unParent: bool | int = ..., unlockMainConnection: bool | int = ..., updateMainConnection: bool | int = ..., upstream: bool | int = ..., useAssets: bool | int = ..., useLongName: int = ..., useTemplate: str = ..., vnnCompound: bool | int = ..., vnnDgContainer: bool | int = ..., vnnRuntime: bool | int = ...) -> Any: ...
...
def nodeTreeLister(*args, addFavorite: str | list[str] = ..., addItem: tuple[str, str, str | Callable] | list[tuple[str, str, str | Callable]] = ..., addVnnItem: tuple[str, str, str, str] | list[tuple[str, str, str, str]] = ..., annotation: bool | int | str = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., clearContents: bool | int = ..., collapsePath: str | list[str] = ..., defineTemplate: str = ..., docTag: bool | int | str = ..., dragCallback: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., executeItem: str = ..., exists: bool | int = ..., expandPath: str | list[str] = ..., expandToDepth: int = ..., favoritesCallback: str | Callable = ..., favoritesList: bool | int = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., isObscured: bool | int = ..., itemScript: bool | int | str = ..., manage: bool | int = ..., noBackground: bool | int = ..., nodeLibrary: bool | int | str = ..., numberOfPopupMenus: bool | int = ..., parent: bool | int | str = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., refreshCommand: bool | int | str | Callable = ..., removeFavorite: str | list[str] = ..., removeItem: str | list[str] = ..., resultsPathUnderCursor: bool | int = ..., selectPath: str | list[str] = ..., statusBarMessage: str = ..., useTemplate: str = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., vnnString: bool | int = ..., width: int = ...) -> Any: ...
def nodeType(*args, apiType: bool | int = ..., derived: bool | int = ..., inherited: bool | int = ..., isTypeName: bool | int = ..., ufeRuntimeName: bool | int = ...) -> Any: ...
def nonLinear(*args, after: bool | int = ..., afterReference: bool | int = ..., autoParent: bool | int = ..., before: bool | int = ..., commonParent: bool | int = ..., defaultScale: bool | int = ..., deformerTools: bool | int = ..., edit: bool | int = ..., exclusive: bool | int | str = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., split: bool | int = ..., type: str = ..., useComponentTags: bool | int = ...) -> Any: ...
def nop(*args) -> Any: ...
...
def openCLInfo(*args, minVertexBuffer: bool | int = ..., query: bool | int = ..., valid: bool | int = ...) -> Any: ...
...
def polyClean(*args, caching: bool | int = ..., cleanEdges: bool | int = ..., cleanPartialUVMapping: bool | int = ..., cleanUVs: bool | int = ..., cleanVertices: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
...
def polyCloseBorder(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
def polyCollapseEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
def polyCollapseFacet(*args, areaThreshold: bool | int | float = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., useAreaThreshold: bool | int = ...) -> Any: ...
...
def polyCone(*args, axis: bool | int | tuple[float, float, float] = ..., caching: bool | int = ..., componentTagCreate: bool | int = ..., constructionHistory: bool | int = ..., createUVs: int = ..., edit: bool | int = ..., frozen: bool | int = ..., height: bool | int | float = ..., name: str = ..., nodeState: int = ..., object: bool | int = ..., query: bool | int = ..., radius: bool | int | float = ..., roundCap: bool | int = ..., subdivisionsAxis: int = ..., subdivisionsCap: int = ..., subdivisionsHeight: int = ..., subdivisionsX: int = ..., subdivisionsY: int = ..., subdivisionsZ: int = ..., texture: bool | int = ...) -> Any: ...
def polyConnectComponents(*args, adjustEdgeFlow: bool | int | float = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., insertWithEdgeFlow: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
def polyContourProjection(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., createNewMap: bool | int = ..., edit: bool | int = ..., flipRails: bool | int = ..., frozen: bool | int = ..., insertBeforeDeformers: bool | int = ..., method: int = ..., name: str = ..., nodeState: int = ..., offset0: bool | int | float = ..., offset1: bool | int | float = ..., offset2: bool | int | float = ..., offset3: bool | int | float = ..., query: bool | int = ..., reduceShear: bool | int | float = ..., smoothness0: bool | int | float = ..., smoothness1: bool | int | float = ..., smoothness2: bool | int | float = ..., smoothness3: bool | int | float = ..., userDefinedCorners: bool | int = ..., uvSetName: str = ..., worldSpace: bool | int = ...) -> Any: ...
def polyCopyUV(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., createNewMap: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., uvSetName: str = ..., uvSetNameInput: bool | int | str = ..., worldSpace: bool | int = ...) -> Any: ...
...
def polyHelix(*args, axis: bool | int | tuple[float, float, float] = ..., caching: bool | int = ..., coils: bool | int | float = ..., componentTagCreate: bool | int = ..., constructionHistory: bool | int = ..., createUVs: int = ..., direction: int = ..., edit: bool | int = ..., frozen: bool | int = ..., height: bool | int | float = ..., name: str = ..., nodeState: int = ..., object: bool | int = ..., query: bool | int = ..., radius: bool | int | float = ..., roundCap: bool | int = ..., subdivisionsAxis: int = ..., subdivisionsCaps: int = ..., subdivisionsCoil: int = ..., texture: int = ..., useOldInitBehaviour: bool | int = ..., width: bool | int | float = ...) -> Any: ...
...
def polyMapCut(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., moveRatio: float = ..., moveratio: bool | int | float = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., usePinning: bool | int = ...) -> Any: ...
def polyMapDel(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
def polyMapSew(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., usePinning: bool | int = ...) -> Any: ...
def polyMapSewMove(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., limitPieceSize: bool | int = ..., name: str = ..., nodeState: int = ..., numberFaces: int = ..., query: bool | int = ..., uvSetName: str = ..., worldSpace: bool | int = ...) -> Any: ...
def polyMergeEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., firstEdge: int = ..., frozen: bool | int = ..., mergeMode: int = ..., mergeTexture: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., secondEdge: int = ...) -> Any: ...
def polyMergeEdgeCtx(*args, activeNodes: bool | int = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., exists: bool | int = ..., firstEdge: int = ..., frozen: bool | int = ..., image1: bool | int | str = ..., image2: bool | int | str = ..., image3: bool | int | str = ..., immediate: bool | int = ..., mergeMode: int = ..., mergeTexture: bool | int = ..., name: str = ..., nodeState: int = ..., previous: bool | int = ..., query: bool | int = ..., reset: bool | int = ..., secondEdge: int = ..., toolNode: bool | int = ...) -> Any: ...
def polyMergeFacet(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., firstFacet: int = ..., frozen: bool | int = ..., mergeMode: int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., secondFacet: int = ...) -> Any: ...
def polyMergeFacetCtx(*args, activeNodes: bool | int = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., exists: bool | int = ..., firstFacet: int = ..., frozen: bool | int = ..., image1: bool | int | str = ..., image2: bool | int | str = ..., image3: bool | int | str = ..., immediate: bool | int = ..., mergeMode: int = ..., name: str = ..., nodeState: int = ..., previous: bool | int = ..., query: bool | int = ..., reset: bool | int = ..., secondFacet: int = ..., toolNode: bool | int = ...) -> Any: ...
def polyMergeUV(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., distance: bool | int | float = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., uvSetName: str = ..., worldSpace: bool | int = ...) -> Any: ...
def polyMergeVertex(*args, alwaysMergeTwoVertices: bool | int = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., distance: bool | int | float = ..., edit: bool | int = ..., frozen: bool | int = ..., mergeToComponents: bool | int | str = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., texture: bool | int = ..., worldSpace: bool | int = ...) -> Any: ...
def polyMirrorFace(*args, axis: int = ..., axisDirection: int = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., cutMesh: bool | int = ..., direction: int = ..., edit: bool | int = ..., firstNewFace: int = ..., flipUVs: int = ..., frozen: bool | int = ..., keepVertexIDs: bool | int = ..., lastNewFace: int = ..., mergeMode: int = ..., mergeThreshold: bool | int | float = ..., mergeThresholdType: int = ..., mirrorAxis: int = ..., mirrorPlaneCenter: tuple[float, float, float] = ..., mirrorPlaneCenterX: float = ..., mirrorPlaneCenterY: float = ..., mirrorPlaneCenterZ: float = ..., mirrorPlaneRotate: tuple[float, float, float] = ..., mirrorPlaneRotateX: float = ..., mirrorPlaneRotateY: float = ..., mirrorPlaneRotateZ: float = ..., mirrorPosition: bool | int | float = ..., name: str = ..., nodeState: int = ..., pivot: bool | int | tuple[float, float, float] = ..., pivotX: bool | int | float = ..., pivotY: bool | int | float = ..., pivotZ: bool | int | float = ..., query: bool | int = ..., scalePivotX: float = ..., scalePivotY: float = ..., scalePivotZ: float = ..., smoothingAngle: float = ..., userSpecifiedPivot: bool | int = ..., worldSpace: bool | int = ...) -> Any: ...
def polyMoveEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., gain: bool | int | float | list[float] = ..., localCenter: int = ..., localDirection: bool | int | tuple[float, float, float] = ..., localDirectionX: bool | int | float = ..., localDirectionY: bool | int | float = ..., localDirectionZ: bool | int | float = ..., localRotate: bool | int | tuple[float, float, float] = ..., localRotateX: bool | int | float = ..., localRotateY: bool | int | float = ..., localRotateZ: bool | int | float = ..., localScale: bool | int | tuple[float, float, float] = ..., localScaleX: bool | int | float = ..., localScaleY: bool | int | float = ..., localScaleZ: bool | int | float = ..., localTranslate: bool | int | tuple[float, float, float] = ..., localTranslateX: bool | int | float = ..., localTranslateY: bool | int | float = ..., localTranslateZ: bool | int | float = ..., name: str = ..., nodeState: int = ..., pivot: bool | int | tuple[float, float, float] = ..., pivotX: bool | int | float = ..., pivotY: bool | int | float = ..., pivotZ: bool | int | float = ..., query: bool | int = ..., random: bool | int | float = ..., rotate: bool | int | tuple[float, float, float] = ..., rotateX: bool | int | float = ..., rotateY: bool | int | float = ..., rotateZ: bool | int | float = ..., scale: bool | int | tuple[float, float, float] = ..., scaleX: bool | int | float = ..., scaleY: bool | int | float = ..., scaleZ: bool | int | float = ..., translate: bool | int | tuple[float, float, float] = ..., translateX: bool | int | float = ..., translateY: bool | int | float = ..., translateZ: bool | int | float = ..., worldSpace: bool | int = ...) -> Any: ...
...
def polyNormal(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., normalMode: int = ..., query: bool | int = ..., userNormalMode: bool | int = ...) -> Any: ...
...
def polyPipe(*args, axis: bool | int | tuple[float, float, float] = ..., caching: bool | int = ..., componentTagCreate: bool | int = ..., constructionHistory: bool | int = ..., createUVs: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., height: bool | int | float = ..., name: str = ..., nodeState: int = ..., object: bool | int = ..., query: bool | int = ..., radius: bool | int | float = ..., roundCap: bool | int = ..., subdivisionsAxis: int = ..., subdivisionsCaps: int = ..., subdivisionsHeight: int = ..., texture: bool | int = ..., thickness: bool | int | float = ...) -> Any: ...
...
def polyQuad(*args, angle: bool | int | float = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., keepGroupBorder: bool | int = ..., keepHardEdges: bool | int = ..., keepTextureBorders: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., worldSpace: bool | int = ...) -> Any: ...
...
def polySewEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., texture: bool | int = ..., tolerance: bool | int | float = ..., worldSpace: bool | int = ...) -> Any: ...
...
def polySpinEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., offset: int = ..., query: bool | int = ..., reverse: bool | int = ...) -> Any: ...
...
def polySplitEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., operation: int = ..., query: bool | int = ...) -> Any: ...
...
def polySplitVertex(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., worldSpace: bool | int = ...) -> Any: ...
def polyStraightenUVBorder(*args, blendOriginal: bool | int | float = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., curvature: bool | int | float = ..., edit: bool | int = ..., frozen: bool | int = ..., gapTolerance: int = ..., name: str = ..., nodeState: int = ..., preserveLength: bool | int | float = ..., query: bool | int = ..., uvSetName: str = ..., worldSpace: bool | int = ...) -> Any: ...
def polySubdivideEdge(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., divisions: int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., size: bool | int | float = ..., worldSpace: bool | int = ...) -> Any: ...
def polySubdivideFacet(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., divisions: int = ..., divisionsU: int = ..., divisionsV: int = ..., edit: bool | int = ..., frozen: bool | int = ..., mode: int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., subdMethod: int = ...) -> Any: ...
...
def polyTorus(*args, axis: bool | int | tuple[float, float, float] = ..., caching: bool | int = ..., componentTagCreate: bool | int = ..., constructionHistory: bool | int = ..., createUVs: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., object: bool | int = ..., query: bool | int = ..., radius: bool | int | float = ..., sectionRadius: bool | int | float = ..., subdivisionsAxis: int = ..., subdivisionsHeight: int = ..., subdivisionsX: int = ..., subdivisionsY: int = ..., texture: bool | int = ..., twist: bool | int | float = ...) -> Any: ...
def polyTransfer(*args, alternateObject: bool | int | str = ..., caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ..., uvSets: bool | int = ..., vertexColor: bool | int = ..., vertices: bool | int = ...) -> Any: ...
def polyTriangulate(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
...
def polyUVRectangle(*args, caching: bool | int = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., frozen: bool | int = ..., name: str = ..., nodeState: int = ..., query: bool | int = ...) -> Any: ...
...
def referenceQuery(*args, child: bool | int = ..., dagPath: bool | int = ..., editAttrs: bool | int = ..., editCommand: bool | int | str | list[str] = ..., editNodes: bool | int = ..., editStrings: bool | int = ..., failedEdits: bool | int = ..., filename: bool | int = ..., isExportEdits: bool | int = ..., isLoaded: bool | int = ..., isNodeReferenced: bool | int = ..., isPreviewOnly: bool | int = ..., liveEdits: bool | int = ..., namespace: bool | int = ..., nodes: bool | int = ..., onReferenceNode: bool | int | str | list[str] = ..., parent: bool | int = ..., parentNamespace: bool | int = ..., referenceNode: bool | int = ..., shortName: bool | int = ..., showDagPath: bool | int = ..., showNamespace: bool | int = ..., successfulEdits: bool | int = ..., topReference: bool | int = ..., unresolvedName: bool | int = ..., withoutCopyNumber: bool | int = ...) -> Any: ...
...
def rename(*args, ignoreShape: bool | int = ..., uuid: bool | int = ...) -> Any: ...
...
def repeatLast(*args, addCommand: str = ..., addCommandLabel: str = ..., commandList: int = ..., commandNameList: int = ..., edit: bool | int = ..., historyLimit: int = ..., item: int = ..., numberOfHistoryItems: bool | int = ..., query: bool | int = ...) -> Any: ...
...
def sculptTarget(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., deformerTools: bool | int = ..., edit: bool | int = ..., exclusive: str = ..., frontOfChain: bool | int = ..., geometry: str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., inbetweenWeight: float = ..., includeHiddenSelections: bool | int = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., regenerate: bool | int = ..., remove: bool | int | list[bool | int] = ..., snapshot: int = ..., split: bool | int = ..., target: int = ..., useComponentTags: bool | int = ...) -> Any: ...
...
def setAttr(*args, alteredValue: bool | int = ..., caching: bool | int = ..., capacityHint: int = ..., channelBox: bool | int = ..., clamp: bool | int = ..., edit: bool | int = ..., keyable: bool | int = ..., lock: bool | int = ..., query: bool | int = ..., size: int = ..., type: str = ...) -> Any: ...
...
def sets(*args, addElement: str = ..., afterFilters: bool | int = ..., anyMember: str = ..., clear: str = ..., color: int = ..., copy: str = ..., edges: bool | int = ..., edit: bool | int = ..., editPoints: bool | int = ..., empty: bool | int = ..., facets: bool | int = ..., flatten: str = ..., forceElement: str = ..., include: str = ..., intersection: str = ..., isIntersecting: str = ..., isMember: str = ..., layer: bool | int = ..., name: str = ..., noIntermediate: bool | int = ..., noSurfaceShader: bool | int = ..., noWarnings: bool | int = ..., nodesOnly: bool | int = ..., query: bool | int = ..., remove: str = ..., renderable: bool | int = ..., size: bool | int = ..., split: str = ..., subtract: str = ..., text: bool | int | str = ..., union: str = ..., vertices: bool | int = ...) -> Any: ...
...
def showManipCtx(*args, currentNodeName: bool | int = ..., edit: bool | int = ..., exists: bool | int = ..., history: bool | int = ..., image1: bool | int | str = ..., image2: bool | int | str = ..., image3: bool | int | str = ..., incSnap: bool | int | tuple[int, bool | int] | list[tuple[int, bool | int]] = ..., incSnapRelative: bool | int | tuple[int, bool | int] | list[tuple[int, bool | int]] = ..., incSnapUI: bool | int = ..., incSnapValue: bool | int | tuple[int, float] | list[tuple[int, float]] = ..., lockSelection: bool | int = ..., name: str = ..., query: bool | int = ..., toggleIncSnap: bool | int = ..., toolFinish: bool | int | str | Callable = ..., toolStart: bool | int | str | Callable = ...) -> Any: ...
...
def snapshot(*args, anchorTransform: str = ..., constructionHistory: bool | int = ..., edit: bool | int = ..., endTime: bool | int | int | float = ..., increment: bool | int | int | float = ..., motionTrail: bool | int = ..., motionTrailName: str = ..., name: bool | int | str = ..., query: bool | int = ..., removeAnchorTransform: str = ..., startTime: bool | int | int | float = ..., update: bool | int | str = ...) -> Any: ...
...
def softMod(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., bindState: bool | int = ..., curveInterpolation: int | list[int] = ..., curvePoint: float | list[float] = ..., curveValue: float | list[float] = ..., deformerTools: bool | int = ..., edit: bool | int = ..., envelope: bool | int | float = ..., exclusive: bool | int | str = ..., falloffAroundSelection: bool | int = ..., falloffBasedOnX: bool | int = ..., falloffBasedOnY: bool | int = ..., falloffBasedOnZ: bool | int = ..., falloffCenter: tuple[float, float, float] = ..., falloffMasking: bool | int = ..., falloffMode: int = ..., falloffRadius: float = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., relative: bool | int = ..., remove: bool | int | list[bool | int] = ..., resetGeometry: bool | int = ..., split: bool | int = ..., useComponentTags: bool | int = ..., weightedNode: bool | int | tuple[str, str] = ...) -> Any: ...
def softModContext(*args) -> Any: ...
def softModCtx(*args, dragSlider: str = ..., edit: bool | int = ..., exists: bool | int = ..., falseColor: bool | int = ..., image1: bool | int | str = ..., image2: bool | int | str = ..., image3: bool | int | str = ..., query: bool | int = ..., reset: bool | int = ...) -> Any: ...
...
def textScrollList(*args, allItems: bool | int = ..., allowAutomaticSelection: bool | int = ..., allowMultiSelection: bool | int = ..., allowSorting: bool | int | list[bool | int] = ..., annotation: bool | int | str = ..., append: str | list[str] = ..., appendPosition: tuple[int, str] | list[tuple[int, str]] = ..., appendWithToolTip: tuple[str, str] | list[tuple[str, str]] = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., defineTemplate: str = ..., deleteKeyCommand: str | Callable = ..., deselectAll: bool | int = ..., deselectIndexedItem: int | list[int] = ..., deselectItem: str | list[str] = ..., docTag: bool | int | str = ..., doubleClickCommand: str | Callable = ..., dragCallback: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., exists: bool | int = ..., font: bool | int | str = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., isObscured: bool | int = ..., lineFont: tuple[int, str] | list[tuple[int, str]] = ..., manage: bool | int = ..., noBackground: bool | int = ..., numberOfItems: bool | int = ..., numberOfPopupMenus: bool | int = ..., numberOfRows: int = ..., numberOfSelectedItems: bool | int = ..., parent: bool | int | str = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., removeAll: bool | int = ..., removeIndexedItem: int | list[int] = ..., removeItem: str | list[str] = ..., selectCommand: str | Callable = ..., selectIndexedItem: bool | int | int | list[int] = ..., selectItem: bool | int | str | list[str] = ..., selectUniqueTagItem: bool | int | str | list[str] = ..., setCheckedState: tuple[str, bool | int] | list[tuple[str, bool | int]] = ..., setUniformItemSize: bool | int = ..., showIndexedItem: int = ..., statusBarMessage: str = ..., uniqueTag: str | list[str] = ..., useTemplate: str = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., width: int = ...) -> Any: ...
def textureDeformer(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., deformerTools: bool | int = ..., direction: str = ..., edit: bool | int = ..., envelope: float = ..., exclusive: bool | int | str = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., name: str = ..., offset: float = ..., parallel: bool | int = ..., pointSpace: str = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., split: bool | int = ..., strength: float = ..., useComponentTags: bool | int = ..., vectorOffset: tuple[float, float, float] = ..., vectorSpace: str = ..., vectorStrength: tuple[float, float, float] = ...) -> Any: ...
...
def toolButton(*args, allowMultipleTools: bool | int = ..., annotation: bool | int | str = ..., backgroundColor: bool | int | tuple[float, float, float] = ..., changeCommand: str | Callable = ..., collection: str = ..., defineTemplate: str = ..., docTag: bool | int | str = ..., doubleClickCommand: str | Callable = ..., dragCallback: str | Callable = ..., dropCallback: str | Callable = ..., edit: bool | int = ..., enable: bool | int = ..., enableBackground: bool | int = ..., enableKeyboardFocus: bool | int = ..., exists: bool | int = ..., fullPathName: bool | int = ..., height: int = ..., highlightColor: bool | int | tuple[float, float, float] = ..., image1: bool | int | str = ..., image2: bool | int | str = ..., image3: bool | int | str = ..., imageOverlayLabel: bool | int | str = ..., isObscured: bool | int = ..., ltVersion: bool | int | str = ..., manage: bool | int = ..., noBackground: bool | int = ..., numberOfPopupMenus: bool | int = ..., offCommand: str | Callable = ..., onCommand: str | Callable = ..., parent: bool | int | str = ..., popupIndicatorVisible: bool | int = ..., popupMenuArray: bool | int = ..., preventOverride: bool | int = ..., query: bool | int = ..., select: bool | int = ..., statusBarMessage: str = ..., style: str = ..., tool: bool | int | str | list[str] = ..., toolArray: bool | int = ..., toolCount: bool | int = ..., toolImage1: bool | int | tuple[str, str] | list[tuple[str, str]] = ..., toolImage2: bool | int | tuple[str, str] | list[tuple[str, str]] = ..., toolImage3: bool | int | tuple[str, str] | list[tuple[str, str]] = ..., useTemplate: str = ..., version: bool | int | str = ..., visible: bool | int = ..., visibleChangeCommand: bool | int | str | Callable = ..., width: int = ...) -> Any: ...
def toolCollection(*args, collectionItemArray: bool | int = ..., defineTemplate: str = ..., edit: bool | int = ..., exists: bool | int = ..., gl: bool | int = ..., numberOfCollectionItems: bool | int = ..., parent: str = ..., query: bool | int = ..., select: bool | int | str = ..., useTemplate: str = ...) -> Any: ...
...
def transferAttributes(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., colorBorders: int = ..., deformerTools: bool | int = ..., edit: bool | int = ..., exclusive: bool | int | str = ..., flipUVs: int = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., matchChoice: int = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., sampleSpace: int = ..., searchMethod: int = ..., searchScaleX: float = ..., searchScaleY: float = ..., searchScaleZ: float = ..., sourceColorSet: str = ..., sourceUvSet: str = ..., sourceUvSpace: str = ..., split: bool | int = ..., targetColorSet: str = ..., targetUvSet: str = ..., targetUvSpace: str = ..., transferColors: int = ..., transferNormals: int = ..., transferPositions: int = ..., transferUVs: int = ..., useComponentTags: bool | int = ...) -> Any: ...
...
def translator(*args, defaultFileRule: bool | int = ..., defaultOptions: bool | int | str = ..., extension: bool | int = ..., fileCompression: bool | int | str = ..., filter: bool | int = ..., list: bool | int = ..., loaded: bool | int = ..., objectType: bool | int = ..., optionsScript: bool | int = ..., query: bool | int = ..., readSupport: bool | int = ..., writeSupport: bool | int = ...) -> Any: ...
...
def unloadPlugin(*args, addCallback: str | Callable = ..., force: bool | int = ..., removeCallback: str | Callable = ...) -> Any: ...
...
def userCtx(*args, edit: bool | int = ..., editCommand: callable = ..., editPrompt: str = ..., exists: bool | int = ..., finalCommand: str = ..., history: bool | int = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ..., noSelectionPrompt: tuple[int, str] | list[tuple[int, str]] = ..., query: bool | int = ..., selectionCount: tuple[int, int] | list[tuple[int, int]] = ..., selectionFlag: tuple[int, str] | list[tuple[int, str]] = ..., selectionMask: tuple[int, str] | list[tuple[int, str]] = ..., selectionPrompt: str | list[str] = ...) -> Any: ...
...
def viewFit(*args, allObjects: bool | int = ..., animate: bool | int = ..., center: bool | int = ..., fitFactor: float = ..., namespace: str = ..., noChildren: bool | int = ..., panel: str = ...) -> Any: ...
...
def window(*args, backgroundColor: tuple[float, float, float] = ..., closeCommand: str | Callable = ..., defineTemplate: str = ..., docTag: bool | int | str = ..., dockCorner: tuple[str, str] | list[tuple[str, str]] = ..., dockStation: bool | int = ..., dockingLayout: bool | int | str = ..., edit: bool | int = ..., exists: bool | int = ..., frontWindow: bool | int = ..., height: int = ..., iconName: bool | int | str = ..., iconify: bool | int = ..., interactivePlacement: bool | int = ..., leftEdge: int = ..., mainMenuBar: bool | int = ..., mainWindow: bool | int = ..., maximizeButton: bool | int = ..., menuArray: bool | int = ..., menuBar: bool | int = ..., menuBarCornerWidget: bool | int | tuple[str, str] = ..., menuBarResize: bool | int = ..., menuBarVisible: bool | int = ..., menuIndex: tuple[str, int] = ..., minimizeButton: bool | int = ..., minimizeCommand: str | Callable = ..., nestedDockingEnabled: bool | int = ..., numberOfMenus: bool | int = ..., parent: str = ..., query: bool | int = ..., resizeToFitChildren: bool | int = ..., restoreCommand: str | Callable = ..., retain: bool | int = ..., sizeable: bool | int = ..., state: bool | int | str = ..., title: bool | int | str = ..., titleBar: bool | int = ..., titleBarMenu: bool | int = ..., toolbox: bool | int = ..., topEdge: int = ..., topLeftCorner: bool | int | tuple[int, int] = ..., useTemplate: str = ..., visible: bool | int = ..., width: int = ..., widthHeight: bool | int | tuple[int, int] = ...) -> Any: ...
...
def wire(*args, after: bool | int = ..., afterReference: bool | int = ..., before: bool | int = ..., crossingEffect: bool | int | float = ..., deformerTools: bool | int = ..., dropoffDistance: bool | int | tuple[int, float] | list[tuple[int, float]] = ..., edit: bool | int = ..., envelope: bool | int | float = ..., exclusive: bool | int | str = ..., frontOfChain: bool | int = ..., geometry: bool | int | str | list[str] = ..., geometryIndices: bool | int = ..., groupWithBase: bool | int = ..., holder: bool | int | tuple[int, str] | list[tuple[int, str]] = ..., ignoreSelected: bool | int = ..., includeHiddenSelections: bool | int = ..., localInfluence: bool | int | float = ..., name: str = ..., parallel: bool | int = ..., prune: bool | int = ..., query: bool | int = ..., remove: bool | int | list[bool | int] = ..., split: bool | int = ..., useComponentTags: bool | int = ..., wire: bool | int | str | list[str] = ..., wireCount: int = ...) -> Any: ...
...
def workspaceControl(*args, checksPlugins: bool | int = ..., close: bool | int = ..., closeCommand: str | Callable = ..., collapse: bool | int = ..., defineTemplate: str = ..., deleteLater: bool | int = ..., dockToControl: tuple[str, str] = ..., dockToMainWindow: tuple[str, bool | int] = ..., dockToPanel: tuple[str, str, bool | int] = ..., duplicatable: bool | int = ..., edit: bool | int = ..., exists: bool | int = ..., floating: bool | int = ..., height: bool | int = ..., heightProperty: bool | int | str = ..., horizontal: bool | int = ..., initCallback: bool | int | str = ..., initialHeight: int = ..., initialWidth: int = ..., label: bool | int | str = ..., loadImmediately: bool | int = ..., minimumHeight: int = ..., minimumWidth: int = ..., query: bool | int = ..., r: bool | int = ..., requiredControl: str | list[str] = ..., requiredPlugin: str | list[str] = ..., resizeHeight: int = ..., resizeWidth: int = ..., restore: bool | int = ..., retain: bool | int = ..., stateString: bool | int | str = ..., tabPosition: bool | int | tuple[str, bool | int] = ..., tabToControl: tuple[str, int] = ..., uiScript: str | Callable = ..., useTemplate: str = ..., visible: bool | int = ..., visibleChangeCommand: str | Callable = ..., width: bool | int = ..., widthProperty: bool | int | str = ...) -> Any: ...
