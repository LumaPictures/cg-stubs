...
class MatrixTransform(Transform):
    ...
    @staticmethod
    def Fit(oldMin: list[tuple[float, float, float, float]] = ..., oldMax: list[tuple[float, float, float, float]] = ..., newMin: list[tuple[float, float, float, float]] = ..., newMax: list[tuple[float, float, float, float]] = ...) -> MatrixTransform: ...
    @staticmethod
    def Identity() -> MatrixTransform: ...
    @staticmethod
    def Sat(sat: float, lumaCoef: list[tuple[float, float, float]]) -> MatrixTransform: ...
    @staticmethod
    def Scale(scale: list[tuple[float, float, float, float]]) -> MatrixTransform: ...
    @staticmethod
    def View(channelHot: list[tuple[int, int, int, int]], lumaCoef: list[tuple[float, float, float]]) -> MatrixTransform: ...
