...
class AllocationTransform(Transform):
    ...
    @overload
    def __init__(self, allocation: Allocation = ..., vars: list[float] = ..., direction: TransformDirection = ...) -> None: ...
...
class Baker:
    ...
    @classmethod
    def getFormats(cls) -> Baker.FormatIterator: ...
...
class CDLTransform(Transform):
    ...
    @overload
    def __init__(self, slope: list[tuple[float, float, float]] = ..., offset: list[tuple[float, float, float]] = ..., power: list[tuple[float, float, float]] = ..., sat: float = ..., id: str = ..., description: str = ..., direction: TransformDirection = ...) -> None: ...
    @classmethod
    def CreateFromFile(cls, src: str, id: str) -> CDLTransform: ...
    @classmethod
    def CreateGroupFromFile(cls, src: str) -> GroupTransform: ...
    def equals(self, other: CDLTransform) -> bool: ...
    def getFirstSOPDescription(self) -> str: ...
    def getFormatMetadata(self) -> FormatMetadata: ...
    def getID(self) -> str: ...
    def getOffset(self) -> list[tuple[float, float, float]]: ...
    def getPower(self) -> list[tuple[float, float, float]]: ...
    def getSOP(self) -> list[tuple[float, float, float, float, float, float, float, float, float]]: ...
    def getSat(self) -> float: ...
    def getSatLumaCoefs(self) -> list[tuple[float, float, float]]: ...
    def getSlope(self) -> list[tuple[float, float, float]]: ...
    def getStyle(self) -> CDLStyle: ...
    def setFirstSOPDescription(self, description: str) -> None: ...
    def setID(self, id: str) -> None: ...
    def setOffset(self, rgb: list[tuple[float, float, float]]) -> None: ...
    def setPower(self, rgb: list[tuple[float, float, float]]) -> None: ...
    def setSOP(self, vec9: list[tuple[float, float, float, float, float, float, float, float, float]]) -> None: ...
    def setSat(self, sat: float) -> None: ...
    def setSlope(self, rgb: list[tuple[float, float, float]]) -> None: ...
...
class CPUProcessor:
    ...
    @overload
    def applyRGB(self, data: typing_extensions.Buffer) -> None: ...
    @overload
    def applyRGB(self, data: list[float]) -> list[float]: ...
    @overload
    def applyRGBA(self, data: typing_extensions.Buffer) -> None: ...
    @overload
...
class ColorSpace:
    ...
    @overload
    def __init__(self, referenceSpace: ReferenceSpaceType = ..., name: str = ..., aliases: list[str] = ..., family: str = ..., encoding: str = ..., equalityGroup: str = ..., description: str = ..., bitDepth: BitDepth = ..., isData: bool = ..., allocation: Allocation = ..., allocationVars: list[float] = ..., toReference: Transform = ..., fromReference: Transform = ..., categories: list[str] = ...) -> None: ...
    ...
    def __deepcopy__(self) -> ColorSpace: ...
...
class ColorSpaceSet:
    class ColorSpaceIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> ColorSpace: ...
    ...
    def __and__(self, other: ColorSpaceSet) -> ColorSpaceSet: ...
    def __deepcopy__(self) -> ColorSpaceSet: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __or__(self, other: ColorSpaceSet) -> ColorSpaceSet: ...
    def __sub__(self, other: ColorSpaceSet) -> ColorSpaceSet: ...
...
class Config:
    ...
    class ActiveNamedTransformIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> NamedTransform: ...
    ...
    class LookIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> Look: ...
    ...
    class ViewTransformIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> ViewTransform: ...
    ...
    def __init__(self) -> None: ...
    @classmethod
    def CreateFromBuiltinConfig(cls, arg0: str) -> Config: ...
    @classmethod
    def CreateFromConfigIOProxy(cls, arg0) -> Config: ...
    @classmethod
    def CreateFromEnv(cls) -> Config: ...
    @classmethod
    def CreateFromFile(cls, fileName: str) -> Config: ...
    @classmethod
    def CreateFromStream(cls, str: str) -> Config: ...
    @classmethod
    def CreateRaw(cls) -> Config: ...
    @classmethod
    def GetProcessorFromBuiltinColorSpace(cls, builtinColorSpaceName: str, srcConfig: Config, srcColorSpaceName: str) -> Processor: ...
    @overload
    @classmethod
    def GetProcessorFromConfigs(cls, srcConfig: Config, srcColorSpaceName: str, dstConfig: Config, dstColorSpaceName: str) -> Processor: ...
    @overload
    @classmethod
    def GetProcessorFromConfigs(cls, srcContext: Context, srcConfig: Config, srcColorSpaceName: str, dstContext: Context, dstConfig: Config, dstColorSpaceName: str) -> Processor: ...
    @overload
    @classmethod
    def GetProcessorFromConfigs(cls, srcConfig: Config, srcColorSpaceName: str, srcInterchangeName: str, dstConfig: Config, dstColorSpaceName: str, dstInterchangeName: str) -> Processor: ...
    @overload
    @classmethod
    def GetProcessorFromConfigs(cls, srcContext: Context, srcConfig: Config, srcColorSpaceName: str, srcInterchangeName: str, dstContext: Context, dstConfig: Config, dstColorSpaceName: str, dstInterchangeName: str) -> Processor: ...
    @classmethod
    def GetProcessorToBuiltinColorSpace(cls, srcConfig: Config, srcColorSpaceName: str, builtinColorSpaceName: str) -> Processor: ...
    def addColorSpace(self, colorSpace: ColorSpace) -> None: ...
    ...
    def getDefaultLumaCoefs(self) -> list[tuple[float, float, float]]: ...
    ...
    def setDefaultLumaCoefs(self, rgb: list[tuple[float, float, float]]) -> None: ...
...
class Context:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, workingDir: str = ..., searchPaths: list[str] = ..., stringVars: dict[str, str] = ..., environmentMode: EnvironmentMode = ...) -> None: ...
    def addSearchPath(self, path: str) -> None: ...
    def clearSearchPaths(self) -> None: ...
    ...
    def setWorkingDir(self, dirName: str) -> None: ...
    def __contains__(self, other: str) -> bool: ...
    def __deepcopy__(self) -> Context: ...
    def __getitem__(self, index: str) -> str: ...
    def __iter__(self) -> Context.StringVarNameIterator: ...
    def __len__(self) -> int: ...
    def __setitem__(self, index: str, object: str) -> None: ...
...
class ExponentTransform(Transform):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, value: list[tuple[float, float, float, float]] = ..., negativeStyle: NegativeStyle = ..., direction: TransformDirection = ...) -> None: ...
    def equals(self, other: ExponentTransform) -> bool: ...
    def getFormatMetadata(self) -> FormatMetadata: ...
    def getNegativeStyle(self) -> NegativeStyle: ...
    def getValue(self) -> list[tuple[float, float, float, float]]: ...
    def setNegativeStyle(self, style: NegativeStyle) -> None: ...
    def setValue(self, value: list[tuple[float, float, float, float]]) -> None: ...

class ExponentWithLinearTransform(Transform):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, gamma: list[tuple[float, float, float, float]] = ..., offset: list[tuple[float, float, float, float]] = ..., negativeStyle: NegativeStyle = ..., direction: TransformDirection = ...) -> None: ...
    def equals(self, other: ExponentWithLinearTransform) -> bool: ...
    def getFormatMetadata(self) -> FormatMetadata: ...
    def getGamma(self) -> list[tuple[float, float, float, float]]: ...
    def getNegativeStyle(self) -> NegativeStyle: ...
    def getOffset(self) -> list[tuple[float, float, float, float]]: ...
    def setGamma(self, values: list[tuple[float, float, float, float]]) -> None: ...
    def setNegativeStyle(self, style: NegativeStyle) -> None: ...
    def setOffset(self, values: list[tuple[float, float, float, float]]) -> None: ...
...
class FileRules:
    ...
    def __deepcopy__(self) -> FileRules: ...
...
class FileTransform(Transform):
    ...
    @classmethod
    def getFormats(cls) -> FileTransform.FormatIterator: ...
...
class FormatMetadata:
    ...
    class ChildElementIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> FormatMetadata: ...
...
class GpuShaderCreator:
    class DynamicPropertyIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> DynamicProperty: ...
...
class GpuShaderDesc(GpuShaderCreator):
    ...
    class Texture3DIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> GpuShaderDesc.Texture3D: ...
    ...
    class TextureIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> GpuShaderDesc.Texture: ...
    ...
    class UniformData:
        ...
        def getDouble(self) -> float: ...
        def getFloat3(self) -> list[tuple[float, float, float]]: ...
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def CreateShaderDesc(cls, language: GpuLanguage = ..., functionName: str = ..., pixelName: str = ..., resourcePrefix: str = ..., uid: str = ...) -> GpuShaderDesc: ...
    def add3DTexture(self, textureName: str, samplerName: str, edgeLen: int, interpolation: Interpolation, values: typing_extensions.Buffer) -> None: ...
    def addTexture(self, textureName: str, samplerName: str, width: int, height: int, channel: GpuShaderCreator.TextureType, interpolation: Interpolation, values: typing_extensions.Buffer) -> None: ...
    def clone(self) -> GpuShaderCreator: ...
...
class GradingBSplineCurve:
    class GradingControlPointIterator:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, index: int) -> GradingControlPoint: ...
        def __iter__(self) -> GradingBSplineCurve.GradingControlPointIterator: ...
        def __len__(self) -> int: ...
        def __next__(self) -> GradingControlPoint: ...
        def __setitem__(self, index: int, object: GradingControlPoint) -> None: ...
    @overload
...
class GroupTransform(Transform):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, transforms: list[Transform] = ..., direction: TransformDirection = ...) -> None: ...
    @classmethod
    def GetWriteFormats(cls) -> GroupTransform.WriteFormatIterator: ...
...
class LogAffineTransform(Transform):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, logSideSlope: list[tuple[float, float, float]] = ..., logSideOffset: list[tuple[float, float, float]] = ..., linSideSlope: list[tuple[float, float, float]] = ..., linSideOffset: list[tuple[float, float, float]] = ..., direction: TransformDirection = ...) -> None: ...
    def equals(self, other: LogAffineTransform) -> bool: ...
    def getBase(self) -> float: ...
    def getFormatMetadata(self) -> FormatMetadata: ...
    def getLinSideOffsetValue(self) -> list[tuple[float, float, float]]: ...
    def getLinSideSlopeValue(self) -> list[tuple[float, float, float]]: ...
    def getLogSideOffsetValue(self) -> list[tuple[float, float, float]]: ...
    def getLogSideSlopeValue(self) -> list[tuple[float, float, float]]: ...
    def setBase(self, base: float) -> None: ...
    def setLinSideOffsetValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLinSideSlopeValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLogSideOffsetValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLogSideSlopeValue(self, values: list[tuple[float, float, float]]) -> None: ...

class LogCameraTransform(Transform):
    def __init__(self, linSideBreak: list[tuple[float, float, float]], base: float = ..., logSideSlope: list[tuple[float, float, float]] = ..., logSideOffset: list[tuple[float, float, float]] = ..., linSideSlope: list[tuple[float, float, float]] = ..., linSideOffset: list[tuple[float, float, float]] = ..., linearSlope: list[float] = ..., direction: TransformDirection = ...) -> None: ...
    def equals(self, other: LogCameraTransform) -> bool: ...
    def getBase(self) -> float: ...
    def getFormatMetadata(self) -> FormatMetadata: ...
    def getLinSideBreakValue(self) -> list[tuple[float, float, float]]: ...
    def getLinSideOffsetValue(self) -> list[tuple[float, float, float]]: ...
    def getLinSideSlopeValue(self) -> list[tuple[float, float, float]]: ...
    def getLinearSlopeValue(self) -> list[tuple[float, float, float]]: ...
    def getLogSideOffsetValue(self) -> list[tuple[float, float, float]]: ...
    def getLogSideSlopeValue(self) -> list[tuple[float, float, float]]: ...
    def isLinearSlopeValueSet(self) -> bool: ...
    def setBase(self, base: float) -> None: ...
    def setLinSideBreakValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLinSideOffsetValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLinSideSlopeValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLinearSlopeValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLogSideOffsetValue(self, values: list[tuple[float, float, float]]) -> None: ...
    def setLogSideSlopeValue(self, values: list[tuple[float, float, float]]) -> None: ...
...
class Lut1DTransform(Transform):
    ...
    def setData(self, data: typing_extensions.Buffer) -> None: ...
...
class MatrixTransform(Transform):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, matrix: list[tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]] = ..., offset: list[tuple[float, float, float, float]] = ..., direction: TransformDirection = ...) -> None: ...
    @classmethod
    def Fit(cls, oldMin: list[tuple[float, float, float, float]] = ..., oldMax: list[tuple[float, float, float, float]] = ..., newMin: list[tuple[float, float, float, float]] = ..., newMax: list[tuple[float, float, float, float]] = ...) -> MatrixTransform: ...
    @classmethod
    def Identity(cls) -> MatrixTransform: ...
    @classmethod
    def Sat(cls, sat: float, lumaCoef: list[tuple[float, float, float]]) -> MatrixTransform: ...
    @classmethod
    def Scale(cls, scale: list[tuple[float, float, float, float]]) -> MatrixTransform: ...
    @classmethod
    def View(cls, channelHot: list[tuple[int, int, int, int]], lumaCoef: list[tuple[float, float, float]]) -> MatrixTransform: ...
    def equals(self, other: MatrixTransform) -> bool: ...
    def getFileInputBitDepth(self) -> BitDepth: ...
    def getFileOutputBitDepth(self) -> BitDepth: ...
    def getFormatMetadata(self) -> FormatMetadata: ...
    def getMatrix(self) -> list[tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]]: ...
    def getOffset(self) -> list[tuple[float, float, float, float]]: ...
    def setFileInputBitDepth(self, bitDepth: BitDepth) -> None: ...
    def setFileOutputBitDepth(self, bitDepth: BitDepth) -> None: ...
    def setMatrix(self, matrix: list[tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]]) -> None: ...
    def setOffset(self, offset: list[tuple[float, float, float, float]]) -> None: ...
...
class NamedTransform:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, name: str = ..., aliases: list[str] = ..., family: str = ..., description: str = ..., forwardTransform: Transform = ..., inverseTransform: Transform = ..., categories: list[str] = ...) -> None: ...
    @classmethod
    def GetTransform(cls, transform: NamedTransform, direction: TransformDirection) -> Transform: ...
    def addAlias(self, alias: str) -> None: ...
    def addCategory(self, category: str) -> None: ...
    def clearAliases(self) -> None: ...
    def clearCategories(self) -> None: ...
    ...
    def __deepcopy__(self) -> NamedTransform: ...
...
class PackedImageDesc(ImageDesc):
    @overload
    def __init__(self, data: typing_extensions.Buffer, width: int, height: int, numChannels: int) -> None: ...
    @overload
    def __init__(self, data: typing_extensions.Buffer, width: int, height: int, numChannels: int, bitDepth: BitDepth, chanStrideBytes: int, xStrideBytes: int, yStrideBytes: int) -> None: ...
    @overload
    def __init__(self, data: typing_extensions.Buffer, width: int, height: int, chanOrder: ChannelOrdering) -> None: ...
    @overload
    def __init__(self, data: typing_extensions.Buffer, width: int, height: int, chanOrder: ChannelOrdering, bitDepth: BitDepth, chanStrideBytes: int, xStrideBytes: int, yStrideBytes: int) -> None: ...
...
class PlanarImageDesc(ImageDesc):
    @overload
    def __init__(self, rData: typing_extensions.Buffer, gData: typing_extensions.Buffer, bData: typing_extensions.Buffer, width: int, height: int) -> None: ...
    @overload
    def __init__(self, rData: typing_extensions.Buffer, gData: typing_extensions.Buffer, bData: typing_extensions.Buffer, aData: typing_extensions.Buffer, width: int, height: int) -> None: ...
    @overload
    def __init__(self, rData: typing_extensions.Buffer, gData: typing_extensions.Buffer, bData: typing_extensions.Buffer, width: int, height: int, bitDepth: BitDepth, xStrideBytes: int, yStrideBytes: int) -> None: ...
    @overload
    def __init__(self, rData: typing_extensions.Buffer, gData: typing_extensions.Buffer, bData: typing_extensions.Buffer, aData: typing_extensions.Buffer, width: int, height: int, bitDepth: BitDepth, xStrideBytes: int, yStrideBytes: int) -> None: ...
...
class Transform:
    ...
    def validate(self) -> None: ...
    def __deepcopy__(self) -> Transform: ...
...
class ViewTransform:
    ...
    def __init__(self, referenceSpace: ReferenceSpaceType) -> None: ...
    @overload
    def __init__(self, referenceSpace: ReferenceSpaceType = ..., name: str = ..., family: str = ..., description: str = ..., toReference: Transform = ..., fromReference: Transform = ..., categories: list[str] = ...) -> None: ...
    def addCategory(self, category: str) -> None: ...
    def clearCategories(self) -> None: ...
    ...
    def __deepcopy__(self) -> ViewTransform: ...
...
class ViewingRules:
    ...
    def removeRule(self, ruleIndex: int) -> None: ...
    def setCustomKey(self, ruleIndex: int, key: str, value: str) -> None: ...
    def __deepcopy__(self) -> ViewingRules: ...
...
class vector_of_uint8_t:
    ...
    @overload
    def __delitem__(self, other: slice) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    @overload
    def __getitem__(self, index: slice) -> vector_of_uint8_t: ...
    @overload
    ...
    @overload
    def __setitem__(self, index: slice, object: vector_of_uint8_t) -> None: ...
